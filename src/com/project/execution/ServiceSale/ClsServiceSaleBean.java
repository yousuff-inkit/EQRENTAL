...
public class ClsServiceSaleBean {
	...
	private String easycmp,salesman;     
	...
	////
	private String lblcreditperiod,lblsitedetails;
	
	public String getLblcreditperiod() {
		return lblcreditperiod;
	}

	public void setLblcreditperiod(String lblcreditperiod) {
		this.lblcreditperiod = lblcreditperiod;
	}
