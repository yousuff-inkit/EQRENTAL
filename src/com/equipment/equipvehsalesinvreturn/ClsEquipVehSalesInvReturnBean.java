...
public class ClsEquipVehSalesInvReturnBean {
	private String lblcomptrn,lblclienttrn,lbltaxtotal,lblnettaxtotal,taxtotal;
	...
	private String salesinvdocno,salesinvvocno,salesinvtrno,salesinvremarks;
	private String lblsalesinvdocno,lblsalesinvvocno,lblsalesinvtrno,lblsalesinvremarks;
	
	
	public String getLblsalesinvdocno() {
		return lblsalesinvdocno;
	}
	public void setLblsalesinvdocno(String lblsalesinvdocno) {
		this.lblsalesinvdocno = lblsalesinvdocno;
	}
	public String getLblsalesinvvocno() {
		return lblsalesinvvocno;
	}
	public void setLblsalesinvvocno(String lblsalesinvvocno) {
		this.lblsalesinvvocno = lblsalesinvvocno;
	}
	public String getLblsalesinvtrno() {
		return lblsalesinvtrno;
	}
	public void setLblsalesinvtrno(String lblsalesinvtrno) {
		this.lblsalesinvtrno = lblsalesinvtrno;
	}
	public String getLblsalesinvremarks() {
		return lblsalesinvremarks;
	}
	public void setLblsalesinvremarks(String lblsalesinvremarks) {
		this.lblsalesinvremarks = lblsalesinvremarks;
	}
