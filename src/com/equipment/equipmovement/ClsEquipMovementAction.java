...
public class ClsEquipMovementAction extends ActionSupport{
ClsCommon objcommon=new ClsCommon();
ClsEquipMovementDAO movementDAO=new ClsEquipMovementDAO();
ClsEquipMovementBean bean;
...
//	System.out.println("Inside print Action");
	HttpServletRequest request=ServletActionContext.getRequest();
	HttpSession session=request.getSession();
	ClsEquipMovementAction movaction =new ClsEquipMovementAction();
