...
public class ClsEquipDepreciationPostingAction extends ActionSupport{

	ClsCommon commonDAO= new ClsCommon();
	ClsEquipDepreciationPostingDAO vehicleDepreciationPostingDAO= new ClsEquipDepreciationPostingDAO();
	ClsEquipDepreciationPostingBean vehicleDepreciationPostingBean;
	...
	public String printAction() throws ParseException, SQLException{
		...
		setUrl(commonDAO.getPrintPath("EDP"));
