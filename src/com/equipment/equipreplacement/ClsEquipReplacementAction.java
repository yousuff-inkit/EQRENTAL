...
public class ClsEquipReplacementAction {
	ClsEquipReplacementDAO replacementDAO=new ClsEquipReplacementDAO();
...
//				System.out.println("Date:"+date+"Date Out:"+dateout+"InCollectDate"+incollectdate);
				//System.out.println("After Mode"+mode+"::"+dateout+"::"+getTimeout()+"::"+getCmbfuel()+"::"+getAtbranchoutkm()+"::"+getCmbatbranchoutfuel()+"::"+getColoutkm());
							int val=replacementDAO.insert(date,getCmbrentaltype(),getRefno(),getTxtfleetno(),dateout,getTimeout(),getOutkm(),getCmbfuel(),getCmbtrreason(),getCmbreplacetype(),getMode(),
									...
									getCmbatbranchoutfuel(),getColoutfleetno(),getHidcoloutbranch(),getHidcoloutlocation(),coloutdate,getColouttime(),getColoutkm(),getCmbcoloutfuel(),getInfleettrancode(),getAtbranchoutfleetno(),getDescription(),getCalcdocno());
							if(val>0.0){
				...
				boolean status=replacementDAO.update(getDocno(),getHidchkdelivery(),getHidcolcollectdriver(),colcollectdate,getColcollecttime(),getColcollectkm(),
						...
						getCmbrentaltype(),session,getMode(),getFormdetailcode(),getCmbcolinbranch(),getCmbcolinlocation(),getCmbreplacetype(),getCalcdocno());
				if(status){
				...
				int value=replacementDAO.delete(getDocno(),getBrchName(),getRefno(),getCmbrentaltype(),session,getMode(),getCalcdocno());
...
//				System.out.println("view===="+getTxtfleetno());
		...
		setCalcdocno(bean.getCalcdocno());
