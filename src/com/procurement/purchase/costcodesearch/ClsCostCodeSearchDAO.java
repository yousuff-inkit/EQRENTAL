	           ...
	           if(search.equalsIgnoreCase("yes")) {
	            ...
	            if(typedocno.equalsIgnoreCase("1")) {
	             ...
	             if(typedocno.equalsIgnoreCase("3") || typedocno.equalsIgnoreCase("4")) {
	              ...
	              sql = "select m.doc_no,m.doc_no tr_no,m.dtype,convert(concat(m.ref_type,' ',m.refdocno),char(100)) prjname,ac.refname customer,m.cldocno,s.rowno siteid,s.site from cm_srvcontrm m left join "
	             ...
	             if(typedocno.equalsIgnoreCase("5")) {
	              ...
	              sql = "select m.doc_no,m.doc_no tr_no,m.dtype,convert(concat(m.contracttype,' ',m.contractno),char(100)) prjname,ac.refname customer,m.cldocno,s.rowno siteid,s.site from cm_cuscallm m left join "
