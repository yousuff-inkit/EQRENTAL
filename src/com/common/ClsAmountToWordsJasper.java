...
public final  class   ClsAmountToWordsJasper {
	...
	static String st4[] = { "Twenty", "Thirty", "Forty", "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
	
	static String st5[] = { "Hundred", "Thousand", "Million", "Billion" };
	
	static String st6[] = { "Hundred", "Thousand", "Million", "Billion"  };
    
	/*
	 * public static void main(String args[]) throws SQLException { ClsAmountToWords
	 * c = new ClsAmountToWords(); c.convertAmountToWords("n"); }
	 */
	
	public static String currency() throws SQLException{
	...
	public static String convertAmountToWords(String n) throws SQLException
	 {
		 String str1="",str2 = "";
	     amt=n;
	     currency();
