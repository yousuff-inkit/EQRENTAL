...
public class ClsMaintenanceReviewAction extends ActionSupport{

	ClsMaintenanceReviewDAO  DAO= new ClsMaintenanceReviewDAO();
	ClsMaintenanceReviewBean  Bean;
	...
	public String printAction() throws ParseException, SQLException{
		...
		Bean=DAO.getPrint(request,fleetno,branch,fromdate,todate);
		...
		setLblfleetregno(Bean.getLblfleetregno());
		setLblfleetauthority(Bean.getLblfleetauthority());
		setLblfleetyom(Bean.getLblfleetyom());
		setLblfleetcolor(Bean.getLblfleetcolor());
		setLblfleetchassisno(Bean.getLblfleetchassisno());
		setLblfleetengineno(Bean.getLblfleetengineno());
