...
//		System.out.println("chk=========== "+invoice);
		...
		if(mode.equalsIgnoreCase("A")){
			...
			ArrayList<String> invoicearray=salikdao.generateInv(getCmbbranch(),sqlfromdate,sqltodate,getTxtcldocno(),getRentaltype(),getTxtagreementno(),session,getCmbtype(),getCmbcategory());
