...
public class ClsSalikClosedAgmtAction extends ActionSupport{
	
	ClsCommon ClsCommon=new ClsCommon();

    
	ClsSalikClosedAgmtDAO salikDAO= new ClsSalikClosedAgmtDAO();
	ClsSalikClosedAgmtBean salikBean;
	...
	private String cmbagmtstatus;
	
	
	public String getCmbagmtstatus() {
		return cmbagmtstatus;
	}

	public void setCmbagmtstatus(String cmbagmtstatus) {
		this.cmbagmtstatus = cmbagmtstatus;
	}
...
//		System.out.println("chk=========== "+invoice);
		...
		if(mode.equalsIgnoreCase("A")){
			...
			ArrayList<String> invoicearray=salikdao.generateInv(getCmbbranch(),sqlfromdate,sqltodate,getTxtcldocno(),getRentaltype(),
					getTxtagreementno(),session,getCmbtype(),getCmbagmtstatus());
