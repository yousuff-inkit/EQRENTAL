package com.dashboard.leaseagreement.leaseagmttarifchangealmariah;
...
public class ClsLeaseAgmtTarifChangeAlMariahDAO {
	...
	public JSONArray getTarifData(String agmtdocno,String id) throws SQLException{
		...
		try{
        	...
        	" chaufexchg,totalcostpermonth, drivercostpermonth, securitypass, fuel, salik, safetyacc, diw, hpd, rateperexhr  from gl_ltarif where rdocno="+agmtdocno;
