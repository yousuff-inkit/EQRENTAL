...
//	      			  System.out.println("==strSql10===="+strSql10);
	        		   ...
	        		   JasperDesign design = JRXmlLoader.load(request.getSession().getServletContext().getRealPath("com/dashboard/vehicle/readytorentAmex/fleetstatusprint.jrxml"));	      	     	 
			...
			String contextPath="/CarRental";
				 ...
				 ClsConnection conobj=new ClsConnection();
	        	   ...
	        	   try{
	        		   ...
	        		   JasperDesign design = JRXmlLoader.load(ipath+"/com/dashboard/vehicle/readytorent/readyToRentPrintEpic.jrxml");	      	       	 
    	               JasperReport jasperReport = JasperCompileManager.compileReport(design);
