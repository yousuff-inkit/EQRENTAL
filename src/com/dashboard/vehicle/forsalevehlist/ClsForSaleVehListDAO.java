package com.dashboard.vehicle.forsalevehlist;
...
public class ClsForSaleVehListDAO {
	...
	public JSONArray getVehListDataExcel(String branch,String id) throws SQLException{
		...
		try{
			...
			" m.FLNAME 'Fleet Name',y.YOM 'Yom',c.color 'Color',m.REG_NO 'Reg No',v.kmin 'Curr.Km',m.SRVC_KM+m.lst_srv 'Due Serv.Km',"+
