...
public class ClsAccountsStatementDAO  { 
	...
	public JSONArray accountsStatement(String branch,String fromdate,String todate,String accdocno,String chckopn,String check) throws SQLException {
				...
				if(!((branch.equalsIgnoreCase("a")) || (branch.equalsIgnoreCase("NA")))){
				  ...
				  if(chckopn.equalsIgnoreCase("1")){
					  openingsql="union all select t.brhid,DATE_ADD('"+sqlFromDate+"',INTERVAL -1 DAY) trdate," 
					  		...
					  		+ "or (t.date< '"+sqlFromDate+"')) "+ sql +" and t.acno= "+accdocno +" group by t.acno,t.curId ";
				  }
	...
	try {
		...
		sql="select b.doc_no brhid,b.branchname,'Statement of Account' vouchername,CONCAT('Period From ',DATE_FORMAT('"+sqlFromDate+"','%d-%m-%Y'),' To ',DATE_FORMAT('"+sqlToDate+"' ,'%d-%m-%Y')) vouchername1,"
