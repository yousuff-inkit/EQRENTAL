	...
	public   JSONArray stocklist(String branch,String status,String psrno,String load) throws SQLException {
      ...
      /*  
		...
		try {
				...
				String sql=" select m.barcode,c.brhid,bd.brandname,ca.category,c.qty,m.part_no productid,m.productname,c.amount,u.unit unit,sc.subcategory subcategory from (select  b.brhid,sum(b.qty) qty,b.prdid,sum(amount) amount from (select i.brhid,i.op_qty-coalesce(a.outqty,0) qty,i.prdid "
