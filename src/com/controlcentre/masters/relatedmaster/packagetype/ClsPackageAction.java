...
public class ClsPackageAction extends ActionSupport{
	
	ClsCommon ClsCommon=new ClsCommon();
	ClsPackageDAO serviceDAO= new ClsPackageDAO();
	ClsPackageBean bean;
	...
	public String saveAction() throws ParseException, SQLException{
		...
		if(mode.equalsIgnoreCase("A")){
						int val=serviceDAO.insert(getName(),getCode(),getDescr(), session,getMode(),getFormdetailcode());
				...
				int val=serviceDAO.edit(getName(),getCode(),getDescr(),session,getMode(),getDocno(),getFormdetailcode());
				...
				boolean Status=serviceDAO.delete(getName(),getCode(),getDescr(),session,getMode(),getDocno(),getFormdetailcode());
			if(Status){
				setName(getName());
				setCode(getCode());
				setDescr(getDescr());
