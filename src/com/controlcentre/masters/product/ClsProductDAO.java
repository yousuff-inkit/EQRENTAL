...
System.out.println("typesearch===="+sql);
	...
	public int insert(java.sql.Date date,String pname,String pcode,String pbarcode,String ptype,String pbrand,String pcat,
			...
			String arabicprdname,ArrayList ssarray,String desc1,ArrayList altrarray) throws SQLException{
...
/*				for(int i=0;i< suitarray.size();i++){
	...
	public int update(int docno,java.sql.Date date,String pname,String pcode,String pbarcode,String ptype,String pbrand,String pcat,
			...
			int cmbstar, int cmbmastertype, String arabicprdname,ArrayList<String> ssarray,String desc1,ArrayList altrarray) throws SQLException{
	...
	public  ClsProductBean getViewDetails(HttpSession session,int docno) throws SQLException { 
		...
		try {
			conn = ClsConnection.getMyConnection();
			Statement stmt = conn.createStatement ();
			String str1Sql=("select  m.date prddate,m.desc1,coalesce(m.prdname,'') prdname,m.mtypeid,m.lbrchg,m.fixingprice ,m.stdprice, m.star,if(m.comp_brch='C',1,2) comp_brch, m.barcode,m.doc_no sdocno,part_no as procode,"
