...
public class ClsFixedAssetGroupAction extends ActionSupport{
	...
	private String hidchkopasset;
	
	
	
	public String getHidchkopasset() {
		return hidchkopasset;
	}
	public void setHidchkopasset(String hidchkopasset) {
		this.hidchkopasset = hidchkopasset;
	}
	...
	public String saveAction() throws SQLException{
		...
		if(mode.equals("A")){
			...
			String fgm_name=getFgmname();
     	   	...
     	   	ClsFixedAssetGroupAction masteraction=new ClsFixedAssetGroupAction();
     	   	masteraction.setHidchkopasset(getHidchkopasset());
     	   	
     	   	int result=gmDAO.insert(fgm_name,fgm_code,sqlDate,session,mode,masteraction);
     	   ...
     	   int result=gmDAO.edit(fgm_name,fgm_code,sqlDate,session,mode,getDocno(),masteraction);
	...
	public void setData(int docno){
		...
		setHidchkopasset(getHidchkopasset());
	}
