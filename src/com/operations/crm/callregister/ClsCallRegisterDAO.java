...
" where veh.fstatus='l' and ac.cldocno="+cldocno+" and agmt.status=3 ) a order by a.others ";*/
				...
				String sql="select concat(veh.reg_no,' ',plt.code_no) regtext,veh.fleet_no fleetno,veh.reg_no regno,convert(concat(veh.flname),char(100)) others from gl_vehmaster veh left join gl_vehplate plt on veh.pltid=plt.doc_no where veh.fstatus='l'";
