...
public class ClsLeaseCalcAlFahimBean {
	private int docno;
	private int vocno;
	private String date;
	...
	private String lblcstno,lblservicetax,lblpan,lbltinno,cltinno,comptinno,taxstat;
	...
	public String getCltinno() {
		return cltinno;
	}

	public void setCltinno(String cltinno) {
		this.cltinno = cltinno;
	}

	public String getComptinno() {
		return comptinno;
	}

	public void setComptinno(String comptinno) {
		this.comptinno = comptinno;
	}
	...
	public void setSavedby(String string) {
