...
public class ClsLeaseAgreementAction extends ActionSupport{
	...
	private String laldelcharge;
				//private String duedate;
				private String lblvehimagepath;
				...
				private String manualla,lblcosmodamagechg,lblchafcharge;
				private Double rentaltotals;
				...
				public String getManualla() {
					return manualla;
				}

				public void setManualla(String manualla) {
					this.manualla = manualla;
				}
				public String getLblvehimagepath() {
					return lblvehimagepath;
				}

				public void setLblvehimagepath(String lblvehimagepath) {
					this.lblvehimagepath = lblvehimagepath;
				}
	...
	private String kmclient,drivermobno,lblindigonationality;
	private String cardtype,cosmocreditcardno,cltelno,lblcosmocreditvaliddate,lblindigoaddnationality1,lblindigoaddmobile;
	private String kmdriver;
	private String kmvehicle;
	private String kmagmtno;
	private String kmmrano;
	private String kmdate,cldesc;
	...
	private String lblclstatus,duedate,duetime;
	...
	public String getCosmocreditcardno() {
		return cosmocreditcardno;
	}

	public void setCosmocreditcardno(String cosmocreditcardno) {
		this.cosmocreditcardno = cosmocreditcardno;
	}
	...
	//-----------------------------------------------------------------------------------------------------	
		...
		public String getUrl() {
				...
				public String getLblindigoaddnationality1() {
			return lblindigoaddnationality1;
		}

		public void setLblindigoaddnationality1(String lblindigoaddnationality1) {
			this.lblindigoaddnationality1 = lblindigoaddnationality1;
		}
		 ...
		 Map<String, String[]> requestParams = request.getParameterMap();
           ...
           if(mode.equalsIgnoreCase("A")){
			...
			val=leaseAgmtDAO.insert(sqlleaseDate,getClientid(),getLe_salmanid(),getDescription(),getLe_clcodeno(),
					...
					advance_chk,invoice,getVehlocation(),getFormdetailcode(),getClientname(),request,vehdetarray,getExcessinsur(),getLeaseprojectDoc(),getLeasePo(),getManualla());
    	   ...
    	   ArrayList<String> paymentarray= new ArrayList<>();
			for(int i=0;i<getPaymentgridlength();i++){
			 ...
			 paymentarray.add(temp2);
        	  ...
        	  if(Status){
        		  	java.sql.Date sqlduedate=leaseAgmtDAO.getDuedate(getMasterdoc_no());
        		  	if(sqlduedate!=null){
     	   ...
     	   java.sql.Date sqldelDateout = commonDAO.changeStringtoSqlDate(getDeldateout());   
		     ...
		     setMasterdoc_no(getMasterdoc_no());
				...
				if(LeaseAgreementBean.getDuedate()!=null && !LeaseAgreementBean.getDuedate().equalsIgnoreCase("")){
					setDuedate(LeaseAgreementBean.getDuedate());
     			}
				setCheckbranch(getCheckbranch());
				setManualla(LeaseAgreementBean.getManualla());
...
public String printActions() throws ParseException, SQLException{
	...
	// int docnos=Integer.parseInt(request.getParameter("docno"));
	 ...
	 mainbean=leaseAgmtDAO.getmainPrint(doc);
	  ...
	  setCosmocreditcardno(bean.getCosmocreditcardno());
	  ...
	  setLblindigoaddnationality1(bean.getLblindigoaddnationality1());
	...
	//mm
	  ...
	  setSalname(bean.getSalname());	   
	   ...
	   setLblvehimagepath(bean.getLblvehimagepath());
...
public String printKm() throws SQLException{
	System.out.println("in");
	 HttpServletRequest request=ServletActionContext.getRequest();
		...
		ClsAmountToWords objamount=new ClsAmountToWords();
		System.out.println("valuee"+bean.getLbltotalexcesskmrate());
		if(bean.getLbltotalexcesskmrate()==null || bean.getLbltotalexcesskmrate().isEmpty()){
			bean.setLbltotalexcesskmrate("0.0");
		}
