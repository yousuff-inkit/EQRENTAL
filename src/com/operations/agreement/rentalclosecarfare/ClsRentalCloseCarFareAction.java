...
public class ClsRentalCloseCarFareAction extends ActionSupport{

ClsRentalCloseCarFareDAO rentalcloseDAO=new ClsRentalCloseCarFareDAO();
ClsCommon objcommon=new ClsCommon();
ClsRentalCloseCarFareBean bean;
