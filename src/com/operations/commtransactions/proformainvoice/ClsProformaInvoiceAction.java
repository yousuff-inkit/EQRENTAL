...
ClsProformaInvoiceDAO manualinvoiceDAO =new ClsProformaInvoiceDAO();
ClsProformaInvoiceBean bean;
private String lblwithtaxvalue,lblwithouttaxvalue,lblwithtaxamount,lblwithouttaxamount,lblwithtaxtotal,lblwithouttaxtotal,
...
public ClsProformaInvoiceAction(){}
...
{*/
public ClsProformaInvoiceAction(String lblinvno,String lblclient,String lblaccount,String lbldate,String lbladdress1,String lblrano,String lbladdress2,String lbllpono,
...
//							System.out.println(val);
			...
			System.out.println("view===="+getCmbagmttype());
