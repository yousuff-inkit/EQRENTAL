...
public class ClsTrustClientAction extends ActionSupport{
    
	ClsConnection ClsConnection=new ClsConnection();
	ClsCommon commonDAO= new ClsCommon();
	
	ClsTrustClientDAO clientDAO= new ClsTrustClientDAO();
	ClsTrustClientBean clientbean;

	private int txtclientdocno;
	private String formdetailcode,cmbprivilege,hidcmbprivilege;             
	public String getCmbprivilege() {
		return cmbprivilege;
	}

	public void setCmbprivilege(String cmbprivilege) {
		this.cmbprivilege = cmbprivilege;
	}

	public String getHidcmbprivilege() {
		return hidcmbprivilege;
	}

	public void setHidcmbprivilege(String hidcmbprivilege) {
		this.hidcmbprivilege = hidcmbprivilege;
	}
	...
	private String cmbtax;
	private String hidcmbtax;
	...
	private int chckseparatesrvcdefault;
	private int hidchckseparatesrvcdefault;
	...
	private String separateservicechargeallowed;
	...
	public String getCmbtax() {
		return cmbtax;
	}

	public void setCmbtax(String cmbtax) {
		this.cmbtax = cmbtax;
	}

	public String getHidcmbtax() {
		return hidcmbtax;
	}

	public void setHidcmbtax(String hidcmbtax) {
		this.hidcmbtax = hidcmbtax;
	}
	...
	public int getChckseparatesrvcdefault() {
		return chckseparatesrvcdefault;
	}

	public void setChckseparatesrvcdefault(int chckseparatesrvcdefault) {
		this.chckseparatesrvcdefault = chckseparatesrvcdefault;
	}

	public int getHidchckseparatesrvcdefault() {
		return hidchckseparatesrvcdefault;
	}

	public void setHidchckseparatesrvcdefault(int hidchckseparatesrvcdefault) {
		this.hidchckseparatesrvcdefault = hidchckseparatesrvcdefault;
	}
	...
	public String getSeparateservicechargeallowed() {
		return separateservicechargeallowed;
	}

	public void setSeparateservicechargeallowed(String separateservicechargeallowed) {
		this.separateservicechargeallowed = separateservicechargeallowed;
	}
	...
	public int getSeparateservicechargelength() {
		return separateservicechargelength;
	}

	public void setSeparateservicechargelength(int separateservicechargelength) {
		this.separateservicechargelength = separateservicechargelength;
	}
	...
	public String saveAction() throws ParseException, SQLException{
		...
		ClsTrustClientBean bean = new ClsTrustClientBean();
		...
		if(mode.equalsIgnoreCase("A")){
			...
			int val=clientDAO.insert(clientDate,getFormdetailcode(),getTxtclient_name(),getCmbsalutation(),getCmbcurrency(),getCmbgroup(),getCmbcategory(),
					...
					getTxtsalik(),getTxttraffic(),getTxtref_no(),getTxtref_type(),getTxtpersonal_add1(),getTxtpersonal_add2(),getTxtpersonal_tel1(),getPersonal_tel2(),
					...
					contractDate,getTxtcontractremarks(),getTxtjobtitle(),dateOfJoiningDate,getTxtbankname(),getTxtregisteredtrnno(),driverarray,referencearray,attacharray,creditcardarray,separateservicechargearray,
					session,request,getCmbprivilege());   
			if(val>0.0){
			...
			int Status=clientDAO.edit(getTxtclientdocno(),getFormdetailcode(),clientDate,getTxtclient_name(),getCmbsalutation(),getCmbcurrency(),getCmbgroup(),
					...
					getTxtresidence_extn_no(),getTxthome_add1(),getTxthome_add2(),getTxthome_tel1(),getHome_tel2(),getTxthome_fax(), getTxthome_email(),getTxthome_contact(),
					getTxthome_extn_no(),getTxtname(),getTxtaddress(),getTxttelephone(),getTxtid(),getCmbnationality(),getTxtsecurity(),getTxtsecurity1(),getTxtcontractno(),
					contractDate,getTxtcontractremarks(),getTxtjobtitle(),dateOfJoiningDate,getTxtbankname(),getTxtregisteredtrnno(),driverarray,referencearray,attacharray,creditcardarray,separateservicechargearray,session,getCmbprivilege());
			if(Status>0){
		...
		if(Status>0){
			...
			setHidcmbtax(clientbean.getHidcmbtax());
			setHidcmbprivilege(clientbean.getCmbprivilege());    
			
			setTxtregisteredtrnno(clientbean.getTxtregisteredtrnno());
			...
			setHidchckseparatesrvcdefault(clientbean.getChckseparatesrvcdefault());
		...
		public void setData() {
			...
			setHidcmbprivilege(getCmbprivilege());        
			...
			setHidchckseparatesrvcdefault(getHidchckseparatesrvcdefault());
			...
			setSeparateservicechargeallowed(getSeparateservicechargeallowed());
