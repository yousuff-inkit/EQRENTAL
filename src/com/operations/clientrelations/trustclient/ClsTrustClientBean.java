...
public class ClsTrustClientBean {
	...
	private Date pass_exp;	 
	private String dlno;
	private Date issdate;
	private String issfrm;
	private Date led;
	private String ltype;	
	private String visano;
	private Date visa_exp;
	...
	public Date getPass_exp() {
		return pass_exp;
	}
	public void setPass_exp(Date pass_exp) {
	...
	public String getIssfrm() {
		return issfrm;
	}
	public void setIssfrm(String issfrm) {
		this.issfrm = issfrm;
	}
	public Date getLed() {
		return led;
	}
	public void setLed(Date led) {
		this.led = led;
	}
	...
	public Date getVisa_exp() {
		return visa_exp;
	}
	public void setVisa_exp(Date visa_exp) {
		this.visa_exp = visa_exp;
	}
