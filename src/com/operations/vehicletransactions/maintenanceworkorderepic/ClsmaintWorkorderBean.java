...
public class ClsmaintWorkorderBean 

{
	 ...
	 // print 
	  ...
	  private  String  lblfleetno,lblfleetname,lblservtype,lblcurrkm,lblnextserkm,lbldate,lblgarage,lblnettotallabour,lblnettotalparts,lblnettotalamount;
		...
		private String  lblcompname,lblcompaddress,lblcomptel,lblcompfax,lblbranch,lbllocation,lblprintname,lblreg_no,lblmainttime,hidtime,nextserdue,currkm;   
		...
		private String lblcomptrn,lbltrnno,lbltaxamount,lblnettaxamount,lblinvo,lblinvdate,maintTime;   
