...
public class ClsmaintenanceBean{
	...
	//------------------------------------------------------------------  
	  ...
	  private  String  lblfleetno,lblfleetname,lblservtype,lblcurrkm,lblnextserkm,lbldate,lblgarage,lblnettotallabour,lblnettotalparts,lblnettotaltax,lblnettotalamount;
		private int docvals,firstarray;
		
		private String  lblcompname, lblinvdate ,lblinvno,lblcompaddress,lblcomptrn,lblcomptel,lblcompfax,lblbranch,lbllocation,lblprintname,lblreg_no;
