...
public class ClsVehicleInspectionBean {
private int docno;
private String date,username,base,left,right,signature,clientmail,front,back,interior;
...
private String hidcmbreftype,lblclientid,lblclntmob,lbldriver,lbldrivermob,lbldriverdob,lbldriverdlno,lblpltcode,lbldout,lbltout,lblkmout,lblfout,lbloutby;
private int rdocno;
