       ...
       sortable:true,
        columns: [
			...
			/* 			{ text: 'DateDifference', datafield: 'datediff', width: '17%',hidden:true}, */
						...
						{ text: 'Receipt No', datafield: 'refno', width: '10%',cellsalign:'left',align:'left'},
						{ text: 'Receipt dt', datafield: 'refdate', width: '10%',cellsalign:'left',align:'left'},
						{ text: 'Salesman', datafield: 'sal_name', width: '15%',cellsformat:'d2',cellsalign:'left',align:'left',},
						{ text: 'Category', datafield: 'category', width: '15%',cellsformat:'d2',cellsalign:'left',align:'left',}
