	...
	function funNotify(){
    	...
    	if(rows.length>0 && (rows[0].rano=="undefined" || rows[0].rano==null || rows[0].rano=="")){
    		return false;
                    ...
                    var amt=$('#leaseInvoiceGrid').jqxGrid('getcellvalue',selectedrows[0],'amount');
