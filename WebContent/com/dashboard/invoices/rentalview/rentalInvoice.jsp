...
<form id="frmDashboardRentalInvoice" method="post">
...
<input type="hidden" name="hidclient" id="hidclient" >
	...
	<tr>
	<td colspan="2"><center><input type="button" style="opacity:0;" name="btninvoicesave" disabled id="btninvoicesave" class="myButton" value="Generate" ></center></td>
	</tr>
	<tr>
	<td colspan="2"></td>
	</tr>	
