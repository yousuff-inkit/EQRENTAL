...
<td width="20%" >
    ...
    <tr><td align="right"><label class="branch">Agg. Status</label></td>
	...
	<tr><td colspan="2"><input type="hidden" id="txtagreementno" name="txtagreementno" style="width:100%;height:20px;"  value='<s:property value="txtagreementno"/>'/></td></tr>
	 <tr><td align="right"><label class="branch">Invoice Status</label></td>
     <td align="left"><select id="invstatuss" name="invstatuss"  value='<s:property value="invstatuss"/>'>
     <option value="1">Active</option><option value=2>Inactive(Deleted)</option><option value=3>All</option>
     </select></td></tr>
