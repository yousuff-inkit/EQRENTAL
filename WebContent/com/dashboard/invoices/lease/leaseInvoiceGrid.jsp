...
$(document).ready(function () {
    ...
    $("#leaseInvoiceGrid").jqxGrid(
    {
       ...
       sortable:false,
				...
				{ text: 'Salik AUH Count',  datafield: 'salikauhcount',  width: '8%',hidden:false,cellsformat: 'd2',cellsalign:'right',align:'right'},
				{ text: 'Salik DXB Count',  datafield: 'salikdxbcount',  width: '8%',hidden:false,cellsformat: 'd2',cellsalign:'right',align:'right'},
