...
<script type="text/javascript">
    ...
    var name='<%=name%>';
        ...
        function funreload(){
   			 ...
   			 $("#vehdetDiv").load("vehicleDetailedAssetGrid.jsp?name="+name+"&branchval="+branchval+'&fleetno='+fleetno+'&fromdate='+fromDate+'&todate='+toDate);
   		  
   		}
        
        function funExportBtn(){
        	 
            $("#vehdetDiv").excelexportjs({
				containerid: "vehdetDiv",   
				datatype: 'json',
				dataset: null,
...
<body class='default'>
 ...
 <table width="100%">
		<tr>
			 <td><div id="vehdetDiv"><jsp:include page="vehicleDetailedAssetGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>	
	</body>
</html>
