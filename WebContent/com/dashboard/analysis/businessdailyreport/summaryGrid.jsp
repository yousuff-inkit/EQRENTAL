<%@page import="com.dashboard.analysis.businessdailyreport.*" %>
...
<style type="text/css">
 ...
 var data,data222;
 	  ...
 	  /*  var rendererstring=function (aggregates){
 		...
 		data222 = '<%=summarydao.getSummaryDataEx(check,fromdate,todate)%>';
 	    }else{
			...
			$("#summaryGrid").on("celldoubleclick", function (event)
					{
					    ...
					    if(dataField=="branch0" || dataField=="branch1" || dataField=="branch2" || dataField=="branch3" || dataField=="branch4" || 
					    	...
					    	document.getElementById("hiddesc").value=description;
					    	document.getElementById("hidbrch").value=branch;
