	...
	$(document).ready(function () {  
	 ...
	 $(function() {
	      $("#btnSubmit").click(function(evt) {
	    	  ...
	    	  $("#leadDiv").load("contractAnalysisGridNew.jsp?fromdate="+fromdate+"&todate="+todate+"&id=1");
	          evt.preventDefault();              
	      })
	    })  
	    
	function funExportBtn(){  
			 JSONToCSVCon(data,'Contract Analysis',true);   
	}
 ...
 <table>
  ...
  <tr>  
	 <td align="right" colspan="2"> <div id="divPivotGridDesigner" style="height: 490px; width: 250px;"></div></td></tr>
            ...
            <td width="80%">
                <div id="leadDiv" style="height:540px; width: 1090px;"><jsp:include page="contractAnalysisGridNew.jsp"></jsp:include>
                </div>  
            </td>
        </tr>
    </table>
