...
<script type="text/javascript">
	...
	function funExportBtn(){
        	$("#assetDiv").excelexportjs({
    			...
    			datatype: 'json', 
    			dataset: null, 
    			gridId: "unRealizedRevenueGrid", 
    			columns: getColumns("unRealizedRevenueGrid") , 
    			worksheetName:"UnRealizedRevenue"
    			});
	...
	function funreload(event){
		...
		/*  var fleetno = $('#txtfleet').val();
		 ...
		 $("#assetDiv").load("unrealizedrevenueGrid.jsp?branchval="+branchval+'&fromdate='+fromdate+'&todate='+todate+'&check='+check);
		}
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="assetDiv"><jsp:include page="unrealizedrevenueGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
