...
<script type="text/javascript"> 
       ...
       var data1='<%=cva.equipDetailedAsssetGridLoading(branchval, fromDate, toDate, fleetno)%>';
       var name='<%=name%>';
        ...
        $(document).ready(function (){ 
            ...
            // prepare the data
             ...
             var result = $("#detailedAsset").jqxGrid('getCellValue', 0, 'bookvalue');
