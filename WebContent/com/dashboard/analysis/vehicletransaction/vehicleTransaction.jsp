	...
	$(document).ready(function () {  
	 ...
	 $(function() {
	      $("#btnSubmit").click(function(evt) {
	    	  ...
	    	  $("#leadDiv").load("vehicleTransactionGridNew.jsp?fromdate="+fromdate+"&todate="+todate+"&id=1");
	          evt.preventDefault();              
	      })
	    })  
	    
	function funExportBtn(){  
			 JSONToCSVCon(data,'Vehicle Transaction',true);   
	}
...
<div id="mainBG" class="homeContent" data-type="background">   
 <table>
  ...
  <tr>  
	 <td align="right" colspan="2"> <div id="divPivotGridDesigners" style="height: 490px; width: 250px;"></div></td></tr>
                 </table>
            </td>   
            <td width="80%">
                <div id="leadDiv" style="height:540px; width: 1090px;"><jsp:include page="vehicleTransactionGridNew.jsp"></jsp:include>
                </div>  
            </td>
        </tr>
    </table>
