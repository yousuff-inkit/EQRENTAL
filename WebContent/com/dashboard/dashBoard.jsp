...
*/
        $(document).ready(function () {
           ...
           // prepare jqxChart settings
            var settings = {
                title: "Registration Expiry & Insurance Expiry",
                description: "",
                showLegend: true,
                    ...
                    [
                        {
                            ...
                            valueAxis:
                            {
                                ...
                                description: ' Reg. Exp & Ins. Exp'
                            },
                            series: [
                                    { dataField: 'reg_exp1', displayText: 'Reg. Expiry'},
...
<table  width="100%">
		    <tr><td>&nbsp;</td></tr> 
			<tr><td><div id='fleetStatus1' style="width: 100%; height: 190px;"></div></td></tr>
			<tr><td><div id='readyToRent' style="width: 100%; height: 170px;"></div></td></tr>
