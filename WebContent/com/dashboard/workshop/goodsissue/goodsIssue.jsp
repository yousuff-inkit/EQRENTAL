...
<html>
    ...
    <body onload="setValues();getBranch();">
        <form id="frmGoodsIssue" method="post" action="saveGoodsIssue" style="height: 100%;">
                ...
                <div class="master-container">
                        ...
                        <div class="sidebar-scroll-content">
                            ...
                            <div class="filter-card">
                                <table class="filter-table">
                                    ...
                                    <tr>
                                        <td class="label-cell">Service Advisor</td>
                                        <td>
                                            <input type="text" name="srvcadvisor" id="srvcadvisor" value='<s:property value="srvcadvisor"/>' readonly="readonly" onkeydown="getSrvcAdvisor(event);" placeholder="Press F3 to Search">
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <div class="main-content-area">
                        ...
                        <div class="grid-content-container">
                            <div id="srvcadvisordiv">
                                <jsp:include page="srvcAdvisorGrid.jsp"></jsp:include>
                            </div>
            ...
            <!-- POPUPS -->
            <div id="srvcadvisorwindow"><div></div></div>
