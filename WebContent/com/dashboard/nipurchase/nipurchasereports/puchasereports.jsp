...
<td width="20%" >
 ...
 <tr><td colspan="2">&nbsp;</td></tr> 
   <tr>
   <td align="right"><input type="button" class="myButtons" name="nipurchaseprint" id="nipurchaseprint" value="Print" onclick="funPrint();"></td>
   <td align="right"><input type="button" class="myButtons" name="clear" id="clear"  value="Clear" onclick="funClearInfo();"></td>
   <tr>
