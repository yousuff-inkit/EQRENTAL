...
<script type="text/javascript">
	...
	function funPrintCollectionClosure(){
	        ...
	        var win= window.open(reurl[0]+"printCollectionClosureNew?branch="+document.getElementById("cmbbranch").value+'&fromdate='+document.getElementById("fromdate").value+'&todate='+$("#todate").val()+'&netamount='+document.getElementById("txtnetamount").value,"_blank","top=150,left=250,Width=1020,Height=500,location=no,scrollbars=no,toolbar=yes");
	        win.focus();
