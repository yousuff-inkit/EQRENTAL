        ...
        $(document).ready(function () {
            ...
            $("#collectionClosure").jqxGrid(
            {
                ...
                columns: [
	                    ...
	                    { text: 'Salesman', datafield: 'salmn', width: '14%' ,hidden:true },
	                    { text: 'Posted Docno', datafield: 'pdocno', width: '7%' ,hidden:true },       
	                    { text: 'Posted Type', datafield: 'ptype', width: '8%',hidden:true },
	                    { text: 'Agreement', datafield: 'rano', width: '12%' , aggregates: ['sum1'],aggregatesrenderer:rendererstring1 },
	                    { text: 'Agmt.Opn.Date', datafield: 'agmtopndate', cellsformat: 'dd.MM.yyyy' , width: '8%',hidden:true },
