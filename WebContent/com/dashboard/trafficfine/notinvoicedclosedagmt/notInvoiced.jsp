...
<td width="20%" >
	...
	<tr><td colspan="2" align="center"><input type="checkbox" name="chksaperate" id="chksaperate" onchange="setSaperate();"><label class="branch">Separate Invoice</label></td></tr>
	...
	<tr><td colspan="2">&nbsp;</td></tr> 
	<tr>
	<td colspan="2" align="center"><button class="myButton" type="button" id="btnGenerate" name="btnGenerate" onclick="funGenerate();">Generate</button>
	<!-- <input type="button" name="btnGenerate" id="btnGenerate" value="Generate" class="myButton" onclick="funGenerate();"> --></td></tr>
