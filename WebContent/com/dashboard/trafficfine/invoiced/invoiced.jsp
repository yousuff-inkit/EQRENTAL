...
<html>
    <head>
        ...
        function funExportBtn(){
            $("#invoicedDiv").excelexportjs({
                containerid: "invoicedDiv",   
                datatype: 'json',
                dataset: null,
                gridId: "jqxInvoiced",
                columns: getColumns("jqxInvoiced") ,   
                worksheetName:"Traffic-Fine-Invoiced"  
            });   
        }
                        ...
                        <div class="filter-card">
                            <table class="filter-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="txtclientname" name="txtclientname" 
                                               ...
                                               onkeydown="getClient(event);" value='<s:property value="txtclientname"/>'/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="txtagreementvoucherno" name="txtagreementvoucherno" 
                                               readonly="readonly" placeholder="Press F3 to Search" 
                                               onkeydown="getAgreement(event);" value='<s:property value="txtagreementvoucherno"/>'/>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div class="action-buttons">
                                ...
                                <button type="button" class="btn-submit" id="btnTrafficInvoicePrint" name="btnTrafficInvoicePrint" onclick="funTrafficInvoicePrint();">Print</button>
                            </div>
                        </div>
