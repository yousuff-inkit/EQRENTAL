...
$(document).ready(function () {   	
            ...
            $('#jqxCRMGrid').on('rowdoubleclick', function (event) {          
             	  var rowindex1=event.args.rowindex; 
             	  document.getElementById("txtname").value=$('#jqxCRMGrid').jqxGrid('getcellvalue', rowindex1, "refname");
             	  document.getElementById("hiddocno").value=$('#jqxCRMGrid').jqxGrid('getcellvalue', rowindex1, "cldocno");
             	  document.getElementById("lblname").value=$('#jqxCRMGrid').jqxGrid('getcellvalue', rowindex1, "cldocno")+" - "+$('#jqxCRMGrid').jqxGrid('getcellvalue', rowindex1, "refname");  
             	 
             	  $('#flwupDiv').load('flwupGrid.jsp?id=1');  
             	 
             	  $('.textpanel p').text($('#jqxCRMGrid').jqxGrid('getcellvalue', rowindex1, "cldocno")+' - '+$('#jqxCRMGrid').jqxGrid('getcellvalue', rowindex1, "refname"));
