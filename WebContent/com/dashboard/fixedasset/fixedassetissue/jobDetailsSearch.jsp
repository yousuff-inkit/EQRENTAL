...
<script type="text/javascript">
	...
	$(document).ready(function () {});   
  	...
  	function loadSearchss() {
 		 ...
 		 var dtype=document.getElementById("cmbjobtype").value;
 		
		getdatas(docnoss,refnames,dtype);
	}

  	function getdatas(docnoss,refnames,dtype){
		 
		 $("#refsearch").load('subAmcSjobSearch.jsp?docnoss='+docnoss+'&refnames='+refnames+'&dtype='+dtype+'&check=1');
...
<table width="100%" >
  ...
  <table width="100%" >  
    ...
    <td align="left" width="20%"><input type="text" name="refnames" id="refnames"  style="width:90%;height:20px;" value='<s:property value="refnames"/>'></td>
