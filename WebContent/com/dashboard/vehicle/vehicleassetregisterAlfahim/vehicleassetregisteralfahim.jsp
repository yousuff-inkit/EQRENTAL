...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		var curmonth=new Date(new Date(curfromdate).setMonth(00,01));
		 $('#fromdate ').jqxDateTimeInput('setDate', new Date(curmonth));
	...
	function funExportBtn(){
		$("#assetDiv").excelexportjs({
			...
			datatype: 'json', 
			dataset: null, 
			gridId: "vehicleAssetAlfahimGrid", 
			columns: getColumns("vehicleAssetAlfahimGrid") , 
			worksheetName:"VehicleAssetRegisterAnnual"
			});
	...
	function funreload(event){
		 ...
		 var check=1;
		 //$('#vehicleAssetAlfahimGrid').jqxGrid('setcolumnproperty', 'costasat1', 'text', 'Cost As At '+fromdate);
		 $("#overlay, #PleaseWait").show();
	
		 $("#assetDiv").load("vehicleassetregisteralfahimGrid.jsp?branchval="+branchval+'&fromdate='+fromdate+'&todate='+todate+'&fleetno='+fleetno+'&group='+group+'&model='+model+'&check='+check);
		}
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="assetDiv"><jsp:include page="vehicleassetregisteralfahimGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
