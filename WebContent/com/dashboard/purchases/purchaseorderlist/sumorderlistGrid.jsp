...
{ 
	 ...
	 datassa='<%=searchDAO.summorderlistsearchExcel(barchval,fromdate,todate,statusselect,acno)%>'; 
	 datasa='<%=searchDAO.summorderlistsearch(barchval,fromdate,todate,statusselect,acno)%>'; 
		// alert(enqdata); --%>
} 
else
{ 
   ...
   var rendererstring=function (aggregates){
    ...
    $("#sumorderlistgrid").jqxGrid(
    {
                  ...
                  { text: 'SL#', sortable: false, filterable: false, editable: false,cellclassname: cellclassname,
                   ...
                   /// doc_no, voc_no, date, type, expdeldt, qty, brand, model, color  
                     { text: 'Doc No',datafield: 'voc_no', width: '7%' ,cellclassname: cellclassname},
         			 ...
         			 { text: 'Ref No',datafield: 'refno', width: '15%',cellclassname: cellclassname },
         			 { text: 'Type',datafield: 'dtype', width: '15%',cellclassname: cellclassname },
         		     { text: 'Account', datafield: 'account',  width: '10%' ,cellclassname: cellclassname },
                     { text: 'Account Name', datafield: 'acname'  ,width: '10%' ,cellclassname: cellclassname },
					 { text: 'Bill Type', datafield: 'billtype',  width: '10%' ,hidden:true ,cellclassname: cellclassname },
					 { text: ' Total tax', datafield: 'totaltax',  width: '10%' ,cellsformat:'d2',cellsalign: 'right', align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring,cellclassname: cellclassname},
					 { text: ' Total Discount', datafield: 'totaldiscount',  width: '10%' ,cellsformat:'d2',cellsalign: 'right', align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring,cellclassname: cellclassname},
       ...
       /*     	         { text: 'Product Id', datafield: 'productid',  width: '13%',cellclassname: cellclassname }, 
		            ...
		            */  { text: 'Prod. Net Total', datafield: 'nettotal',  width: '12%' ,cellsformat:'d2',cellsalign: 'right', align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring,cellclassname: cellclassname},
