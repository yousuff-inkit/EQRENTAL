...
function funExportBtn(){
		...
		{
	   		JSONToCSVCon(datassa, 'Purchase Invoice Summary List', true);	
		}
	   	else
	   		{
	...
	function funPurchase(tr_no)
	{
	   ...
	   var url=document.URL;
		...
		var detName= "Purchase Invoice";
		 var path1='com/Procurement/Purchase/purchaseinvoice/purchseinvoicemaster.jsp';

		    var path= path1+"?mod="+mod+"&tr_no="+tr_no;  
 ...
 <tr ><td align="right" > <label class="branch">Type</label></td> <td ><select id="summ" name="summ" style="width:70%;" onchange="funsumm()">
	...
	<option value="summ">Summary</option>
		<option value="">Detail</option>
	 	...
	 	<tr ><td align="right" > <label class="branch"> </label></td> <td ><select hidden="true" id="statusselect" name="statusselect" style="width:70%;">
