...
function funAttachBtn(){
	  ...
	  $("#windowattach").jqxWindow('setTitle',"EEM - "+document.getElementById("docnosss").value);
	changeAttachContent("<%=contextPath%>/com/dashboard/Attach.jsp?formCode=EEM&docno="+document.getElementById("docnosss").value+"&barchvals="+document.getElementById("brhs").value);		
