...
.filter-table div[id^="insuexpdate"] {
    width: 100%;
}
...
$(document).ready(function () {
	 ...
	 $("#insuexpdate").jqxDateTimeInput({ width: '100%', height: '24px',formatString:"dd.MM.yyyy"});
...
function funExportBtn(){
	$("#invcomSearchwindow").excelexportjs({
   		containerid: "invcomSearchwindow",
   		datatype: 'json',
   		dataset: null,
   		gridId: "insexpgrid",
...
<div class="master-container">
	...
	<div class="main-content-wrapper">
		...
		<div class="scrollable-grid-area">
			<div id="insuexp"><jsp:include page="insuranceExpairyGrid.jsp"></jsp:include></div>
		</div>
	</div>
