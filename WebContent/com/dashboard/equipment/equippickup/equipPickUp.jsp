						...
						<td width="20%">
    						<fieldset style="background: #ECF8E0;">
									...
									<tr>
  										<td colspan="2">
    										<fieldset id="pickupfield"><legend>In Details</legend>
      											<table width="100%">
        											<tr>
          												<td align="right"><label class="branch">Contract</label></td>
          												<td align="left">
								...
								<tr>
  								...
  								<tr><td colspan="2" ><textarea id="agmtdetails" name="agmtdetails" style="resize:none;width:100%;" rows="5" readonly></textarea></td></tr> 
