...
background-color:transparent;
	...
	function getdata(docnosearch,fleetsearch,regnosearch,clientsearch,searchdate,mobilesearch,branch){
		//alert(searchdate);
				$("#loadRaSearch").load("gridRaSearch.jsp?id=1&docno="+docnosearch+"&fleet="+fleetsearch+"&regno="+regnosearch+"&client="+clientsearch+"&date="+searchdate+"&mobile="+mobilesearch+"&branch="+branch);
		}
...
<table width="100%" >
  <tr>
    ...
    <td align="left"><input type="text" name="docnosearch" id="docnosearch" value='<s:property value="docnosearch"/>' style="height:18px;"></td>
    <td align="right"><label class="branch">Fleet</label></td>
    <td align="left"><input type="text" name="fleetsearch" id="fleetsearch" value='<s:property value="fleetsearch"/>' style="height:18px;"></td>
    <td align="right"><label class="branch">Asset id</label></td>
    <td align="left"><input type="text" name="regnosearch" id="regnosearch" value='<s:property value="regnosearch"/>' style="height:18px;"></td>
    <td align="right">&nbsp;</td>
    <td align="left">&nbsp;</td>
  </tr>
  <tr>
    <td align="right"><label class="branch">Client</label></td>
    <td align="left"><input type="text" name="clientsearch" id="clientsearch" value='<s:property value="clientsearch"/>' style="height:18px;"></td>
    ...
    <td align="left"><input type="text" name="mobilesearch" id="mobilesearch" value='<s:property value="mobilesearch"/>' style="height:18px;"></td>
    <!-- <td align="right">&nbsp;</td>
