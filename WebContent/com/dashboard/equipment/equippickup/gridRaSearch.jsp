<%@ page import="com.dashboard.equipment.equippickup.*" %>
<%ClsEquipPickUpDAO crcd=new ClsEquipPickUpDAO(); %>
...
var id='<%=id%>';
if(id=="1"){
	radata='<%=crcd.getContracts(docno,fleet,regno,client,date,mobile,branch,id)%>';
}
        ...
        $(document).ready(function () { 	
            ...
            $("#gridRaSearch").jqxGrid(
            {
               ...
               // pageable: true,
                ...
                columns: [
							...
							{ text: 'calcdocno',datafield:'calcdocno',width:'20%',hidden:true}
							]
            });
            ...
            $('#gridRaSearch').on('rowdoubleclick', function (event) {
            	...
            	var rowindex1=event.args.rowindex;
             	...
             	document.getElementById("calcdocno").value=$('#gridRaSearch').jqxGrid('getcellvalue', rowindex1, "calcdocno");
