<%@ page import="com.dashboard.equipment.equippickup.ClsEquipPickUpDAO"%>
<% ClsEquipPickUpDAO cvpd=new ClsEquipPickUpDAO(); %>
...
$(document).ready(function () {
    ...
    $('#pickupgrid').on('rowdoubleclick', function (event) 
	  ...
	  document.getElementById("agmtdetails").innerText="Fleet: "+$('#pickupgrid').jqxGrid('getcellvalue', rowindex1, "flname")+" Asset id: "+$('#pickupgrid').jqxGrid('getcellvalue', rowindex1, "reg_no")+"\n"+
	  ...
	  document.getElementById("brhid").value=$('#pickupgrid').jqxGrid('getcellvalue', rowindex1, "brhid");
