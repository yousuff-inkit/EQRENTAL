...
function funLoadData() {
  	...
  	$("#fleetdiv").load("vehicleDetailsgrid.jsp?check="+aa);
  }
...
function funExportsBtn(){
    ...
    $("#fleetdiv").excelexportjs({
			...
			datatype: 'json',
			dataset: null,
			gridId: "vehicledetails",
			columns: getColumns("vehicledetails") ,   
			worksheetName:"VEHICLE DETAILS"  
		});   

    JSONToCSVConvertor(dataExcelExport, 'VEHICLE DETAILS', true);
} 
