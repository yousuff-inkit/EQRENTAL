...
function funExportBtn()
{
	...
	function JSONToCSVConvertor(JSONData, ReportTitle, ShowLabel) {
	 ...
	 function funPrintBtn(){
	    	   ...
	    	   //alert(companyname);
			   var win= window.open(reurl[0]+"printfleetstatus?brhid="+document.getElementById("cmbbranch").value+"&company="+companyname+"&print=1","_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");    
		       win.focus(); 
