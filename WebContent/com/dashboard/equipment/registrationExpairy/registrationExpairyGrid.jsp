<%@ page import="com.dashboard.equipment.regexpiry.*" %>
...
//    	$('#rentalInvoiceGrid').jqxGrid({ sortable: true});
	...
	showfilterrow: true,
        ...
        columns: [   
				    ...
				    { text: 'Reg.NO', datafield: 'reg_no', editable:false, width: '5%',hidden:true },
...
function funAttachBtn(){
	  ...
	  $("#windowattach").jqxWindow('setTitle',"EEM - "+document.getElementById("docnoss").value);
		changeAttachContent("<%=contextPath%>/com/dashboard/Attach.jsp?formCode=EEM&docno="+document.getElementById("docnoss").value+"&barchvals="+document.getElementById("brh").value);		
