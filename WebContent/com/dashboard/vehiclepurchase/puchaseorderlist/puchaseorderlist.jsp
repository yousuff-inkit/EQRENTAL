...
{	
	...
	var mod="view";
	window.parent.formName.value="Veh. Purchase Order";
	window.parent.formCode.value="VPO";
	var detName= "Veh. Purchase Order";
	 //var path1='com/operations/vehicleprocurement/purchaseorder/purchaseOrder.jsp';
    var path1='com/operations/vehicleprocurement/purchaseorder/savePurchaseorder';
