 ...
 function funreload(event)
{
	 ...
	 $("#returngrid").load("returnGrid.jsp?id=1");  
}
 ...
 function funExportBtn(){
	...
	function funSubmit()
	{
		...
		var userdoc=document.getElementById("usdocno").value;
		    ...
		    x.open("GET", "returnStatus.jsp?doc="+doc+"&userdoc="+userdoc, true);
		    x.send();
...
<td width="20%">
	...
	<tr>
		...
		<tr>
			<td align="center"><input type="button" id="btnsubmit" name="btnsubmit" value="Submit" class="myButton" onclick="funSubmit()"></td>
...
<td width="80%">
	<table width="100%">
		...
		<tr>
			<td><div id="returngrid"><jsp:include page="returnGrid.jsp"></jsp:include></div></td>
		</tr>
