 ...
 function funreload(event)
{
	 ...
	 $("#servicegrid").load("serviceGrid.jsp?id=1");  
}
 ...
 function funExportBtn(){
	...
	function funSubmit()
	{
		 ...
		 */
		    ...
		    /* x.open("GET", "serviceStatus.jsp?doc="+doc+"&userdoc="+userdoc, true); */
		    x.open("GET", "serviceStatus.jsp?doc="+doc, true);
		    x.send();
...
<td width="80%">
	<table width="100%">
		...
		<tr>
			<td><div id="servicegrid"><jsp:include page="serviceGrid.jsp"></jsp:include></div></td>
		</tr>
