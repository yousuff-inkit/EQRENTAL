 ...
 function funreload(event)
{
	 ...
	 $("#complaintgrid").load("complaintGrid.jsp?id=1");  
}
 ...
 function funExportBtn(){
	...
	function funSubmit()
	{
		...
		/* 	if(userdoc=="")
		    ...
		    /* x.open("GET", "complaintStatus.jsp?doc="+doc+"&userdoc="+userdoc, true); */    
		    x.open("GET", "complaintStatus.jsp?doc="+doc, true);
		    x.send();
...
<td width="80%">
	<table width="100%">
		...
		<tr>
			<td><div id="complaintgrid"><jsp:include page="complaintGrid.jsp"></jsp:include></div></td>
		</tr>
