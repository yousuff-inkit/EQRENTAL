...
java.sql.Date sqlexdate=null;
	...
	{
	  upsql="update gl_"+ta+"pyt set reldate='"+sqlexdate+"',acode='"+authcode+"' where rdocno='"+rdocno+"' and doc_no='"+pytdoc+"' ";
	    stmt.executeUpdate(upsql); 
	}
	else
	{
		  upsql="update gl_"+ta+"pyt set relstatus=1,acode='"+authcode+"' where rdocno='"+rdocno+"' and doc_no='"+pytdoc+"' ";
		    stmt.executeUpdate(upsql); 
	}
