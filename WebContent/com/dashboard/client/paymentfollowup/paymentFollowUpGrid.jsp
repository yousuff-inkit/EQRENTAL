      ...
      var temp='<%=branchval%>';
        ...
        $(document).ready(function () {
        	...
        	var source =
            {
        	 ...
        	 $("#paymentFollowUp").on("bindingcomplete", function (event) {
 		    	$('#paymentFollowUp').jqxGrid('hidecolumn', 'currency');
 			    
 		    	if (parseInt($("#hidmulticurrency").val())>0){
             		$('#paymentFollowUp').jqxGrid('showcolumn', 'currency');
 			    }
             });
            ...
            $('#paymentFollowUp').on('rowdoubleclick', function (event) { 
          	  ...
          	  document.getElementById("txtmobno").value=$('#paymentFollowUp').jqxGrid('getcellvalue', rowindex1, "pmob");
