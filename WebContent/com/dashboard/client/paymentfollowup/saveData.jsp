...
ClsCommon ClsCommon=new ClsCommon();
	...
	try{
		...
		String branchid = request.getParameter("branchid")==null || request.getParameter("branchid").trim().equals("")?"0":request.getParameter("branchid").trim(); 
		String docno = request.getParameter("docno")==null || request.getParameter("docno").trim().equals("")?"0":request.getParameter("docno").trim(); 
		String accountno = request.getParameter("accountno")==null || request.getParameter("accountno").trim().equals("")?"0":request.getParameter("accountno").trim();    
		String remarks = request.getParameter("remarks");
		String cldocno = request.getParameter("cldocno")==null || request.getParameter("cldocno").trim().equals("")?"0":request.getParameter("cldocno").trim();
