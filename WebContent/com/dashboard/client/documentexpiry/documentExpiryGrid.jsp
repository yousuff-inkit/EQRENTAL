...
<script type="text/javascript">
      ...
      var temp='<%=branchval%>';
	  	...
	  	if(temp!='NA'){ 
	  		    data='<%=cld.documentExpiryGridLoading(branchval, upToDate,check, cldocno, active)%>';   
	  		  <%-- DocumentExpiryexcel='<%=cld.documentExpiryGridexcelLoading(branchval,   String cldocno = request.getParameter("cldocno")==null?"0":request.getParameter("cldocno").trim();%>  ,check)%>'; --%>
	  	}
        ...
        $(document).ready(function () {
            ...
            $("#documentExpiry").jqxGrid(
            {
                ...
                columns: [
						...
						{ text: 'Cldocno', datafield: 'cldocno', width: '10%' },
