...
<%	
	...
	try{
		...
		String strSql = "select m.loc_name loc,m.doc_no , u.userid='"+session.getAttribute("USERID").toString()+"' stat from my_locm m left join tr_userloclink u on u.locid=m.doc_no where status=3 and m.brhid='"+brhid+"' and u.userid='"+session.getAttribute("USERID").toString()+"'";     
