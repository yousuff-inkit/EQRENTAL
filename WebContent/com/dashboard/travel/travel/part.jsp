  ...
  <script type="text/javascript"> 
	 var aa1;
            ...
            $(document).ready(function () {
           	 ...
           	 <%-- aa1= '<%=purchaseorderDAO.searchProduct(session,acno,cmbbilltype,dates,"","","","",id,"","","","","")%>'; --%>
                ...
                $("#jqxInput").jqxInput({ source: dataAdapter, displayMember: "part_no", valueMember: "psrno", width: 160, height: 20});
