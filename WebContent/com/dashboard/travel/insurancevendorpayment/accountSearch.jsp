...
#search {
	...
	function getdata(atype,partyname,accNo,contactNo){
		 $("#refreshdiv").load('accountGrid.jsp?atype='+atype+'&partyname='+partyname.replace(/ /g, "%20")+'&accNo='+accNo+'&contactNo='+contactNo+'&check=1');
		}
...
<table width="100%">
  ...
  <tr>
    <td colspan="5"><div id="refreshdiv"><jsp:include page="accountGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
  </div>
</body>
