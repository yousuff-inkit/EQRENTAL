...
<body onload="getBranch();">         
  ...
  <div class="container-fluid">
    ...
    <div class="row">      
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                                          
        <div id="traveldiv"><jsp:include page="profitGrid.jsp"></jsp:include></div>
      </div>
    </div>    
...
<script type="text/javascript">   
    $(document).ready(function(){       
        ...
        $('#btnexcel').click(function(){                
			...
			worksheetName:"Profit Management"  
	        });          
        });
...
function getLocation() {
	...
	x.send();
	 ...
	 function funload(){   
         ...
         $('#traveldiv').load('profitGrid.jsp?check=1'+'&brhid='+brhid+'&locid='+locid+'&todate='+todate+'&fromdate='+fromdate);   
	 }
