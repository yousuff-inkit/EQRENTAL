       ...
       vdata= '<%=DAO.searchRoom(hotel) %>';      
		$(document).ready(function () { 	
            ...
            $('#jqxroomtypeSearch').on('rowdoubleclick', function (event) {               
                ...
                $('#jqxpricegrid').jqxGrid('setcellvalue', rowIndex, "room" ,$('#jqxroomtypeSearch').jqxGrid('getcellvalue', rowindex2, "room"));
                $('#jqxpricegrid').jqxGrid('setcellvalue', rowIndex, "roomid" ,$('#jqxroomtypeSearch').jqxGrid('getcellvalue', rowindex2, "doc_no"));
