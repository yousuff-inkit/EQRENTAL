...
%> 
 ...
 <script type="text/javascript">
 			var data1='<%=sd.mainSearch(session, customer, docNo, date, tno, check,branch)%>';              
            ...
            $("#jqxMainSearch").jqxGrid(
            {
                ...
                columns: [
					 ...
					 { text: 'Date', datafield: 'bookdate', cellsformat: 'dd.MM.yyyy' , width: '15%' },
					 { text: 'Ticket No', datafield: 'ticketno',  width: '15%' },
					]
            });
