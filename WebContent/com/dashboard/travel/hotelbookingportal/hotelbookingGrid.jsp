...
<%         
		...
		int pax = request.getParameter("pax")=="" || request.getParameter("pax")==null?0:Integer.parseInt(request.getParameter("pax").toString());
		...
		String rtype = request.getParameter("rtype")=="" || request.getParameter("rtype")==null?"0":request.getParameter("rtype").trim();
...
<script type="text/javascript">     
      var data1;  
	  		   data1='<%=DAO.bookinggriddata(fromdate,todate,locid,nationid,hotelid,pax,child,rtype,check,child1,child2,child3,child4,child5,child6)%>';       
  	  
        $(document).ready(function () {
        	$("#jqxhotelbook").jqxGrid({ theme: "latextheme" });    
