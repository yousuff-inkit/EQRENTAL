 <%@page import="com.dashboard.travel.invoicegeneration.ClsInvoiceGenerationDAO"%>
 <%  ClsInvoiceGenerationDAO DAO=new ClsInvoiceGenerationDAO(); %>
...
var hdata;
var hdataexcel;
		   hdata='<%=DAO.loadHotelGrid(branch,cldocno,id,session) %>';         
		   hdataexcel='<%=DAO.loadHotelExcel(branch,cldocno,id,session) %>';                                   
        ...
        $("#jqxHotelGrid").jqxGrid(
                {
                    ...
                    columns: [  
						{ text: 'Sr. No.',datafield: '',columntype:'number',cellclassname:cellclassname, width: '4%',cellsrenderer: function (row, column, value) {
							...
							{ text: 'nonvatamt',datafield: 'nonvatamt', width: '7%',cellclassname:cellclassname,hidden:true},
							{ text: 'vatamt',datafield: 'vatamt', width: '7%',cellclassname:cellclassname,hidden:true},
							{ text: 'taxamt',datafield: 'taxamt', width: '7%',cellclassname:cellclassname,hidden:true},         
							...
							{ text: 'Selling Price',datafield: 'sprice', width: '7%',cellclassname:cellclassname,cellsalign:'right',align:'right'},  
