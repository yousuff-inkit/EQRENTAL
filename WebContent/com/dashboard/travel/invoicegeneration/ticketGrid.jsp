...
<%  ClsInvoiceGenerationDAO sd=new ClsInvoiceGenerationDAO(); %>  
...
var tdata;
var tdataexcel;
		   tdata='<%=sd.loadTicketGrid(branch,cldocno,id,session) %>';          
		   tdataexcel='<%=sd.loadTicketExcel(branch,cldocno,id,session) %>';                          
        ...
        $("#jqxTicketGrid").jqxGrid(
                {
                    ...
                    columns: [  
						{ text: 'Sr. No.',datafield: '',columntype:'number',cellclassname:cellclassname, width: '4%',cellsrenderer: function (row, column, value) {
	    					...
	    					{ text: 'Customer',datafield: 'customer', width: '15%',cellclassname:cellclassname},
