                              ...
                              for (var i = 0; i < dataAdapter.records.length; i++) {
                                  if (item.value == dataAdapter.records[i].doc_no) {                  
                                	  ...
                                	  if($('#tourismconfig').val()!=1){
	                                	  document.getElementById("cospricechild").innerHTML="Sell.Price Child: "+dataAdapter.records[i].spchild;    
	                                	  document.getElementById("cospriceadult").innerHTML="Sell.Price Adult: "+dataAdapter.records[i].spadult;
                                	  }
                                	  var adultdis=0.00,childdis=0.00,admaxdis=0.00,chmaxdis=0.00,disper=0.00,spadultvalue=0.00,spchildvalue=0.00;    
                                	  admaxdis=dataAdapter.records[i].admaxdis;
                                	  chmaxdis=dataAdapter.records[i].chmaxdis;   
                                	  spadultvalue=dataAdapter.records[i].spadult;
                                	  spchildvalue=dataAdapter.records[i].spchild;  
                                	  ...
                                	  document.getElementById("cmbtourdiscounttype").value="PAY BACK";       
                                	  adultdis=(parseFloat(admaxdis)*parseFloat(disper))/100;
                                	  childdis=(parseFloat(chmaxdis)*parseFloat(disper))/100;
                                	  document.getElementById("tourdiscountadult").value=0.00;  
                                	  document.getElementById("tourdiscountchild").value=0.00; 
                                	  spadultvalue=parseFloat(spadultvalue)-adultdis;
                                	  spchildvalue=parseFloat(spchildvalue)-childdis;      
                                	  document.getElementById("spchild").value=spchildvalue;    
                                	  document.getElementById("spadult").value=spadultvalue; 
                                	  document.getElementById("tourtotal").value=0.00;          
                                	  /* if($('#privatetr').val()=="1"){                                                                         
                                		  document.getElementById("tourtotal").value=spadultvalue;                                            
                                	  } */     
                                	  break;                  
                                  }  
                              }
