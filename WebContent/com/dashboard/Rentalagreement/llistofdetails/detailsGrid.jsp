        ...
        $(document).ready(function () { 
            ...
            { 
                ...
                editable:false,
			         ...
			         columns: [
							...
							{ text: 'Branch', datafield: 'branchname', width: '8%' },   //voc no
							...
							{ text: 'Contract Fleet', datafield: 'ofleet_no', width: '7%' },
							{ text: 'Contract Reg No', datafield: 'oreg_no', width: '8%' },                                          
							{ text: 'Client Id', datafield: 'cldocno', width: '5%' },
							{ text: 'Client Name', datafield: 'refname', width: '18%' },
							{ text: 'Acc No', datafield: 'acno', width: '5%' }, 
							{ text: 'Agmt Status', datafield: 'agmtstatus', width: '6%' },
							{ text: 'Contact Person', datafield: 'contactperson', width: '8%'},
							{ text: 'Driver', datafield: 'drname', width: '10%'},
							{ text: 'Mob NO', datafield: 'per_mob', width: '8%'},
							{ text: 'Tariff Docno', datafield: 'tdocno', width: '8%'},
							...
							{ text: 'Out Location', datafield: 'outlocation', width: '10%' }, 
							...
							{ text: 'Del. Time', datafield: 'deltime', width: '5%' },
							{ text: 'Ref No', datafield: 'refnos', width: '5%'},
						    { text: 'Manual RA', datafield: 'mrno', width: '5%'},
							{ text: 'In Date', datafield: 'indate', width: '6%',cellsformat:'dd.MM.yyyy'},
							{ text: 'In Time', datafield: 'intime', width: '5%' },
							{ text: 'Col Date', datafield: 'coldate', width: '6%',cellsformat:'dd.MM.yyyy'},
							{ text: 'Col Time', datafield: 'coltime', width: '5%' },
							{ text: 'Rent', datafield: 'rent', width: '4%',cellsformat: 'd2', cellsalign: 'right', align:'right'},
							{ text: 'CDW', datafield: 'cdw', width: '4%',cellsformat: 'd2', cellsalign: 'right', align:'right'},
							...
							{ text: 'Used Days', datafield: 'used_days', width: '6%',cellsformat: 'd2', cellsalign: 'right', align:'right'},
							...
							{ text: 'Project', datafield: 'project_name', width: '10%'},
							{ text: 'branchid', datafield: 'brhid', width: '10%',hidden:true },
							{ text: 'docno', datafield: 'docno', width: '10%',hidden:true },
							{ text: 'Attachment',columntype:'button', datafield: 'attach', width: '8%'},
            ...
            $('#detailsgrid').on('cellclick', function (event) 
            		...
            		var rowindex1=event.args.rowindex;
            			 if(event.args.datafield=="attach"){
            				var docno = $('#detailsgrid').jqxGrid('getcellvalue', rowindex1, "doc_no");
            				var brchid = $('#detailsgrid').jqxGrid('getcellvalue', rowindex1, "brhid");
