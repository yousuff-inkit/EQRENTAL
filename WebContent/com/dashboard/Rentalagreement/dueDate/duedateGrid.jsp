...
var duedateexcel;
 ...
 datasssss='<%=crad.duedate(barchval,uptodate)%>';
duedateexcel='<%=crad.duedateexc(barchval,uptodate)%>';
 aa=0;
 }
            ...
            { 
                ...
                columns: [
                          { text: 'SL#', sortable: false, filterable: false, editable: false,
							...
							{ text: 'Rate', datafield: 'rate', width: '12%'},
							{ text: 'Credit_balance', datafield: 'sum', width: '12%'},
