<%@ page import="com.dashboard.rentalagreementlatest.ClsrentalagreementDAO" %>
                ...
                columns: [
                          { text: 'SL#', sortable: false, filterable: false, editable: false,
							...
							{ text: 'Out Date', datafield: 'odate', width: '5%',cellsformat:'dd.MM.yyyy',editable:false},
							 ...
							 { text: ' ', datafield: 'btnconfirm',columntype: 'button',editable:false, filterable: false,hidden:true},
