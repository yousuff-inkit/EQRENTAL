...
<td width="20%" >
    ...
    <tr><td colspan="2" align="center">
    	<input class="myButton" type="button" class="clearButton" name="clear" id="clear"  value="Clear" onclick="funClearData();">&nbsp;&nbsp;<input type="button" name="btngenerate"  id="btngenerate" value="Generate" class="myButton" onclick="funGenerate();"></td></tr>
	<tr><td colspan="2" align="center">
