...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#agreementDetailsWindow').jqxWindow({
                width: '51%',
                height: '58%',
                maxHeight: '70%',
                maxWidth: '51%',
        ...
        function funreload(event) {
            ...
            $("#notInvoicedDiv").load('notInvoicedGrid.jsp?branchval=' + branchval + '&fromdate=' + fromdate + '&todate=' + todate + '&cldocno=' + cldocno + '&rentaltype=' + rentaltype + '&agmtno=' + agmtno + '&type=' + type+'&cmbcategory='+cmbcategory+'&id=1');
        }
