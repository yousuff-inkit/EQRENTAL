	...
	try{
		 ...
		 if((bibpid.equalsIgnoreCase("1")))
		{
		 ...
		 if((bibpid.equalsIgnoreCase("4")))
			{
			 String name="",mob="",email="",tel="",peraddress="";
			 int salid=0;
			 ...
			 String sqls="select m.name,m.sal_id,m.mob,m.email,m.tel,m.per_address from cm_prosclientm m  where TR_NO="+trdocno+"";
			 ResultSet rsstk = stmt.executeQuery(sqls);
				...
				while(rsstk.next()) {
					...
					peraddress=rsstk.getString("per_address");
				}
			...
			int dat=clientDAO.insert(sqlDate,"CRM",name,"",session.getAttribute("CURRENCYID").toString(),"1", catid,
					salid+"","1",0,"0",0,"0","1","",clientacid,"",0,0,0,1,1,"0.0","0.0","","","","",tel,"","",email,"","","","","","","","", 
					"","","","","","","","","","","","","","","","","","",name,peraddress,mob,0,"",
					"","","",sqlDate,"","",sqlDate,"","",blankarray,blankarray,blankarray,blankarray,blankarray,session,request);
