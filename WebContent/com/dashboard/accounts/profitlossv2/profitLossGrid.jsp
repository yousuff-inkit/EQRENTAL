<%@page import="com.dashboard.accounts.profitlossv2.ClsProfitLoss" %>
...
<style type="text/css">
 ...
 <script type="text/javascript">
 		...
 		if(temp!='NA'){ 
	    		data = '<%=cpl.profitLossGrid(branchval, fromDate, toDate, level1, level2, level3, level4, check, rate, onedaylessdt, entrydate)%>';
	    		dataExcelExport = '<%=cpl.profitLossExcelExport(branchval, fromDate, toDate, level1, level2, level3, level4, check, rate,onedaylessdt, entrydate)%>';
 		}
