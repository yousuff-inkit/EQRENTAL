...
<table width="100%">
  <tr>
    ...
    <td width="30%"><input type="text" name="txtaccountsno" id="txtaccountsno" style="width:85%;height: 20px;" value='<s:property value="txtaccountsno"/>'></td>
    <td width="10%" align="right" style="font-size:9px;">Currency</td>
    <td width="27%"><input type="text" name="txtaccountcurrency" id="txtaccountcurrency" style="width:50%;height: 20px;" value='<s:property value="txtaccountcurrency"/>'></td>
  ...
  <tr>
    ...
    <td colspan="3"><input type="text" name="txtaccountsname" id="txtaccountsname" style="width:80%;height: 20px;" value='<s:property value="txtaccountsname"/>'></td>
  </tr>
  <tr>
