...
<script type="text/javascript">
     	...
     	$(document).ready(function () { 	
          ...
          $('#costtypeSearch').on('celldoubleclick', function (event) {
                ...
                $('#prepaymentDistributionGridID').jqxGrid('setcellvalue', rowindex1, "costtype" ,$('#costtypeSearch').jqxGrid('getcellvalue', rowindex2, "costtype"));
                $('#prepaymentDistributionGridID').jqxGrid('setcellvalue', rowindex1, "costgroup" ,$('#costtypeSearch').jqxGrid('getcellvalue', rowindex2, "costgroup"));
