...
<table width="100%">
  ...
  <td width="7%" align="right" style="font-size:9px;">Account</td>
    ...
    <td hidden width="18%" align="right" style="font-size:9px;">Contact No.</td>
    <td hidden width="49%"><input type="text" name="txtcontactno" id="txtcontactno" style="width:50%;height:20px;" value='<s:property value="txtcontactno"/>'>
