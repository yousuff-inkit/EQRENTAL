...
<%   String branchval = request.getParameter("branchval")==null?"NA":request.getParameter("branchval").trim();
     ...
     String chckopn = request.getParameter("chckopn")==null?"0":request.getParameter("chckopn").trim();
...
<script type="text/javascript">
      ...
      var temp='<%=branchval%>';
	  	...
	  	if(temp!='NA'){ 
	  		   data='<%=DAO.accountsStatement(branchval, fromDate, toDate, accdocno,chckopn,check)%>';
