<%@page import="com.dashboard.accounts.currentageingstatementmonthly.ClsCurrentAgeingStatementMonthlyDAO"%>
<%   ClsCurrentAgeingStatementMonthlyDAO DAO= new ClsCurrentAgeingStatementMonthlyDAO(); %>
...
<script type="text/javascript">
      ...
      var previousmonthname9=''+$('#txtpreviousmonth9').val()+'';
	  	...
	  	if(temp!='NA'){ 
	  		  data='<%=DAO.currentAgeingStatementMonthlyGridLoading(branchval, upToDate, atype, accdocno, salesperson, category, check)%>'; 
	  		dataExcel='<%=DAO.currentAgeingStatementMonthlyExcelExport(branchval, upToDate, atype, accdocno, salesperson, category, check)%>';
	  	}
        ...
        $(document).ready(function () {
            ...
            $("#ageingStatement").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Next Months',  datafield: 'nextmonth',  width: '9%', cellsformat: 'd2',cellsalign:'right',align:'right', aggregates: ['sum'], aggregatesrenderer:rendererstring },
