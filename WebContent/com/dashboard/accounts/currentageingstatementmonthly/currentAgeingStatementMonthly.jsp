...
<script type="text/javascript">
   ...
   function getMonthNames(a){
	...
	if ($("#txtacountno").val()!="") {
	        ...
	        var reurl=url.split("currentAgeingStatementMonthly.jsp");
	...
	function funreload(event){
		 ...
		 $("#currentAgeingStatementMonthlyDiv").load("currentAgeingStatementMonthlyGrid.jsp?branchval="+branchval+'&uptodate='+uptodate1+'&atype='+atype+'&accdocno='+accdocno+'&salesperson='+salesperson+'&category='+category+'&check='+check);
		...
		function funExportBtn(){      
			JSONToCSVCon(dataExcel,'CurrentAgeingStatementMonthWise',true);
		}
...
<td width="80%">
	<table width="100%">
		<tr>
			 <td><div id="currentAgeingStatementMonthlyDiv"><jsp:include page="currentAgeingStatementMonthlyGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
