...
<td width="20%" >
	...
	<td align="left"><input type="text" id="txtlevel5from" name="txtlevel5from" style="width:20%;height:20px;text-align: center;" value='121'/>&nbsp;>=</td></tr>
	 ...
	 <table width="100%" id="loadinbasecurrdiv" hidden>
		<tr>
		<td width="50%"><label class="branch">Load In Base Currency</label></td>
		<td><input type="checkbox" name="chkloadinbasecurr" id="chkloadinbasecurr"/></td>
		</tr>
	</table>
	<table width="100%">
	<tr><td colspan="2">&nbsp;</td></tr>
