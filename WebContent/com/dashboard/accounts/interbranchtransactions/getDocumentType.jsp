...
ClsConnection ClsConnection=new ClsConnection();
	...
	try{
		...
		String strSql = "select t.doc_type dtype,t.menu_name menu from my_menu t left join my_powr p on p.mno=t.mno left join my_user u on u.role_id=p.roleid where t.pmenu in (201100) "
