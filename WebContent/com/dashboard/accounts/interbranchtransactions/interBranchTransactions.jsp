...
<script type="text/javascript">
	...
	function funExportBtn(){
		 ...
		 if(dtype=='IBR'){JSONToCSVCon(dataExcelExport, 'IBBankReceiptVoucher', true);}if(dtype=='IBP'){JSONToCSVCon(dataExcelExport, 'IBBankPaymentVoucher', true);}
		 if(dtype=='IJV'){JSONToCSVCon(dataExcelExport, 'IBJournalVoucher', true);}
	...
	function  funClearInfo(){
		...
		$("#interBranchTransactionsGridID").jqxGrid('clear');
		$("#interBranchTransactionsGridID").jqxGrid('addrow', null, {});
	...
	function funreload(event){
		...
		if(dtype==''){
		 ...
		 if(dtype=='IJV'){documenttype='Listing of IB Journal Voucher (IJV)';}
		
		 $("#overlay, #PleaseWait").show();
		 
		 document.getElementById("lbldoctype").innerText=documenttype; 
		 
			 $("#interBranchTransactionsDiv").load("interBranchTransactionsGrid.jsp?branchval="+branchval+'&fromdate='+fromdate+'&todate='+todate+'&accdocno='+accdocno+'&dtype='+dtype
...
<td width="80%">
	<table width="100%">
		...
		<tr>
			 <td><div id="interBranchTransactionsDiv"><jsp:include page="interBranchTransactionsGrid.jsp"></jsp:include></div></td>
		</tr>
	</table>
</tr>
</table>
