<%@page import="com.dashboard.accounts.interbranchtransactions.ClsInterBranchTransactions"%>
<% ClsInterBranchTransactions DAO= new ClsInterBranchTransactions(); %>
...
<script type="text/javascript">
		...
		if(temp!='NA'){
			  data1='<%=DAO.interBranchTransactionsGridLoading(branchval, fromDate, toDate, accType, accDocno, dType, docRangeFrom, docRangeTo, amtRangeFrom, amtRangeTo,chk)%>';
			  var dataExcelExport='<%=DAO.interBranchTransactionsExcelExport(branchval, fromDate, toDate, accType, accDocno, dType, docRangeFrom, docRangeTo, amtRangeFrom, amtRangeTo,chk)%>';
		}
        ...
        $(document).ready(function () { 
            ...
            $("#interBranchTransactionsGridID").jqxGrid(
            {
                width: '100%',
                height: 470,
                source: dataAdapter,
...
<div id="interBranchTransactionsGridID"></div>
