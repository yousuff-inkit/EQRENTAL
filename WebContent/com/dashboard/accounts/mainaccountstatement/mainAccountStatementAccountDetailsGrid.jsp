        ...
        $(document).ready(function () {
        	...
        	$("#excelExport").click(function() {
        		if(parseInt(window.parent.chkexportdata.value)=="1") {
        			JSONToCSVCon(data3, "MainAccountStatement", true);
    			 } else {
            ...
            $('#accountDetailsGridID').on('rowdoubleclick', function (event) { 
            	  ...
            	  $("#accountDetailsDetailedGridID").jqxGrid({ disabled: false});
         		  $("#accountDetailsDetailedDiv").load("mainAccountStatementDetailedAccountDetailsGrid.jsp?trno="+$('#accountDetailsGridID').jqxGrid('getcellvalue', rowindex1, "tr_no")+'&check='+check);
