	     ...
	     $("#overlay, #PleaseWait").show();
  		   ...
  		   setInterval(function(){ 
  			 ...
  			 if(parseInt(temp)==2) {
  			   ...
  			   $("#accountDetailsDiv").load("mainAccountStatementAccountDetailsGrid.jsp?branchval="+branchval+'&fromdate='+fromdate+'&todate='+todate+'&atype='+atype+'&accdocno='+accountno+'&name='+accountname.replace(/ /g, "%20")+'&check=1');
...
<img alt="excelDocument" src="<%=contextPath%>/icons/excel_new.png">
    ...
    <div id="accountDetailsDiv"><jsp:include page="mainAccountStatementAccountDetailsGrid.jsp"></jsp:include></div><br/>
    <div id="accountDetailsDetailedDiv"><jsp:include page="mainAccountStatementDetailedAccountDetailsGrid.jsp"></jsp:include></div>
