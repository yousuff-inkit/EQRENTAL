        ...
        $(document).ready(function () { 
            ...
            var source = 
            {
                ...
                datafields: [
                            ...
                            {name : 'clstatus', type: 'string'  },
     						...
     						{name : 'originalengine',type:'String'},
     						{name : 'originalyom',type:'String'},
     						{name : 'originalcolor',type:'String'},
							...
							{name : 'repcurkm', type: 'String'  },	
							{name : 'orgcurkm', type: 'String'  },	
							...
							{name : 'orgauthname', type: 'String' },
							{name : 'repauthname', type: 'String' },
							{name : 'code', type: 'String' },
						    {name : 'orgcode', type: 'String' },
							{name : 'repcode', type: 'String' },
                          	],
                          	localdata: datasssss,
            ...
            { 
                ...
                columns: [
						...
						{ text: 'LA NO', datafield: 'doc_no', width: '7%',hidden:true }, 
						...
						{ text: 'Current KM', datafield: 'orgcurkm', width: '5%', cellsalign: 'right', align:'right' },
						...
						{ text: 'Original Authority', datafield: 'orgauthname', width: '10%' },
						{ text: 'Original Plate Code', datafield: 'orgcode', width: '9%' },
						{ text: 'Original Engine',datafield:'originalengine',width:'10%'},
						{ text: 'Original Chassis',datafield:'originalchase',width:'10%'},
						{ text: 'Original Yom',datafield:'originalyom',width:'6%'},  
						{ text: 'Original Color',datafield:'originalcolor',width:'10%'},
						{ text: 'Replaced Fleet',datafield:'replacefleet',width:'8%'},
						{ text: 'Replaced Reg No',datafield:'replaceregno',width:'8%'},
						{ text: 'Replaced Authority', datafield: 'repauthname', width: '10%' },
                        { text: 'Replaced Plate Code', datafield: 'repcode', width: '9%' },
						{ text: 'Replaced Current KM',datafield:'repcurkm',width:'9%', cellsalign: 'right', align:'right'},
