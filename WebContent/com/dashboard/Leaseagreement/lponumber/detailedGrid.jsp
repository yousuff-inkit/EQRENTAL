<%@ page import="com.dashboard.leaseagreement.lponumber.ClsLeaseLpoNumber" %>
<%
	...
	String fromdate = request.getParameter("fromdate")==null?"0":request.getParameter("fromdate").trim();
 	...
 	ClsLeaseLpoNumber crad=new ClsLeaseLpoNumber();
        ...
        $(document).ready(function () { 
            ...
            var source = 
            {
                ...
                datafields: [
                 			...
                 			{name : 'LA NO', type: 'String'  },   //this is the agreement
            ...
            { 
                ...
                columns: [
							...
							{ text: 'LA NO', datafield: 'LA NO', width: '6%' },   //voc no
