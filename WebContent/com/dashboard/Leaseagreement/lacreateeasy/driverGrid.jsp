              ...
              /*   handlekeyboardnavigation: function (event) {
                ...
                */
                ...
                columns: [
							...
							{ text: 'Date of Birth', datafield: 'dob1', width: '6%',cellsformat: 'dd.MM.yyyy',columntype:'datetimeinput'},
							...
							{ text: 'Lic Issued', datafield: 'issdate1', width: '9%',cellsformat: 'dd.MM.yyyy',columntype:'datetimeinput' },
							{ text: 'dbLic Issued', datafield: 'licyr1', width: '9%' ,hidden:true },
							{ text: 'calcuLic Issued', datafield: 'expiryear1', width: '9%' ,hidden:true },
							{ text: 'Lic Expiry', datafield: 'led1', width: '7%',cellsformat: 'dd.MM.yyyy',columntype:'datetimeinput' },
							{ text: 'Lic Type', datafield: 'ltype1', width: '7%',columntype:'dropdownlist',
                                createeditor: function (row, column, editor) {
                                                      editor.jqxDropDownList({ autoDropDownHeight: true, source: list });
                                } },
							{ text: 'Iss From', datafield: 'issfrm1', width: '9%' },
							{ text: 'Passport#', datafield: 'passport_no1', width: '9%' },
							{ text: 'Pass Exp.', datafield: 'pass_exp1', width: '7%',cellsformat: 'dd.MM.yyyy',columntype:'datetimeinput' }, 
