            ...
            { 
                ...
                editable:false,
			         ...
			         columns: [
							...
							{ text: 'Contract Fleet', datafield: 'Contract Fleet', width: '8%',hidden:true },   
							{ text: 'Contract Reg No', datafield: 'Contract Reg No', width: '8%',hidden:true },    
							...
							{ text: 'Rental Type', datafield: 'Rental Type', width: '7%',hidden:true },
							{ text: 'Due Date', datafield: 'Due Date', width: '6%',cellsformat:'dd.MM.yyyy',hidden:true},   
							{ text: 'DueTime', datafield: 'DueTime', width: '5%' ,hidden:true},
							{ text: 'Ref No', datafield: 'Ref No', width: '6%'},
						    { text: 'Manual RA', datafield: 'Manual RA', width: '6%',hidden:true},
