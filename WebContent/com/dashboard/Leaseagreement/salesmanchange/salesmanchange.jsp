...
function funreload(event)
{
	 ...
	 var todate= $("#todate").val(); 
	  ...
	  $("#detlist").load("detailedGrid.jsp?barchval="+barchval+"&fleet="+$("#fleet").val()+"&fromdate="+fromdate+"&todate="+todate+"&cldocno="+document.getElementById("cldocno").value+"&salesmandoc="+document.getElementById("salesmandoc").value+"&status="+document.getElementById("status").value+'&outchk='+$("#outchks").val()+'&inchk='+$("#inchks").val()+'&catid='+$("#catid").val());
