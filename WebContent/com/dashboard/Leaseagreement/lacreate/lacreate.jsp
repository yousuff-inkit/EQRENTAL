...
<td width="20%" >
 ...
 <table width="100%">
  ...
  <tr>
    ...
    <td><input type="text" name="fleetno" id="fleetno" placeholder="Press F3 TO Search" readonly onKeyDown="getFleet(event);" onclick="this.placeholder='' "  style="height:20px;" value='<s:property value="fleetno"/>'></td>
  </tr>
  <tr>
