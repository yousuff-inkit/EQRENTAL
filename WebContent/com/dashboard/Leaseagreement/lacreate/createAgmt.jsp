...
try{
	...
	ClsLeaseAgmtForMasterAlmariahDAO agmtdao=new ClsLeaseAgmtForMasterAlmariahDAO();
	...
	for(int i=0;i<arrdrivers.length;i++){
		...
		if(!temp[8].equalsIgnoreCase("") && !temp[8].equalsIgnoreCase("undefined") && temp[8]!=null){
			sqllicenseexpiry=objcommon.changeStringtoSqlDate(temp[8]);
		}
		if(!temp[7].equalsIgnoreCase("") && !temp[7].equalsIgnoreCase("undefined") && temp[7]!=null){
			sqlissuedate=objcommon.changeStringtoSqlDate(temp[7]);
		}
		if(!temp[12].equalsIgnoreCase("") && !temp[12].equalsIgnoreCase("undefined") && temp[12]!=null){
