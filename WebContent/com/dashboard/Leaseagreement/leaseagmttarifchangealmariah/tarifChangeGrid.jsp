...
{ text: '     '+document.getElementById("maincdw").value,  datafield: 'cdw',renderer: columnsrenderer,cellsformat: 'd2',cellsalign: 'right', align: 'right',cellclassname:'column',hidden:true},
