...
try{
	...
	String oldtarif="";
	int branch=0;
	String stroldtarif="select brhid, rate, cdw, pai, cdw1, pai1, gps, babyseater, cooler, kmrest, exkmrte, chaufchg, chaufexchg, totalcostpermonth, drivercostpermonth, securitypass, fuel, salik, safetyacc, diw, hpd, rateperexhr from gl_ltarif where rdocno="+agmtdocno;
	...
	while(rsoldtarif.next()){
		...
		oldtarif=rsoldtarif.getString("rate")+"::"+rsoldtarif.getString("cdw")+"::"+rsoldtarif.getString("pai")+"::"+rsoldtarif.getString("cdw1")+"::"+rsoldtarif.getString("pai1")+"::"+rsoldtarif.getString("gps")+"::"+rsoldtarif.getString("babyseater")+"::"+rsoldtarif.getString("cooler")+"::"+rsoldtarif.getString("kmrest")+"::"+rsoldtarif.getString("exkmrte")+"::"+rsoldtarif.getString("chaufchg")+"::"+rsoldtarif.getString("chaufexchg")+"::"+rsoldtarif.getString("totalcostpermonth")+"::"+rsoldtarif.getString("drivercostpermonth")+"::"+rsoldtarif.getString("securitypass")+"::"+rsoldtarif.getString("fuel")+"::"+rsoldtarif.getString("salik")+"::"+rsoldtarif.getString("safetyacc")+"::"+rsoldtarif.getString("diw")+"::"+rsoldtarif.getString("hpd")+"::"+rsoldtarif.getString("rateperexhr");
	}
	int maxdocno=0;
	...
	for(int i=0;i<tarifarray.size();i++){
		...
		String strinserttarif="insert into gl_ltarifchange(doc_no,rdocno, brhid, rate, cdw, pai, cdw1, pai1, gps, babyseater, cooler, kmrest, exkmrte, chaufchg, chaufexchg, rstatus,totalcostpermonth, drivercostpermonth, securitypass, fuel, salik, safetyacc, diw, hpd, rateperexhr) values"+
	...
	" chaufexchg="+(tariff[11].equalsIgnoreCase("undefined") || tariff[11].equalsIgnoreCase("") || tariff[11].trim().equalsIgnoreCase("NaN")|| tariff[11].isEmpty()?0:tariff[11].trim())+","+
	" totalcostpermonth="+(tariff[12].equalsIgnoreCase("undefined") || tariff[12].equalsIgnoreCase("") || tariff[12].trim().equalsIgnoreCase("NaN")|| tariff[12].isEmpty()?0:tariff[12].trim())+","+
	" drivercostpermonth="+(tariff[13].equalsIgnoreCase("undefined") || tariff[13].equalsIgnoreCase("") || tariff[13].trim().equalsIgnoreCase("NaN")|| tariff[13].isEmpty()?0:tariff[13].trim())+","+
	" securitypass="+(tariff[14].equalsIgnoreCase("undefined") || tariff[14].equalsIgnoreCase("") || tariff[14].trim().equalsIgnoreCase("NaN")|| tariff[14].isEmpty()?0:tariff[14].trim())+","+
	" fuel="+(tariff[15].equalsIgnoreCase("undefined") || tariff[15].equalsIgnoreCase("") || tariff[15].trim().equalsIgnoreCase("NaN")|| tariff[15].isEmpty()?0:tariff[15].trim())+","+
	" salik="+(tariff[16].equalsIgnoreCase("undefined") || tariff[16].equalsIgnoreCase("") || tariff[16].trim().equalsIgnoreCase("NaN")|| tariff[16].isEmpty()?0:tariff[16].trim())+","+
	" safetyacc="+(tariff[17].equalsIgnoreCase("undefined") || tariff[17].equalsIgnoreCase("") || tariff[17].trim().equalsIgnoreCase("NaN")|| tariff[17].isEmpty()?0:tariff[17].trim())+","+
	" diw="+(tariff[18].equalsIgnoreCase("undefined") || tariff[18].equalsIgnoreCase("") || tariff[18].trim().equalsIgnoreCase("NaN")|| tariff[18].isEmpty()?0:tariff[18].trim())+","+
	" hpd="+(tariff[19].equalsIgnoreCase("undefined") || tariff[19].equalsIgnoreCase("") || tariff[19].trim().equalsIgnoreCase("NaN")|| tariff[19].isEmpty()?0:tariff[19].trim())+","+
	" rateperexhr="+(tariff[20].equalsIgnoreCase("undefined") || tariff[20].equalsIgnoreCase("") || tariff[20].trim().equalsIgnoreCase("NaN")|| tariff[20].isEmpty()?0:tariff[20].trim())+" where rdocno="+agmtdocno;
