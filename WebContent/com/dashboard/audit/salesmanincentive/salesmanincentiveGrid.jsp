<%@page import="com.dashboard.audit.salesmanincentive.ClsSalesmanIncentiveDAO"%>
<%ClsSalesmanIncentiveDAO DAO= new ClsSalesmanIncentiveDAO(); %>
...
<script type="text/javascript">
		...
		if(temp=='1'){ 
			     data='<%=DAO.GridLoading(branch, fromdate, todate, accdocno, check)%>'; 
        ...
        $(document).ready(function () { 	
            ...
            $("#jqxsalesmanincentive").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Date', datafield: 'date', cellsformat: 'dd.MM.yyyy',  width: '4%' },
							...
							{ text: 'Posted Date', datafield: 'c_date', columntype: 'datetimeinput', cellsformat: 'dd.MM.yyyy',  width: '4%' },
							{ text: 'Description', datafield: 'description',  width: '17%' },
							{ text: 'Party Name' , datafield: 'party',  width: '13%' },
    ...
    <div id="jqxsalesmanincentive"></div>
