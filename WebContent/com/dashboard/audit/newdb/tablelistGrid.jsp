...
<script type="text/javascript">
	...
	if(temp=='1'){ 
		 data='<%=DAO.listTables(dbname,check)%>';
	}
    ...
    $("#tablelistGrid").on("bindingcomplete", function (event) {$('#overlay,#PleaseWait').hide();});
    ...
    $("#tablelistGrid").jqxGrid(
    {
        ...
        columns: [
					...
					{ text: 'Tables',datafield:'table_name'},
									
					]
    
    });
    
    $('#tablelistGrid').on('rowdoubleclick', function (event)  { 
