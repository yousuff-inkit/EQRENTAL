...
<script type="text/javascript">
	...
	function funExportBtn(){
		$("#bankReconciliationDiv").excelexportjs({  
       		containerid: "bankReconciliationDiv", 
       		datatype: 'json', 
       		dataset: null, 
       		gridId: "jqxBankReconciliation", 
       		columns: getColumns("jqxBankReconciliation") , 
       		worksheetName:"Bank Reconciliation Audit"
       	}); 
	} 
    ...
    <div class="master-container">
        ...
        <div class="main-content-area">
            ...
            <div class="grid-content-container">
                <div id="bankReconciliationDiv"><jsp:include page="bankReconciliationGrid.jsp"></jsp:include></div>
            </div>
