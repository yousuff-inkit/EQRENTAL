...
<%   String branchval = request.getParameter("branchval")==null?"NA":request.getParameter("branchval").trim();
     ...
     String cmbtype=request.getParameter("cmbtype")==null?"0":request.getParameter("cmbtype").trim();
...
<script type="text/javascript">
      ...
      var temp='<%=branchval%>';
	  	...
	  	if(temp!='NA'){ 
	  		   data='<%=DAO.securityChequeListGridLoading(branchval, upToDate,check,cmbtype)%>';  
	  	}
