 	...
 	//alert(formname);
 	 $("#overlay, #PleaseWait").show();    
 	    ...
 	    if(document.getElementById("rdsummary").checked==true){   
 	     $("#approvaldatediv").load("appmainGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&formname="+formname+"&docno="+docno+'&check=1');	    
   	     //$("#duedetailsgrid").jqxGrid('clear');   
 	
 	}
 	    else if(document.getElementById("rddetailed").checked==true){
 	    $("#approvaldatediv").load("appmainGrid.jsp?barchval="+barchval+"&fromdate="+fromdate+"&todate="+todate+"&formname="+formname+"&docno="+docno+'&check=2');
 	    }
 }
...
<td width="20%" >
	...
	<jsp:include page="../../heading.jsp"></jsp:include>
	 ...
	 <tr><td width="20%" align="right" ><label class="branch">Period From</label></td><td align="left"><div id='fromdate' name='fromdate' value='<s:property value="fromdate"/>'></div>
                    </td></tr>
	...
	<tr>
       <td width="48%" align="center"><input type="radio" id="rdsummary" name="rdo"  value="rdsummary"><label for="rdsummary" class="branch">Summary</label></td>
       <td width="52%" align="center"><input type="radio" id="rddetailed" name="rdo"  value="rddetailed"><label for="rddetailed" class="branch">Detailed</label></td>
       </tr>
