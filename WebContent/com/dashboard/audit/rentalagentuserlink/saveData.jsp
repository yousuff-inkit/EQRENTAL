	...
	try{
		...
		int val=0;
		 ...
		 if(rpttype.equalsIgnoreCase("1")) {
    	 	sql="update my_salesman set salesuserlink="+userdocno+" where status<>7 and doc_no="+salesmanid+" and sal_type='RLA'";
		 ...
		 if(rpttype.equalsIgnoreCase("2")) {
    	 	sql="update my_salesman set salesuserlink=null where status<>7 and doc_no="+salesmanid+" and sal_type='RLA'";
     	 System.out.println(sql);
    	 	val= stmt.executeUpdate(sql);
