...
<script type="text/javascript">
      ...
      var temp='<%=branchval%>';
	  	...
	  	if(temp!='NA'){  
				 ...
				 datas='<%=DAO.appliedGridExcelLoading(branchval, atype, accountno,check)%>'; 
	  	}
        ...
        $(document).ready(function () {
            ...
            $('#appliedDelete').on('rowdoubleclick', function (event) { 
                 ...
                 $('#date').jqxDateTimeInput({disabled: false});$('#txtreason').attr("readonly",false);$('#chckremoveall').attr("disabled",false);$('#btndelete').attr("disabled",false);
