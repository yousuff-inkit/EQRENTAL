                ...
                <div class="sidebar-filters">
                    ...
                    <div class="sidebar-scroll-content">
                        ...
                        <div class="filter-card" style="padding: 10px;">
                            <textarea id="empinfo" name="empinfo" readonly="readonly" style="height: 80px;" placeholder="Employee Info..."><s:property value="empinfo" ></s:property></textarea>
                        </div>
