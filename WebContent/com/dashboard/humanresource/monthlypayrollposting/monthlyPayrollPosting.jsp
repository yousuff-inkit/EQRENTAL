...
<html>
    <head>
        ...
        /* Misc */
        #monthlyPayrollPostingDiv, #JVTDiv, #monthlypayrollTotalDiv {
            border: 1px solid #e3e8ee;
            border-radius: 8px;
            overflow: hidden;
        }
        
        #monthlyPayrollPostingDiv {
            margin-bottom: 15px;
            flex-shrink: 0;
            min-height: 250px;
        }
    ...
    <body onload="getBranch();disable();setValues();">
        <form id="frmDashboardMonthlyPayrollPosting" action="saveDashboardMonthlyPayrollPosting" method="post" style="height: 100%;">
                    ...
                    <div class="sidebar-filters">
                        ...
                        <div class="sidebar-scroll-content">
                            ...
                            <div class="filter-card">
                                ...
                                <p class="bounce"><label id="lbllastposted" name="lbllastposted"><s:property value="lbllastposted"/></label></p>
                            </div>
