...
<table width="100%" class="normaltable" >
  <tr>
    ...
    <td width="30%"><font size="3"><label id="lblcompname" name="lblcompname" ><s:property value="easycmpname"/></label></font></td>
  </tr>
  <tr>
  ...
  <tr>
    <td rowspan="2" align="center"><b><font size="5"><label id="lblprintname1" name="lblprintname1"><s:property value="lblprintname1"/></label></font></b></td>
