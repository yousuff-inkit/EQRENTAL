...
//System.out.println("======aa==== ");		
	...
	Date to=com.changeStringtoSqlDate(request.getParameter("to")); 
			...
			if(!(from==null))
			{
           		...
           		String sql="select r.voc_no,r.brhid,a.refname,t.rate from gl_lagmt r left join my_acbook a on r.cldocno=a.cldocno and dtype='CRM' left join gl_ltarif t on r.doc_no=t.rdocno where outdate>='"+from+"' and outdate<='"+to+"' ";
