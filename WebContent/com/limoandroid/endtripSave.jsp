...
String msg="",stime="",etime="",timevalue="";
int vals=0,extrahr=0,doc=0;
double minkm=0,ridechrg=0,extrakmrate=0,totalkm=0,mincharge=0,excesshrsrate=0,totalchrg=0.0;	
double nightminkmcharge=0.0,nightmincharge=0.0,nightextrakmrate=0.0,nightexcesshrsrate=0.0,vat=0.0,taxamount=0.0,extrahrcharges=0.0,total=0.0;
...
// 		System.out.println("======aa==== "+fleet+":"+regno+":"+mode+":"+del_KM+":"+de_Fuel+":"+deldateOut+":"+deltimeOut);
		...
		Statement stmt=conn.createStatement();
	    		...
	    		String sql="update an_starttripdet set endkm="+endkm+",enddate='"+sqlenddate+"',endtime='"+endtime+"',endlocation='"+city+"' where rowno="+docno+"";
...
//	 							System.out.println("ridech=="+ridechrg);
			...
			String sql12="insert into an_cashinvm(tripcharge, extrahrschrg, totalchrg, vat, nettotal, userid)values("+ridechrg+","+extrahrcharges+","+totalchrg+","+taxamount+","+total+","+userid+")";
