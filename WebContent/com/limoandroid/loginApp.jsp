...
<%	
	...
	String username="", password="",value="",driverid="";
	int userid=0;
...
// 	System.out.println("pass:"+pass);
	try{
		...
		String strSql = "select * from an_userregister where username='"+userName+"' and password='"+passwor+"'";
...
// 				System.out.println("elseeeeeeeee");
	...
	finally
	{
     ...
     response.getWriter().write(value+"::"+userid+"::"+driverid);
  %>