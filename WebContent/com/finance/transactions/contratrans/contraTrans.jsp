...
<form id="frmContraTrans" action="saveContraTrans" method="post" autocomplete="off">
    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row">
                ...
                <div style="display:flex; align-items:center; gap:8px; flex-shrink:0;">
                    <input type="text" id="docno" name="txtcontratransdocno" value='<s:property value="txtcontratransdocno"/>' tabindex="-1" readonly style="width:120px;"/>
        ...
        <!-- Dual Panel: Payment From & Payment To -->
        <div style="display: flex; gap: 15px; margin-bottom: 15px;">
            ...
            <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:70px; flex-shrink:0;">Type</label>
                    <select id="cmbtype" name="cmbtype" onchange="clearClientInfoFrom();funchequedate();" value='<s:property value="cmbtype"/>' style="width:80px; flex-shrink:0;">
                        <option value="CASH">Cash</option>
                        <option value="BANK">Bank</option>
                    </select>
                    <input type="hidden" id="hidcmbtype" name="hidcmbtype" value='<s:property value="hidcmbtype"/>'/>
                    
                    <div class="input-search-container" style="width:100px; flex-shrink:0; margin-left: 8px;">
                        ...
                        <svg class="magnifier-icon" onclick="if($('#mode').val()!='view'){ var date = $('#jqxContraTransDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', date); AccountSearchContent('accountsDetailsSearch.jsp?type1='+$('#cmbtype').val()+'&date='+date); $('#txtfromorto').val(2); }" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                    </div>
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:70px; flex-shrink:0;">Currency</label>
                    <select id="cmbfromcurrency" name="cmbfromcurrency" value='<s:property value="cmbfromcurrency"/>' onchange="getRate(this.value,$('#jqxContraTransDate').val());" style="width:100px; flex-shrink:0;">
                        <option></option>
                    </select>
                    ...
                    <label class="lbl-right" style="width:50px; flex-shrink:0; margin-left: 10px;">Rate</label>
                    <input type="text" id="txtfromrate" name="txtfromrate" value='<s:property value="txtfromrate"/>' onblur="funRoundRate(this.value,this.id);getBaseAmountFrom();" tabindex="-1" style="flex:1; min-width:0; text-align: right;"/>
                </div>

                <div class="field-row">
                    <label class="lbl-right" style="width:70px; flex-shrink:0; margin-top:2px;">
                        <input type="checkbox" id="chckpdc" name="chckpdc" style="vertical-align: middle; margin: 0 4px 0 0;" onclick="funCheck();funPDCDate($('#hidchckpdc').val(),$('#jqxContraTransDate').jqxDateTimeInput('getDate'),$('#jqxChequeDate').jqxDateTimeInput('getDate'));"> PDC
                    </label>
                    ...
                    <label class="lbl-right" style="width:60px; flex-shrink:0;">Chq No.</label>
                    <input type="text" id="txtchequeno" name="txtchequeno" value='<s:property value="txtchequeno"/>' style="width:80px; flex-shrink:0;"/>
                    
                    <label class="lbl-right" style="width:60px; flex-shrink:0; margin-left: 10px;">Chq Date</label>
                ...
                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:70px; flex-shrink:0;">Amount</label>
                    <input type="text" id="txtfromamount" name="txtfromamount" value='<s:property value="txtfromamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountFrom();" style="width:100px; flex-shrink:0; text-align: right;"/>
                    
                    <label class="lbl-right" style="width:70px; flex-shrink:0; margin-left: 10px;">Base Amt</label>
                    <input type="text" id="txtfrombaseamount" name="txtfrombaseamount" value='<s:property value="txtfrombaseamount"/>' tabindex="-1" readonly style="flex:1; min-width:0; text-align: right;"/>
                </div>
            </div>
            ...
            <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:80px; flex-shrink:0; margin-top:2px;">
                        <input type="checkbox" id="chckib" name="chckib" style="vertical-align: middle; margin: 0 4px 0 0;" onclick="funCheckIb();"> Inter-Branch
                    </label>
                    ...
                    <select id="cmbbranch" name="cmbbranch" value='<s:property value="cmbbranch"/>' style="flex:1; min-width:0;">
                        <option value=""></option>
                    </select>
                ...
                <div class="field-row">
                    ...
                    <select id="cmbtotype" name="cmbtotype" onchange="clearClientInfoTo();" value='<s:property value="cmbtotype"/>' style="width:80px; flex-shrink:0;">
                        <option value="CASH">Cash</option>
                        <option value="BANK">Bank</option>
                    </select>
                    ...
                    <div class="input-search-container" style="width:100px; flex-shrink:0; margin-left: 8px;">
                        ...
                        <svg class="magnifier-icon" onclick="if($('#mode').val()!='view'){ var date = $('#jqxContraTransDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', date); AccountSearchContent('accountsDetailsSearch.jsp?type1='+$('#cmbtotype').val()+'&date='+date); $('#txtfromorto').val(3); }" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                    </div>
                ...
                <div class="field-row">
                    ...
                    <select id="cmbtocurrency" name="cmbtocurrency" value='<s:property value="cmbtocurrency"/>' onchange="getRatevalue(this.value,$('#jqxContraTransDate').val());" style="width:100px; flex-shrink:0;">
                        <option></option>
                    </select>
                    ...
                    <input type="text" id="txttorate" name="txttorate" value='<s:property value="txttorate"/>' onblur="funRoundRate(this.value,this.id);getBaseAmountTo();getCrTotal();" tabindex="-1" style="flex:1; min-width:0; text-align: right;"/>
                </div>
                
                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:80px; flex-shrink:0;">Amount</label>
                    <input type="text" id="txttoamount" name="txttoamount" value='<s:property value="txttoamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountTo();getCrTotal();" style="width:100px; flex-shrink:0; text-align: right;"/>
                    
                    <label class="lbl-right" style="width:60px; flex-shrink:0; margin-left: 15px;">Base Amt</label>
                    <input type="text" id="txttobaseamount" name="txttobaseamount" value='<s:property value="txttobaseamount"/>' tabindex="-1" readonly style="flex:1; min-width:0; text-align: right;"/>
                </div>
            </div>
        </div>
