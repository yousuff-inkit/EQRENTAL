...
<table width="100%">
  ...
  <tr>
    ...
    <td width="39%"><input type="text" id="txtfromrate" name="txtfromrate" style="width:35%;text-align: right;" value='<s:property value="txtfromrate"/>' onblur="funRoundRate(this.value,this.id);getBaseAmountFrom();" tabindex="-1"/></td>
  </tr>
  <tr>
