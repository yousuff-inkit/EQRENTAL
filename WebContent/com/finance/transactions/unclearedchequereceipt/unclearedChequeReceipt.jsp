...
<table width="100%">
  ...
  <tr>
    ...
    <td width="45%"><input type="text" id="txtfromrate" name="txtfromrate" style="width:37%;text-align: right;" value='<s:property value="txtfromrate"/>' onblur="funRoundRate(this.value,this.id);getBaseAmountFrom();getDrTotal();" tabindex="-1"/></td>
  </tr>
  <tr>
