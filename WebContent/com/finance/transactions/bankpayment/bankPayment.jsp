    ...
    <div style="display: flex; gap: 15px; margin-bottom: 15px;">
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <input type="text" id="txtfromrate" name="txtfromrate" style="width:120px; text-align:right;" value='<s:property value="txtfromrate"/>' onblur="funRoundRate(this.value,this.id);getBaseAmountFrom();getCrTotal();" tabindex="-1" />
            </div>
            
            <div class="field-row">
                <label class="lbl-right" style="width:100px;">
                    <input type="checkbox" id="chckpdc" name="chckpdc" style="vertical-align: middle; margin-right: 4px; height:auto !important;" onclick="funCheck();funPDCDate($('#hidchckpdc').val(),$('#jqxBankPaymentDate').jqxDateTimeInput('getDate'),$('#jqxChequeDate').jqxDateTimeInput('getDate'));" > PDC
