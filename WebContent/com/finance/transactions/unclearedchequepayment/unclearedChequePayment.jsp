...
<table width="100%">
  ...
  <tr>
    ...
    <td width="45%"><input type="text" id="txtfromrate" name="txtfromrate" style="width:37%;text-align: right;" value='<s:property value="txtfromrate"/>' onblur="funRoundRate(this.value,this.id);getBaseAmountFrom();getCrTotal();" tabindex="-1"/></td>
  </tr>
  <tr>
...
<table width="100%">
  ...
  <tr>
    ...
    <td width="57%"><input type="text" id="txttorate" name="txttorate" style="width:30%;text-align: right;" value='<s:property value="txttorate"/>' onblur="funRoundRate(this.value,this.id);getBaseAmountTo();getDrTotal();" tabindex="-1"/></td>
  </tr>
  <tr>
    <td align="right">Amount</td>
