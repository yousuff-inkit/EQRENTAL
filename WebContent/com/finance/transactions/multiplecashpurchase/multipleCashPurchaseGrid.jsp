        ...
        $(document).ready(function () { 
            ...
            $("#jqxMultipleCashPurchase").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Vendor', datafield: 'vendor',  editable: false, width: '4%' },
							...
							{ text: 'Account Name', datafield: 'accountname1', editable: false, width: '10%' },	
							...
							{ text: 'Cost Type', datafield: 'costgroup', width: '5%',editable: false },
							{ text: 'Cost Id', datafield: 'costtype', width: '5%',hidden: true },
							...
							{ text: 'Vendorid',datafield:'vendorid',width:'5%',editable:false,hidden:true},
							{ text: 'rowno',datafield:'rowno',width:'5%',editable:false,hidden:true},
							{ text: 'Hid-Inv-Date', datafield: 'hidinvdate', editable: false, hidden: true,  width: '5%' },
