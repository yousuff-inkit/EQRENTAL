...
<table width="100%">
  ...
  <tr>
    ...
    <td colspan="3"><input type="text" id="txtrate" name="txtrate" style="width:15%;text-align: right;" value='<s:property value="txtrate"/>' onblur="funRoundRate(this.value,this.id);getBaseAmountFrom();getCrTotal();" tabindex="-1" /></td>
  </tr>
  <tr>
