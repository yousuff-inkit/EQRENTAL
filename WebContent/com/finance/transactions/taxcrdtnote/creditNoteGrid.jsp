	         	   ...
	         	   var rowlength= rows.length;
	                 ...
	                 var amountk= $("#jqxCreditNote").jqxGrid('getcellvalue', i, "amount1");
	      			...
	      			{ 
	             		...
	             		//alert("====="+taxempamount);
	             		 $('#jqxCreditNote').jqxGrid('setcellvalue', i, "taxamount",taxempamount.toFixed(2));  
	             		taxempamount=taxempamount.toFixed(2);  
	          		     var taxtotalamount=parseFloat(amountk)+parseFloat(taxempamount);
	          		 // alert("====="+taxtotalamount);
	          		     $('#jqxCreditNote').jqxGrid('setcellvalue', i, "nettotal",taxtotalamount.toFixed(2));
	          			 
	      			}else{
	      				amountk=parseFloat(amountk);
	     				 $('#jqxCreditNote').jqxGrid('setcellvalue', i, "taxamount" ,"0.00");
		              	   $('#jqxCreditNote').jqxGrid('setcellvalue', i, "nettotal" ,amountk.toFixed(2));  
	     			}
	                 ...
	                 if(isNaN(baseamount)){
		                 ...
		                 if(!isNaN(amountk)){
		                	 amountk=parseFloat(amountk); 
		              	   $('#jqxCreditNote').jqxGrid('setcellvalue', i, "baseamount1" ,amountk.toFixed(2));
