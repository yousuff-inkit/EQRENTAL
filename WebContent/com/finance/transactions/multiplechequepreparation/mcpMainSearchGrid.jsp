...
%> 
 ...
 <script type="text/javascript">
 			...
 			var data1='<%=DAO.mcpMainSearch(session, partyname, docNo, date, amount, chequeNo, chequeDt, check)%>';
            ...
            $("#jqxMultipleChequePreparationMainSearch").jqxGrid(
            {
                width: '99%',
                height: 300,
                source: dataAdapter,
			  ...
			  $('#jqxMultipleChequePreparationMainSearch').on('rowdoubleclick', function (event) {
                var rowindex1=event.args.rowindex;
				funReset();
                document.getElementById("txttoaccname").value= $('#jqxMultipleChequePreparationMainSearch').jqxGrid('getcellvalue', rowindex1, "description");
                document.getElementById("docno").value= $('#jqxMultipleChequePreparationMainSearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
                ...
                funSetlabel();
                document.getElementById("frmMultipleChequePreparation").submit();
    ...
    <div id="jqxMultipleChequePreparationMainSearch"></div>
