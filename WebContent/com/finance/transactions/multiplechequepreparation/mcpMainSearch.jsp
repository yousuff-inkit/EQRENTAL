...
<title>GatewayERP(i)</title>
	...
	$(document).ready(function () {
 	...
 	function getdata(partyname,docNo,date,amount,chequeNo,chequeDt,check){
		 $("#refreshdiv").load('mcpMainSearchGrid.jsp?partyname='+partyname.replace(/ /g, "%20")+'&docNo='+docNo+'&date='+date+'&amount='+amount+'&chequeNo='+chequeNo+'&chequeDt='+chequeDt+'&check='+check);
	}
...
<table width="100%">
  ...
  <tr>
    <td colspan="8"><div id="refreshdiv"><jsp:include  page="mcpMainSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
  </div>
</body>
