    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <div style="display:flex; gap:8px;">
                <input type="text" id="docno" name="txtdebitnotedocno" value='<s:property value="txtdebitnotedocno"/>' tabindex="-1" readonly style="width:120px;" />
        ...
        <div class="field-row">
            ...
            <select id="cmbtype" name="cmbtype" style="width:125px;" onchange="clearClientInfo();" value='<s:property value="cmbtype"/>'>
                <option value="AR">AR</option><option value="AP">AP</option><option value="GL">GL</option>
            </select>
        ...
        <div class="field-row">
            ...
            <input type="text" id="txtrate" name="txtrate" style="width:120px; text-align: right;" value='<s:property value="txtrate"/>' onblur="funRoundRate(this.value,this.id);getBaseAmountFrom();getDrTotal();" tabindex="-1"/>
        </div>
