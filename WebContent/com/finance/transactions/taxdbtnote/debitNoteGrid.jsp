        ...
        $(document).ready(function () { 
            ...
            $("#jqxDebitNote").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Tax Amount', datafield: 'taxamount', cellsformat: 'd2', width: '5%', cellsalign: 'right', align: 'right' , editable: false},  
							{ text: 'NetTotal', datafield: 'nettotal', cellsformat: 'd2', width: '5%', cellsalign: 'right', align: 'right', aggregates: ['sum'],aggregatesrenderer:rendererstring , editable: false},  
            ...
            if(temp>0){
         	  ...
         	  $("#jqxDebitNote").on('cellvaluechanged', function (event) 
         	  {
     			...
     			{ 
            		...
            		//alert("====="+taxempamount);
            		 $('#jqxDebitNote').jqxGrid('setcellvalue', i, "taxamount",taxempamount.toFixed(2));
            		 taxempamount=parseFloat(taxempamount).toFixed(2);    
         		     var taxtotalamount=parseFloat(amountk)+parseFloat(taxempamount);      
         		 // alert("====="+taxtotalamount);
         		     $('#jqxDebitNote').jqxGrid('setcellvalue', i, "nettotal",taxtotalamount.toFixed(2));
         			 
     			}else{
     				amountk=parseFloat(amountk);  
     				 $('#jqxDebitNote').jqxGrid('setcellvalue', i, "taxamount" ,"0.00");
	              	   $('#jqxDebitNote').jqxGrid('setcellvalue', i, "nettotal" ,amountk.toFixed(2));
     			}
            	var value1= $("#jqxDebitNote").jqxGrid('getcellvalue', i, "nettotal");
                 ...
                 if(isNaN(baseamount)){
	              ...
	              if(!isNaN(baseamount)){
	            	  amountk=parseFloat(amountk); 
	              	   $('#jqxDebitNote').jqxGrid('setcellvalue', i, "baseamount1" ,amountk.toFixed(2));
	              }
           ...
           $('#jqxDebitNote').on('celldoubleclick', function (event) {
        	  if(event.args.columnindex == 3){
        		    ...
        		    DebitSearchContent('debitNoteSearch.jsp?atype='+value+'&cmbtype='+$('#cmbtype').val());
                  } 
