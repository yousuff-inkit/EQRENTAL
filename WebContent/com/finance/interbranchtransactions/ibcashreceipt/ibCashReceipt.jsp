...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <input type="text" id="docno" name="txtibcashreceiptdocno" value='<s:property value="txtibcashreceiptdocno"/>' tabindex="-1" style="width:120px;" />
    ...
    <div style="display: flex; gap: 15px; margin-bottom: 15px;">
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                <label class="lbl-right" style="width:100px;">Cash</label>
                <div class="input-search-container" style="width: 120px;">
                    ...
                    <svg class="magnifier-icon" onclick="var d=$('#jqxIBCashReceiptDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', d); accountFromSearchContent('<%=contextPath%>/com/finance/accountsDetailsSearch.jsp?date='+d);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
            ...
            <div class="field-row">
                ...
                <select id="cmbfromcurrency" name="cmbfromcurrency" style="width:120px;" value='<s:property value="cmbfromcurrency"/>' onchange="getRate(this.value,$('#jqxIBCashReceiptDate').val());">
                    <option></option>
                </select>
            ...
            <div class="field-row">
                ...
                <input type="text" id="txtfrombaseamount" name="txtfrombaseamount" style="width:120px; text-align:right;" value='<s:property value="txtfrombaseamount"/>' tabindex="-1" />
            </div>
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <select id="cmbtobranch" name="cmbtobranch" style="width:120px;" onchange="funIBDateInPeriod($('#jqxIBCashReceiptDate').val(),this.value);" value='<s:property value="cmbtobranch"/>'>
                    <option></option>
                </select>
                <input type="hidden" id="hidcmbtobranch" name="hidcmbtobranch" value='<s:property value="hidcmbtobranch"/>' />

                <label class="lbl-right" style="width:50px; margin-left:auto;">Type</label>
            ...
            <div class="field-row">
                ...
                <div class="input-search-container" style="width: 110px;">
                    ...
                    <svg class="magnifier-icon" onclick="var d=$('#jqxIBCashReceiptDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', d); accountToSearchContent('<%=contextPath%>/com/finance/clientAccountDetailsSearch.jsp?atype='+$('#cmbtotype').val()+'&date='+d);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
            ...
            <div class="field-row">
                ...
                <select id="cmbtocurrency" name="cmbtocurrency" style="width:120px;" value='<s:property value="cmbtocurrency"/>' onchange="getRatevalue(this.value,$('#jqxIBCashReceiptDate').val());">
                    <option></option>
                </select>
                ...
                <label class="lbl-right" style="width:50px; margin-left:auto;">Rate</label>
                <input type="text" id="txttorate" name="txttorate" style="width:110px; text-align:right;" value='<s:property value="txttorate"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountTo();getCrTotal();" tabindex="-1" />
            </div>

            <div class="field-row" style="margin-bottom:0;">
                <label class="lbl-right" style="width:70px;">Amount</label>
                <input type="text" id="txttoamount" name="txttoamount" style="width:120px; text-align:right;" value='<s:property value="txttoamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountTo();getAmount();getCrTotal();" />

                <label class="lbl-right" style="width:80px; margin-left:auto;">Base Amount</label>
                <input type="text" id="txttobaseamount" name="txttobaseamount" style="width:110px; text-align:right;" value='<s:property value="txttobaseamount"/>' tabindex="-1" />
            </div>
        </div>
    ...
    <div class="middle-panel">
        ...
        <div id="jqxIbCashApplyInvoicing1" class="grid-container">
        ...
        <div class="field-row" style="margin-top: 15px; justify-content: flex-end; margin-bottom:0;">
            ...
            <input type="text" id="txtapplyinvoiceapply" name="txtapplyinvoiceapply" style="width:100px; text-align:right;" value='<s:property value="txtapplyinvoiceapply"/>' tabindex="-1" />

            <label class="lbl-right" style="width:60px; margin-left:15px;">Balance</label>
            <input type="text" id="txtapplyinvoicebalance" name="txtapplyinvoicebalance" style="width:100px; text-align:right;" value='<s:property value="txtapplyinvoicebalance"/>' tabindex="-1" />
        </div>
    </div>
