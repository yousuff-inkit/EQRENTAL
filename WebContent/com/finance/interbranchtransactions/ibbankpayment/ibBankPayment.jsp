...
#frmIbBankPayment input[type="text"],
#frmIbBankPayment select,
.textbox { 
...
#frmIbBankPayment input[type="text"]:focus,
#frmIbBankPayment select:focus,
.textbox:focus { 
    border-color: #007bff; 
}

#frmIbBankPayment input[readonly],
#frmIbBankPayment input:disabled,
#frmIbBankPayment select:disabled,
.textbox[readonly] { 
...
#bankApplyInvoicing1, #jqxIbBankPaymentGrid {
    border: 1px solid #c5d3e0;
    border-radius: 4px;
    overflow: hidden;
}
...
<script type="text/javascript">
	$(document).ready(function() {
		 ...
		 $("#jqxIbBankPaymentDate").jqxDateTimeInput({ width: '100%', height: '24px', formatString:"dd.MM.yyyy"});
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <div style="display:flex; align-items:center; gap:8px; flex:1; min-width:0;">
                <input type="text" id="docno" name="txtibbankpaydocno" value='<s:property value="txtibbankpaydocno"/>' tabindex="-1" readonly style="width:120px; flex-shrink:0;" />
    ...
    <div style="display: flex; gap: 15px; margin-bottom: 15px;">
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <div class="input-search-container" style="width: 120px; flex-shrink:0;">
                    ...
                    <svg class="magnifier-icon" onclick="var d=$('#jqxIbBankPaymentDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', d); accountFromSearchContent('<%=contextPath%>/com/finance/accountsDetailsSearch.jsp?date='+d);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
            ...
            <div class="field-row">
                ...
                <select id="cmbfromcurrency" name="cmbfromcurrency" style="width:120px; flex-shrink:0;" value='<s:property value="cmbfromcurrency"/>' onchange="getRate(this.value,$('#jqxIbBankPaymentDate').val());">
                    <option></option>
                </select>
                ...
                <input type="text" id="txtfromrate" name="txtfromrate" style="width:120px; text-align:right; flex-shrink:0;" value='<s:property value="txtfromrate"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountFrom();getCrTotal();" tabindex="-1" />
            </div>
            
            <div class="field-row">
                <label class="lbl-right" style="width:80px; flex-shrink:0; display:flex; align-items:center; justify-content:flex-end; gap:4px;">
                    <input type="checkbox" id="chckpdc" name="chckpdc" style="margin:0; height:auto !important; width:auto !important;" onclick="funCheck();funPDCDate($('#hidchckpdc').val(),$('#jqxIbBankPaymentDate').jqxDateTimeInput('getDate'),$('#jqxChequeDate').jqxDateTimeInput('getDate'));" > PDC
            ...
            <div class="field-row">
                ...
                <input type="text" id="txtfromamount" name="txtfromamount" style="width:120px; text-align:right; flex-shrink:0;" value='<s:property value="txtfromamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountFrom();getCrTotal();" />
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <select id="cmbtobranch" name="cmbtobranch" style="flex:1; min-width:0;" onchange="funIBDateInPeriod($('#jqxIbBankPaymentDate').val(),this.value);" value='<s:property value="cmbtobranch"/>'>
                    <option></option>
                </select>
            ...
            <div class="field-row">
                ...
                <div class="input-search-container" style="width: 120px; flex-shrink:0;">
                    ...
                    <svg class="magnifier-icon" onclick="var d=$('#jqxIbBankPaymentDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', d); accountToSearchContent('<%=contextPath%>/com/finance/clientAccountDetailsSearch.jsp?atype='+$('#cmbtotype').val()+'&date='+d);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
            ...
            <div class="field-row">
                <label class="lbl-right" style="width:80px; flex-shrink:0;">Currency</label>
                <select id="cmbtocurrency" name="cmbtocurrency" style="width:120px; flex-shrink:0;" value='<s:property value="cmbtocurrency"/>' onchange="getRatevalue(this.value,$('#jqxIbBankPaymentDate').val());">
                    <option></option>
                </select>
    ...
    <div class="middle-panel">
        ...
        <div id="bankApplyInvoicing1" class="grid-container">
            <center><jsp:include page="applyIbBankInvoicingGrid.jsp"></jsp:include></center>
        </div>
