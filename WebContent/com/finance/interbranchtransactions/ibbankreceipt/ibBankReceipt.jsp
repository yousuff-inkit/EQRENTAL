...
#frmIbBankReceipt input[type="text"],
#frmIbBankReceipt select,
.textbox { 
...
#frmIbBankReceipt input[type="text"]:focus,
#frmIbBankReceipt select:focus,
.textbox:focus { 
    border-color: #007bff; 
}

#frmIbBankReceipt input[readonly],
#frmIbBankReceipt input:disabled,
#frmIbBankReceipt select:disabled,
.textbox[readonly] { 
...
#frmIbBankReceipt td[align="right"],
#frmIbBankReceipt div[align="right"] {
    text-align: right; 
    color: #444;
    font-size: 12px; 
    font-weight: bold;
...
#bankApplyInvoicing1, #jqxIbBankReceiptGrid {
    border: 1px solid #c5d3e0;
    border-radius: 4px;
    overflow: hidden;
}
...
<script type="text/javascript">
	$(document).ready(function() {
		 ...
		 $("#jqxIbBankReceiptDate").jqxDateTimeInput({ width: '100%', height: '24px', formatString:"dd.MM.yyyy"});
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <input type="text" id="txtrefno" name="txtrefno" value='<s:property value="txtrefno"/>' style="width:120px; flex-shrink:0;" />
            
            <label class="lbl-right" style="width:80px; flex-shrink:0; margin-left:auto;">Doc No.</label>
            <div style="display:flex; align-items:center; gap:8px; flex:1; min-width:0;">
                <input type="text" id="docno" name="txtibbankreceiptdocno" value='<s:property value="txtibbankreceiptdocno"/>' tabindex="-1" readonly style="width:120px; flex-shrink:0;" />
                ...
                <span id="txtStatus" style="font-weight:bold; color:#e67e22; white-space:nowrap; margin-left:10px;"></span>
            </div>
        </div>
    </div>
    ...
    <div style="display: flex; gap: 15px; margin-bottom: 15px;">
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <div class="input-search-container" style="width: 120px; flex-shrink:0;">
                    ...
                    <svg class="magnifier-icon" onclick="var d=$('#jqxIbBankReceiptDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', d); accountFromSearchContent('<%=contextPath%>/com/finance/accountsDetailsSearch.jsp?date='+d);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
                <input type="text" id="txtfromaccname" name="txtfromaccname" value='<s:property value="txtfromaccname"/>' tabindex="-1" readonly style="flex:1; min-width:0;" />
            ...
            <div class="field-row">
                ...
                <select id="cmbfromcurrency" name="cmbfromcurrency" style="width:120px; flex-shrink:0;" value='<s:property value="cmbfromcurrency"/>' onchange="getRate(this.value,$('#jqxIbBankReceiptDate').val());">
                    <option></option>
                </select>
                ...
                <input type="text" id="txtfromrate" name="txtfromrate" style="width:120px; text-align:right; flex-shrink:0;" value='<s:property value="txtfromrate"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountFrom();getDrTotal();" tabindex="-1" />
            </div>
            
            <div class="field-row">
                <label class="lbl-right" style="width:80px; flex-shrink:0; display:flex; align-items:center; justify-content:flex-end; gap:4px;">
                    <input type="checkbox" id="chckpdc" name="chckpdc" style="margin:0; height:auto !important; width:auto !important;" onclick="funCheck();funPDCDate($('#hidchckpdc').val(),$('#jqxIbBankReceiptDate').jqxDateTimeInput('getDate'),$('#jqxChequeDate').jqxDateTimeInput('getDate'));" > PDC
                ...
                <label class="lbl-right" style="width:70px; flex-shrink:0;">Cheque No.</label>
            ...
            <div class="field-row">
                ...
                <input type="text" id="txtfromamount" name="txtfromamount" style="width:120px; text-align:right; flex-shrink:0;" value='<s:property value="txtfromamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountFrom();getDrTotal();" />
                
                <label class="lbl-right" style="width:80px; flex-shrink:0; margin-left:auto;">Base Amt</label>
                <input type="text" id="txtfrombaseamount" name="txtfrombaseamount" style="width:120px; text-align:right; flex-shrink:0;" value='<s:property value="txtfrombaseamount"/>' tabindex="-1" readonly />
            </div>
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <select id="cmbtobranch" name="cmbtobranch" style="flex:1; min-width:0;" onchange="funIBDateInPeriod($('#jqxIbBankReceiptDate').val(),this.value);" value='<s:property value="cmbtobranch"/>'>
                    <option></option>
                </select>
                ...
                <select id="cmbtotype" name="cmbtotype" style="width:80px; flex-shrink:0;" onchange="clearClientInfo();" value='<s:property value="cmbtotype"/>'>
            ...
            <div class="field-row">
                ...
                <div class="input-search-container" style="width: 120px; flex-shrink:0;">
                    ...
                    <svg class="magnifier-icon" onclick="var d=$('#jqxIbBankReceiptDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', d); accountToSearchContent('<%=contextPath%>/com/finance/clientAccountDetailsSearch.jsp?atype='+$('#cmbtotype').val()+'&date='+d);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
                <input type="text" id="txttoaccname" name="txttoaccname" value='<s:property value="txttoaccname"/>' style="flex:1; min-width:0;" tabindex="-1" readonly />
            ...
            <div class="field-row">
                <label class="lbl-right" style="width:80px; flex-shrink:0;">Currency</label>
                <select id="cmbtocurrency" name="cmbtocurrency" style="width:120px; flex-shrink:0;" value='<s:property value="cmbtocurrency"/>' onchange="getRatevalue(this.value,$('#jqxIbBankReceiptDate').val());">
                    <option></option>
                </select>
                ...
                <label class="lbl-right" style="width:60px; flex-shrink:0; margin-left:auto;">Rate</label>
                <input type="text" id="txttorate" name="txttorate" style="width:120px; text-align:right; flex-shrink:0;" value='<s:property value="txttorate"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountTo();getDrTotal();" tabindex="-1" />
            </div>
            
            <div class="field-row" style="margin-bottom:0;">
                <label class="lbl-right" style="width:80px; flex-shrink:0;">Amount</label>
                <input type="text" id="txttoamount" name="txttoamount" style="width:120px; text-align:right; flex-shrink:0;" value='<s:property value="txttoamount"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountTo();getAmount();getDrTotal();" />
                
                <label class="lbl-right" style="width:80px; flex-shrink:0; margin-left:auto;">Base Amt</label>
                <input type="text" id="txttobaseamount" name="txttobaseamount" style="width:120px; text-align:right; flex-shrink:0;" value='<s:property value="txttobaseamount"/>' tabindex="-1" readonly />
            </div>
        </div>
    </div>
    ...
    <div class="middle-panel">
        ...
        <div id="bankApplyInvoicing1" class="grid-container">
            <center><jsp:include page="applyIbBankReceiptInvoicingGrid.jsp"></jsp:include></center>
        </div>
        ...
        <div class="field-row" style="margin-top: 15px; justify-content: flex-end; margin-bottom:0;">
            ...
            <input type="text" id="txtapplyinvoiceamt" name="txtapplyinvoiceamt" style="width:100px; text-align:right; flex-shrink:0;" value='<s:property value="txtapplyinvoiceamt"/>' readonly />
            <input type="hidden" id="txtvalidation" name="txtvalidation" value='<s:property value="txtvalidation"/>' />
            
            <label class="lbl-right" style="width:60px; flex-shrink:0; margin-left:15px;">Applied</label>
            <input type="text" id="txtapplyinvoiceapply" name="txtapplyinvoiceapply" style="width:100px; text-align:right; flex-shrink:0;" value='<s:property value="txtapplyinvoiceapply"/>' tabindex="-1" readonly />
            
            <label class="lbl-right" style="width:60px; flex-shrink:0; margin-left:15px;">Balance</label>
            <input type="text" id="txtapplyinvoicebalance" name="txtapplyinvoicebalance" style="width:100px; text-align:right; flex-shrink:0;" value='<s:property value="txtapplyinvoicebalance"/>' tabindex="-1" readonly />
        </div>
    </div>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-top: 15px; justify-content: flex-end; margin-bottom:0;">
            ...
            <input type="text" id="txtdrtotal" name="txtdrtotal" style="width:100px; text-align:right; flex-shrink:0;" value='<s:property value="txtdrtotal"/>' readonly />
            
            <label class="lbl-right" style="width:60px; flex-shrink:0; margin-left:15px;">Cr. Total</label>
            <input type="text" id="txtcrtotal" name="txtcrtotal" style="width:100px; text-align:right; flex-shrink:0;" value='<s:property value="txtcrtotal"/>' tabindex="-1" readonly />
        </div>
    </div>
