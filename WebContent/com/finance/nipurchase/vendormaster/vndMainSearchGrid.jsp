...
<%
 ...
 String chk = request.getParameter("id")==null?"0":request.getParameter("id");
 System.out.println("id in grid====="+chk);
%> 
<script type="text/javascript">
  		
  		var data1= '<%= DAO.vndMainSearch(vndname,vndaccno,vndmob,vndtel,chk) %>';
  		...
  		$(document).ready(function (){ 	
            ...
            $('#jqxVendorSearch').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("txtaccountno").value= $('#jqxVendorSearch').jqxGrid('getcellvalue', rowindex1, "acno");
                ...
                funSetlabel();
                document.getElementById("frmVendorMasterDetails").submit();
