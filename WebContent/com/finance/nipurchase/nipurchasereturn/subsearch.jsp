        ...
        $(document).ready(function () { 
            ...
            $("#refnosearch").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'billtype', datafield: 'billtype', width: '2%' ,hidden:true },
							{ text: 'billtypeid', datafield: 'billtypeid', width: '2%' ,hidden:true },
             ...
             $('#refnosearch').on('rowdoubleclick', function (event) {
                 ...
                 document.getElementById("hidcmbbilltype").value = $('#refnosearch').jqxGrid('getcellvalue', rowindex1, "billtypeid");
                 document.getElementById("cmbbilltype").value = $('#refnosearch').jqxGrid('getcellvalue', rowindex1, "billtypeid");
