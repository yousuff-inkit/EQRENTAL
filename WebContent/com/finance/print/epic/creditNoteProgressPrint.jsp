...
<table width="100%" class="normaltable" >
  ...
  <tr>
    <td rowspan="2"  align="center"><b><font size="5">Tax Credit Note</font></b></td>
...
<table width="100%">
  <tr>
    <td align="left" >Your Account has been <label colspan="2" id="lblcreditordebit" name="lblcreditordebit"><s:property  value="lblcreditordebit"/></label></td>
  
    
    <td width="44%">: <label id="lblaccountname" name="lblaccountname"><s:property value="lblaccountname"/></label></td>
    <td width="4%" align="left"></td>
    <td width="16%">Voucher No</td>
    <td>: <label id="lbldocumentno" name="lbldocumentno"><s:property value="lbldocumentno"/></label></td>
    
  </tr>
  <tr>
    <td width="11%">Customer TRN No</td>
    <td colspan="2">: <label id="lblclienttrno" name="lblclienttrno"><s:property value="lblclienttrno"/></label></td>
    
    <td width="16%" align="left">Voucher Date</td>
    <td width="25%">: <label id="lbldate" name="lbldate"><s:property value="lbldate"/></label></td>
  </tr>
   <tr>
   <td width="11%" align="left">Amount in words </td>
   ...
   <td width="25%">: <label id="lblnetamount" name="lblnetamount"><s:property value="lblnetamount"/></label></td>
  </tr>
  ...
  <s:else>
  <tr>
   <td width="11%" align="left">Agreement Vehicle </td>
   <td colspan="2">: <label id="lblvehicleinfo" name="lblvehicleinfo"><s:property value="lblvehicleinfo"/></label></td>
    
   <td width="16%" align="left">Agreement </td>
   <td width="25%">: <label id="lblagreement" name="lblagreement"><s:property value="lblagreement"/></label></td>
  </tr>
  </s:else>
  <tr>
   ...
   <td width="16%" align="left">Invoice No </td>
   <td width="25%">: <label id="lblinvoiceno" name="lblinvoiceno"><s:property value="lblinvoiceno"/></label></td>
  </tr>
  <tr>
  <td width="11%" align="left">&nbsp;</td>
   ...
   <td width="25%">: <label id="refno" name="refno"><s:property value="refno"/></label></td>
