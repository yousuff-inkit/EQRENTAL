...
<table id="accounting" style="border-collapse: collapse;" width="100%">
  ...
  <tr height="25" style="background-color: #D8D8D8;border-collapse: collapse;">
    <th width="2%" align="center" style="border-collapse: collapse;"><b>Sl No</b></th>
    <th width="4%" align="center" style="border-collapse: collapse;"><b>Acc. No</b></th>
    <th width="4%" align="center" style="border-collapse: collapse;"><b>Acc. Type</b></th>
    <th width="12%" align="center" style="border-collapse: collapse;"><b>Acc. Head</b></th>
    <th width="19%" align="center" style="border-collapse: collapse;"><b>Description</b></th>
    <th width="5%" align="center" style="border-collapse: collapse;"><b>Currency</b></th>
    <th width="7%" align="center" style="border-collapse: collapse;"><b>&nbsp;Costtype</b></th>
    <th width="5%" align="center" style="border-collapse: collapse;"><b>Costcode</b></th> 
    <th width="10%" align="right" style="border-collapse: collapse;"><b>Debit</b></th>
    <th width="11%" align="right" style="border-collapse: collapse;"><b>Credit</b></th>
  </tr>
  </thead>
  <tbody>
  <tr>
      <td colspan="10"><hr noshade size=1 color="#e1e2df" width="100%"></td>
  </tr>
    <%int i=0,l=0; %>
    <s:iterator var="stat" value='#request.printingarraynew' >
   <%l=l+1;i=0;%>
	<tr height="20" style="margin-bottom:10px;">   
