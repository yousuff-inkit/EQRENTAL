...
<table width="100%">
  ...
  <tr>
    ...
    <td width="13%" align="left">Amount </td>
   ...
   <td colspan="2">: <label id="lblnetamountwords" name="lblnetamountwords"><s:property value="lblnetamountwords"/></label></td>
    <td width="13%" align="left">Reference Invoice No </td>
   <td width="14%">: <label id="lblinvoiceno" name="lblinvoiceno"><s:property value="lblinvoiceno"/></label></td>
  </tr>
