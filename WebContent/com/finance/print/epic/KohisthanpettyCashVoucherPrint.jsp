...
<body bgcolor="white" style="font-size:15px;" onload="hidedata()">
...
<jsp:include page="../../../common/KprintHeader.jsp"></jsp:include>
</div>
...
<table width="100%">
  ...
  <tr>
   ...
   <tr>
   <td align="left" width="13%">Amount in words </td>
...
<table id="accounting" style="border-collapse: collapse;" width="100%";display:inline-block;>
  ...
  <tr height="25" style="background-color: #D8D8D8;border-collapse: collapse;">
    <th width="4%" align="center" style="border-collapse: collapse;" ><b>Sl No</b></th>
    <th width="10%" align="center" style="border-collapse: collapse;"><b>Acc. No</b></th>
    <th width="24%" align="left" style="border-collapse: collapse;"><b>Acc. Head</b></th>
    <th width="30%" align="left" style="border-collapse: collapse;"><b>Description</b></th>
    <th width="8%" align="center" style="border-collapse: collapse;"><b>Reg No</b></th>
    <th width="4%" align="center" style="border-collapse: collapse;"><b>Cur</b></th> 
    <th width="8%" align="right" style="border-collapse: collapse;"><b>Debit</b></th>
    <th width="8%" align="right" style="border-collapse: collapse;"><b>Credit</b></th>
  </tr>
  </thead>
  <tbody>
  <tr>
...
<table width="100%" style="margin-top:70%; " >
 <tr>
