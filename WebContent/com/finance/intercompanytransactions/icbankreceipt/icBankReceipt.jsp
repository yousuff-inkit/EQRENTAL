...
<table width="100%">
  <tr>
    ...
    <td width="11%"><div id="icBankReceiptDate" name="icBankReceiptDate" onchange="datechange();" onblur="datechange();" value='<s:property value="icBankReceiptDate"/>'></div>
...
<table width="100%">
  <tr>
    ...
    <td width="19%"><input type="text" id="txtfromrate" name="txtfromrate" style="width:45%;text-align: right;" value='<s:property value="txtfromrate"/>' onblur="getBaseAmountFrom();getDrTotal();funRoundAmt(this.value,this.id);" tabindex="-1"/></td>
  </tr>
  <tr>
