...
/* Cleaned up icon class to prevent background colors */
.icon {
    width: 2.5em;
    height: 2em;
    border: none;
        ...
        <div class='modern-ui hidden-scrollbar'>
            ...
            <div class="middle-panel">
                ...
                <div class="field-row">
                    ...
                    <button type="button" class="icon" id="btnExcelExporter" title="Export current Document to Excel" onclick="funExcelExporter();" style="margin-left: 10px;">
                        <img alt="Export Excel" src="<%=contextPath%>/icons/excel_new.png" style="height:20px;">
                    </button>
