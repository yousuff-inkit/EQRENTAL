...
#jqxJournalVoucherGrid, #jqxJournalVoucherApplyingGrid {
    border: 1px solid #c5d3e0;
    border-radius: 4px;
    overflow: hidden;
}
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            <label class="lbl-right" style="width:80px; flex-shrink:0;">Criteria</label>
            <select id="cmbcriteria" name="cmbcriteria" style="width:160px; flex-shrink:0;" onchange="dateDisable();getPDCAccounts();getPDCPostAccount();clearClientInfo();" value='<s:property value="cmbcriteria"/>'>
            ...
            <label class="lbl-right" style="width:40px; flex-shrink:0;">From</label>
            ...
            <label class="lbl-right" style="width:30px; flex-shrink:0;">To</label>
            <div style="width: 110px; flex-shrink:0;">
            ...
            <label class="lbl-right" style="width:60px; flex-shrink:0;">Posting</label>
            <div style="width: 110px; flex-shrink:0;">
            ...
            <button class="myButton" type="button" id="btnview" name="btnview" onclick="funloadgrid();" style="margin-left:auto; flex-shrink:0;">View</button>
        </div>
        
        <div class="field-row" style="margin-bottom:0;">
            <label class="lbl-right" style="width:80px; flex-shrink:0;">Account Type</label>
            <select id="cmbacctype" name="cmbacctype" style="width:160px; flex-shrink:0;" onchange="clearClientInfo();" value='<s:property value="cmbacctype"/>'>
            ...
            <label class="lbl-right" style="width:40px; flex-shrink:0;">Acc</label>
    ...
    <div class="middle-panel">
        ...
        <div id="jqxJournalVoucherGrid" class="grid-container" style="margin-bottom: 15px;">
    ...
    <div id="pdcPostponedDiv" hidden="true" class="middle-panel" style="background: #f4fdf4; border-color: #c3e6cb;">
        <span class="middle-panel-title" style="background: #f4fdf4; color: #28a745; border-left-color: #28a745;">PDC Postponed Details</span>
        <div class="field-row">
            <label class="lbl-right" style="width:80px; flex-shrink:0;">Bank</label>
            <input type="text" id="txtbankaccid" name="txtbankaccid" style="width:120px; flex-shrink:0;" value='<s:property value="txtbankaccid"/>'/>
            <input type="text" id="txtbankaccname" name="txtbankaccname" style="flex:1; min-width:0;" value='<s:property value="txtbankaccname"/>'/>
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <input type="text" id="txtchequeno" name="txtchequeno" style="width:120px; flex-shrink:0;" value='<s:property value="txtchequeno"/>'/>
