...
<script type="text/javascript">
	...
	function getCategoryAccountGroup(a) {
      ...
      function getClientAlreadyExists(clientname,salutation,docno,mode){
      		var trno=document.getElementById("txtregisteredtrnno").value;
		...
		x.open("GET", "getClientAlreadyExists.jsp?clientname="+clientname+"&salutation="+salutation+"&docno="+docno+"&mode="+mode+"&trno="+trno+"&cmbcategory="+cmbcategory, true);
		x.send();
   }
    ...
    function getPassportNoAlreadyExists(passportno,docno,mode){
	 ...
	 function funNotify(){	
		 ...
		 //alert($('#cmbcategory').val().trim());
		 if($('#cmbtax').val()=='1' && $('#cmbcategory').val().trim()=='2'){
		 ...
		 //Cosmo Validation-20-02-2019
		 
		 if($('#txtpersonal_add1').val().trim()==''){
		 	document.getElementById("errormsg").innerText="Address is mandatory";
		 	return 0;
		 }
		 
		 if($('#personal_tel2').val().trim()==''){
		 	document.getElementById("errormsg").innerText="Mobile No is mandatory";
		 	return 0;
		 }
		 
		 if($('#txtpersonal_email').val().trim()==''){
		 	document.getElementById("errormsg").innerText="Email is mandatory";
		 	return 0;
		 }
		 
		 if($('#txtname').val().trim()==''){
		 	document.getElementById("errormsg").innerText="Sponsor/Company is mandatory";
		 	return 0;
		 }
		 
		 if($('#txtcontractno').val().trim()==''){
		 	document.getElementById("errormsg").innerText="Trade License No is mandatory";
		 	return 0;
		 }
		 
		 if($('#jqxContractDate').jqxDateTimeInput('getDate')==null){
		 	document.getElementById("errormsg").innerText="Trade License Date is mandatory";
		 	return 0;
		 }
