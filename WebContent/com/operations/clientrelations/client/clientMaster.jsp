...
<table width="100%">
  <tr>
    <td width="30%" align="left"><input type="checkbox" id="chckdefault" name="chckdefault" value="" onchange="defaultcheck();" onclick="$(this).attr('value', this.checked ? 1 : 0)">Default
                                 <input type="hidden" id="hidchckdefault" name="hidchckdefault" value='<s:property value="hidchckdefault"/>'/></td>
    <td width="14%" align="right">Salik DXB</td>
  ...
  <tr>
    ...
    <td ><input type="text" id="txtsalikauh" name="txtsalikauh" style="text-align: right;"  value='<s:property value="txtsalikauh"/>'/></td>
    <td colspan="2">&nbsp;</td>
  </tr>
</table>
</fieldset>
...
<div id="tab1">
<div style="width:100%;">
 <div id="cpGridDetails"> <jsp:include page="cpGridDetails.jsp"></jsp:include></div><br/>
