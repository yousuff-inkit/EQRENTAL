...
<table width="100%" >
   ...
   <tr>
    ...
    <td width="595"><input type="text" id="docno" name="docno" style="width:15.2%;" readonly tabindex="-1" value='<s:property value="docno"/>'/></td>
    <tr>
  ...
  <td width="144"> <input type="text" id="clientid" name="clientid" readonly placeholder="Press F3 To Search" value='<s:property value="clientid"/>' onKeyDown="getclientinfo(event);" ondoubleclick="getclientinfo(event);"/></td>
     <td colspan="2" ><input type="text" id="clientname" readonly name="clientname" style="width:40%;" tabindex="-1" value='<s:property value="clientname"/>'/>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <input type="hidden" id="le_clacno" name="le_clacno" style="width:25%;"  value='<s:property value="le_clacno"/>'/>
  ...
  <tr>
  <td align="right"></td><td colspan="3"><input type="text" id="cusaddress"  placeholder="Mobil NO-Address" readonly name="cusaddress" style="width:89.3%; resize: none; " value='<s:property value="cusaddress"/>'>
