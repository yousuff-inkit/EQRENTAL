...
<%--   <table width="100%" >
    <tr>
      ...
      <td width="45%"><b><font size="5PX">Vehicle Delivery Note</font></b></td>
      <tr>
      </table> --%>
      <table width="100%" >
  <tr>
  ...
  <tr>
    <td rowspan="2"  align="center"><b><font size="4">Vehicle Delivery Note</font></b></td>
...
<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;
 ...
 <br> <br> <br>
  ...
  <fieldset><img src='<s:property value="lblvehimagepath"/>' style="width:100%;height:auto;"></fieldset>
</div>
