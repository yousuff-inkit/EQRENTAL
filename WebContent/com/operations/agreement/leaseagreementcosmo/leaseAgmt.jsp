...
$("#duedate").jqxDateTimeInput({ width: '125px', height: '15px',formatString:"dd.MM.yyyy",enableBrowserBoundsDetection: true,value:null});
...
function  funReadOnly(){
	...
	$('#frmLeaseAgreementCosmo input').attr('disabled', true );
	$('#frmLeaseAgreementCosmo textarea').attr('disabled', true );
	$('#frmLeaseAgreementCosmo select').attr('disabled', true);
...
function funRemoveReadOnly(){
	...
	$('#frmLeaseAgreementCosmo input').attr('disabled', false );
	$('#frmLeaseAgreementCosmo textarea').attr('disabled', false );
	$('#frmLeaseAgreementCosmo select').attr('disabled', false);
    ...
    $('#adidrvcharges').attr('readonly', false);
       ...
       $("#jqxgrid2").jqxGrid('clear');
	    ...
	    if($("#mode").val()=='A')  
          ...
          $("#nwevehgrid").jqxGrid('addrow', null, {});
	 	   document.getElementById("leasestatus").innerText="";
	    	}
...
<form id="frmLeaseAgreementCosmo" action="saveLeaseAgreementCosmo" method="post" autocomplete="off">
<script>
...
<table width="100%" >
   ...
   <tr>
    ...
    <td colspan="2"><input type="text" id="docno" name="docno" style="width:15.2%;" readonly tabindex="-1" value='<s:property value="docno"/>'/></td>
    <tr>
  <td width="69" align="right"> Client</td>
  <td width="144"> <input type="text" id="clientid" name="clientid" readonly placeholder="Press F3 To Search" value='<s:property value="clientid"/>' onKeyDown="getclientinfo(event);" ondoubleclick="getclientinfo(event);"/></td>
     <td colspan="3" ><input type="text" id="clientname" readonly name="clientname" style="width:40%;" tabindex="-1" value='<s:property value="clientname"/>'/>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <input type="hidden" id="le_clacno" name="le_clacno" style="width:25%;"  value='<s:property value="le_clacno"/>'/>
  ...
  <tr>
  <td align="right"></td><td colspan="4"><input type="text" id="cusaddress"  placeholder="Mobil NO-Address" readonly name="cusaddress" style="width:89.3%; resize: none; " value='<s:property value="cusaddress"/>'>
  ...
  <tr>
      	...
      	<tr>
        	...
        	<td align="left"><input type="text" name="servicelevel" id="servicelevel" value='<s:property value="servicelevel" />' placeholder="Press F3 to Search" onkeydown="getServiceLevel(event);" hidden=true></td>
        	...
        	<td  align="left"><input type="text" name="leaseserviceamt" id="leaseserviceamt" value='<s:property value="leaseserviceamt"/>' onkeypress="javascript:return isNumber (event);"></td>
  ...
  <option value="2">Period</option>
          ...
          <tr>
            <td><div id="paymentdiv">
              ...
              <td width="20%">
				      <table width="100%"> 
					  <tr>
							<td align="right">Manual LA</td>
							<td><input type="text" id="manualla"  name="manualla" value='<s:property value="manualla"/>'></td>
						</tr>
						<tr>
    ...
    &nbsp;to&nbsp;
     ...
     <div id="newvehdiv">
      ...
      <table width="100%" > 
        <tr>
          <td  align="left" colspan="9" >Temperory Fleet&nbsp;&nbsp;<!-- </td>&nbsp;
   ...
   <!--        </td>
      ...
      <!--     
        ...
        <tr>
          ...
          <td align="left" colspan="2">Fuel&nbsp;&nbsp;<!-- </td>
          <td align="left" colspan="3"> --><select name="cmbfuelout" id="cmbfuelout">  
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <button type="button"  title="Reset"  class="icon" id="cleardata" onclick="clearvehdata()"  value='<s:property value="cleardata"/>'>
          	...
          	<td colspan="2">Due Date &nbsp;<div id="duedate" name="duedate" value='<s:property value="duedate"/>'></div></td>
        </tr>
      </table >
      </fieldset>
