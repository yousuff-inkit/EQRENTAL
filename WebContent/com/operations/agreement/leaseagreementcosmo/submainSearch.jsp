          ...
          /*   $("#jqxmainsearch").jqxGrid('addrow', null, {}); */
				         ...
				         document.getElementById("docno").value=$('#jqxmainsearch').jqxGrid('getcellvalue', rowindex1, "voc_no");
				               document.getElementById("clientid").value=$('#jqxmainsearch').jqxGrid('getcellvalue', rowindex1, "cldocno");
				                ...
				                $('#frmLeaseAgreementCosmo permanentfleet').attr('disabled', false);
				                $('#frmLeaseAgreementCosmo clientid').attr('disabled', false);
				                $('#frmLeaseAgreementCosmo docno').attr('disabled', false); 
				                funSetlabel();
				                
				                $('#frmLeaseAgreementCosmo input').attr('disabled', false ); 
				                
				                document.getElementById("frmLeaseAgreementCosmo").submit();
