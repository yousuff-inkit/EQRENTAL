...
<script>
	$(document).ready(function(e) {
        ...
        $('#btnsearchdoc').click(function(e) {
			...
			$('#mainsearchdiv').load('masterrefnoSearchGrid.jsp?cldocno='+cldocno+'&clientname='+clientname+'&date='+date+'&po='+po+'&refno='+refno+'&vocno='+vocno+'&id=1');
        });
    });
</script>
</head>
...
<table width="100%" border="0">
  ...
  <tr>
    <td colspan="8"><div id="mainsearchdiv"><jsp:include page="masterrefnoSearchGrid.jsp"></jsp:include></div></td>
  </tr>
</table>
</body>
</html>