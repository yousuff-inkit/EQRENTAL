...
<h2 align="right">LEASE AGREEMENT</h2> </td>

		<td  align="right" ><b>LANO :<label id="rentaldoc" name="rentaldoc" ><s:property value="rentaldoc"/></label></b></td>
     ...
     <fieldset><legend><b style="font-size: 11px">Rental Details &nbsp;&nbsp;&nbsp;&nbsp; تفاصيل الايجار</b></legend>  
       <table  width="100%" border="1">
    	...
    	<tr>
    		...
    		<td align="right" style="font-size: 11px"><label id="tariff" name="tariff"><s:property value="tariff"/></label></b></td>
    		    	</tr>
       <%-- <tr>
