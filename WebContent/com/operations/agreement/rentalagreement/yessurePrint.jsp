 					...
 					<td colspan="2">
						...
						<table width="100%">
							...
							<tr>
								...
								<td colspan="2" width="60%"></td>
								<td>&nbsp;</td>
								<td colspan="2">Dubai Police : 999&nbsp;&nbsp;&nbsp;Roadside Assistance : 0589135966</td>
							</tr>
						</table>
					</td>
				</tr>
 					...
 					<fieldset>
     					...
     					<table width="100%" >  
    						...
    						<tr>
      							...
      							<td align="left" colspan="2">Plate Code&nbsp;<label id="ravehplate" name="ravehplate"><s:property value="ravehplate"/></label> </td>
    						</tr> 
