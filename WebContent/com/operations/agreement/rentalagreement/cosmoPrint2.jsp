...
<table width="100%" class="location-table">
  ...
  <tr>
    ...
    <td width="11%" class="borderbottom"><label id="radateout" name="radateout"><s:property value="radateout"/></label>&nbsp;&nbsp;&nbsp;<label id="ratimeout" name="ratimeout"><s:property value="ratimeout"/></label></td>
    ...
    <td class="borderbottom borderright"><label id="duedate" name="duedate"><s:property value="duedate"/></label>&nbsp;&nbsp;&nbsp;<label id="duetime" name="duetime"><s:property value="duetime"/></label></td>
  </tr>
</table>
  ...
  <tr>
    ...
    <td width="50%"><table width="100%" border="0">
      ...
      <table width="100%" border="0">
        ...
        <tr>
          <td class="borderright">Fine Service Charges in :15%</td>
