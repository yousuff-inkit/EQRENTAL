...
<table width="100%"  >
<tr><td width="50%" style="font-size: 11px; vertical-align: bottom;">
<table>
	<tr>
	...
	<tr>
	<tr><td width="40%" style="font-size: 11px">Address: Office no.206,Al Saud Building ,Al Quasis 4,Dubai UAE</td></tr>
<tr><td width="30%" style="font-size: 11px">Tel: +97142833957  Branch Mob: +971563986496</td>
</tr>
</table>
</td>
<td><img src="<%=contextPath%>/icons/epic.jpg" width="200" height="120" align="right" alt=""/></td>
</tr>
<tr>
<td>&nbsp;</td>
<td align="right" style="font-size: 12px; padding-right:15px;"><b><u>www.shiningstarauto.net</u></b></td>
</tr>
...
<table width="100%" >
 ...
 <tr>
   ...
   <tr>
    ...
    <td width="82%" colspan="3" style="font-size: 11px">&nbsp;&nbsp;&nbsp;<label id="radrname" name="radrname"><s:property value="radrname"/></label> &nbsp;&nbsp;اسم السائق</td>
      
    </tr>
    </table>
        <table  width="100%" style="padding:0px">
    <tr>
        <td  width="37%" align="left" style="font-size: 11px">D\L NO [رقم الرخصه القياده]</td>
   ...
   <td width="34%" align="left" style="font-size: 11px">Exp Date [تاريخ الانتهاء]</td>
    ...
    <tr>
    <td width="34%" align="left" style="font-size: 11px">Exp Date [تاريخ الانتهاء]</td>
    <td width="18%" style="font-size: 11px"><label name="passexpdate" id="passexpdate" ><s:property value="passexpdate"/></label></td>
   

    <td width="27%" align="right" style="font-size: 11px">DOB [تاريخ الميلاد]</td>
...
<!--    <tr>
   ...
   <tr> 
  	  <td width="38%" align="left" style="font-size: 11px">Name [اسم]</td>
    ...
    <tr>
      <td width="38%" align="left" style="font-size: 11px">D\L NO [رقم الرخصه القياده]</td>
...
<td>
  ...
  <legend><b style="font-size: 11px">Vehicle&nbsp;&nbsp;&nbsp;&nbsp;   نوع المركبة</b></legend>
     <table width="100%" style="padding:0px" >  
  <tr>
    
    <td width="23%" ><label id="ravehname" name="ravehname" style="font-size: 11px"><s:property value="ravehname"/></label></td>
    <td width="25%"></td>
    ...
    <td width="30%" colspan="2" style="font-size: 11px">Color[اللون]&nbsp;<label id="racolor" name="racolor"><s:property value="racolor"/></label></td>
      ...
      <td style="font-size: 11px"><label id="ravehregno" name="ravehregno"><s:property value="ravehregno"/></label> &nbsp;&nbsp;رقم المركبة</td>
...
<%--      <td align="left" style="font-size: 11px">Group&nbsp;<label id="ravehgroup" name="ravehgroup"><s:property value="ravehgroup"/></label></td>  --%>
    <td align="left" style="font-size: 11px">Chassis no.&nbsp;<label id="ravehgroup" name="ravehgroup"><s:property value="ravehgroup"/></label></td> 
         ...
         <fieldset>
    <legend><b style="font-size: 11px">Out Details  &nbsp;&nbsp;&nbsp;&nbsp;  تفاصيل خروج السيارة  </b></legend>  
       <table style="padding:0px">
  <tr>
    <th align="left" style="font-size: 11px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
    <th width="22%" align="left" style="font-size: 11px">Date [تاريخ]</th>
       <th width="22%" align="left" style="font-size: 11px">Time [وقت]</th>
          <th width="25%" align="left" style="font-size: 11px">Km [كلوميتر]</th>
             <th width="25%" align="left" style="font-size: 11px">Fuel [البيترول]</th>
  </tr>
  <tr>
    ...
    <td width="10%" align="left">KM</td><td width="25%">
     ...
     <fieldset><legend><b style="font-size: 11px">Rental Details &nbsp;&nbsp;&nbsp;&nbsp; تفاصيل الايجار</b></legend>  
      <table  width="100%" style="padding:0px">
    	...
    	<tr>
    		<td style="font-size: 11px"><label id="lblindigorenttype" name="lblindigorenttype"><s:property value="lblindigorenttype"/></label>&nbsp;Tariff[سعر]</td>
    		<td style="font-size: 11px"><label id="lblindigorate" name="lblindigorate"><s:property value="lblindigorate"/></label></td>
    		<td style="font-size: 11px">Discount[الخصم]&nbsp;</td>
    		<td style="font-size: 11px"><label id="lblindigodiscount" name="lblindigodiscount"><s:property value="lblindigodiscount"/></label></td>
    		    	</tr>
    </table>
    <table  width="100%" style="padding:0px" >
       <tr><td style="font-size: 11px">Net Total[صافي المجموع]</td>
    		<td style="font-size: 11px"><label id="lblindigonettotal" name="lblindigonettotal"><s:property value="lblindigonettotal"/></label></b></td>
       
       <td width="15%" style="font-size: 11px">Accessories[مستلزمات]</td><td width="5%" style="font-size: 11px"><label id="raaccessory" name="raaccessory"><s:property value="raaccessory"/></label></td>
        <tr><td width="35%" style="font-size: 11px">Add Driver Charges[قيمة السائق الاضافي] </td><td width="10%" style="font-size: 11px"><label id="raadditionalcge" name="raadditionalcge"><s:property value="raadditionalcge"/></label></td>
       <td width="15%" style="font-size: 11px">KM Limit[حد الكيلوميتر]</td><td width="25%" style="font-size: 11px"><label id="raextrakm" name="raextrakm"><s:property value="raextrakm"/></label></td>
       </tr>
       <tr><td width="35%" style="font-size: 11px">Extra per KM Charge[قيمة الاضافيه كيلوميتر]</td><td width="25%" style="font-size: 11px"><label id="raexxtakmchg" name="raexxtakmchg"><s:property value="raexxtakmchg"/></label></td>
       <td width=35% style="font-size: 11px">Vehicle Service Due [خدمة السيارة مستحقه]</td><td width="25%" style="font-size: 11px"><label id="rarentserdue" name="rarentserdue"><s:property value="rarentserdue"/></label></td></tr>
  </table>
    </fieldset>
...
<!--   			<td width="30%" style="font-size: 11px">[مبلغ تحمل التأمين+٣٠٪؜ قيمة الاضر]</td> -->
  		</tr>
  		<!--  <tr>
  		<td style="font-size: 11px">[مبلغ تحمل التأمين+٣٠٪؜ قيمة الاضر]</td>
  		</tr>  -->
  		<tr>
...
<!--   			<td width="40%" style="font-size: 11px"><input type="checkbox" style="border:2px solid #000;box-shadow:none;background-color:transparent;">Insurance Excess 2500</td> -->
  			
  		</tr>
  		
<!--   		 <tr> -->
<!--   			<td style="font-size: 11px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [مبلغ تحمل التامين  1500]</td> -->
<!--   			<td style="font-size: 11px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [مبلغ تحمل التامين  2500]</td> -->
<!--   		</tr> -->
  		
<!--   		<tr> -->
<!--   			<td width="45%" style="font-size: 11px"><input type="checkbox" style="border:2px solid #000;box-shadow:none;background-color:transparent;">Insurance Excess Zero</td> -->
<!--   			<td width="35%" style="font-size: 11px"><input type="checkbox" style="border:2px solid #000;box-shadow:none;background-color:transparent;">Excess2500 + 30%Damage</td> -->
<!--   		</tr> -->
<!--   		 <tr> -->
<!--   			<td style="font-size: 11px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[مبلغ تحمل التامين صفر]</td> -->
<!--   			<td style="font-size: 11px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[اضافي2500 + ضرا%30]</td> -->
