...
<form id="frmInvoicePrint" action="printrental" autocomplete="off" target="_blank">
 <div style="background-color:white;">
     <table width="100%">
  <tr>
    <td width="18%" rowspan="6"><img src="<%=contextPath%>/icons/epic.jpg" width="140%" height="100%"  alt=""/></td> 
  ...
  <tr>
    <td rowspan="2"  align="center"><b>Rental Agreement No:<label id="rentaldoc" name="rentaldoc" ><s:property value="rentaldoc"/></label></b></td>
    <td align="left"><b>Tel :</b>&nbsp;<label id="lblindigobranchtel" name="lblindigobranchtel"><s:property value="lblindigobranchtel"/></label></td>
    </tr>
  <tr>
    <td align="left"><b>Email :</b>&nbsp;<label id="lblindigobranchemail" name="lblindigobranchemail">asif@kohistanrentacar.com</label></td>
    </tr>
  <tr>
...
<tr>
<td align="left"><b>Mob :</b>&nbsp;+971557865406,+971557862680</td>
</tr>
...
<table width="100%">
	...
	<!-- 	<td width="36.5%" align="center">&nbsp;</td> -->
		<td columnspan=2 align="center"><b>Rental Agreement Status : </b><b><label  id="rastatus" name="rastatus"><s:property value="rastatus"/></label></b></td>
	</tr>
</table>
<%-- <table width="100%">
	<tr>
    		...
    		<td colspan="2">
    			<table width="100%">
    				<tr>
    					...
    					<td width="20%"><img src="<%=contextPath%>/icons/smoking500.jpg" width="150" height="150"  alt=""/>
    					</td>
    					<td width="40%">  
    	...
    	<tr>
    		<td colspan="2">
    			<fieldset><legend><b>Terms & Conditions</b></legend>
    				<p style="font-size:7px;margin-top:5px;" align="justify">
    				<!-- 	I acknowledge receipt of the vehicle identified in this Vehicle Rental Agreement and that its condition is indicated in the Vehicle Check Report. I agree to pay all rental charges and 5 AED Salik charge for every crossing and any charges of fines or offence AED 100 surcharge per fine associated with this vehicle if the fines are below 500. If the fines are above 500 then I agree to pay 20% administrative charges above fine.
    				    I agree to pay AED 500 per black point. I agree to pay 3000 AED in case of impounding or in case of accident which is not covered by insurance policy. I agree to pay damages not covered by Police Report and to pay for any loss of documents or accessories from the vehicle. My signature below shall constitute my authority read, understood and accepted all the terms and conditions listed on the Vehicle Rental Agreements and security deposit amount will be returned after 21 days when the car is returned. 
    				    I agree to return the car at company’s office location.In an event where hirer opt to an early cancellation or termination of initial booking.KOHISTAN Car Rental will not be responsible to refund the unused credits and days. Kohistan Rent A Car cannot impound the vehicle to the legal authority in any case.
  -->
  
  I acknowledge receipt of the vehicle identified in this Vehicle Rental Agreement and that its condition is indicated in the Vehicle Check Report. I agree to pay all rental charges and 5 AED Salik charge for every crossing and any charges of fines or Offence AED 100/- surcharge per fine associated with this vehicle if the fines are below 500/-. If the fines are above 500/- then I agree to pay 20% administrative charges above fine. I agree to pay AED 500/- per black point. 
  <span style="color:red"> In case of any traffic violation, the vehicle impounding (by the Police) is not allowed and the hirer agrees to pay AED 6,000/- (Cash only) as an impounding penalty. </span> 
  I agree to pay damages not covered by Police Report and to pay for any loss of documents or accessories from the vehicle including key of the vehicle. The key lost charges are AED 1500/-. My signature below shall constitute my authority read, understood and accepted all the terms and conditions listed on the Vehicle Rental Agreements and security deposit amount will be returned after 21 days when the car is returned. I agree to return the car at company’s office location. In an event where hirer opt to an early cancellation or termination of initial booking, KOHISTAN Car Rental will not be responsible to refund the unused credits and days.
    			...
    			<fieldset>
    				<table width="100%">
    					...
    					<tr>
    						...
    						<td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> -->
    						<td width="50%">Kohistan’s Driver Signature:</td>
    					<td width="20%">&nbsp;</td>
    					<td width="15%">Date</td>
    					<td width="15%">&nbsp;</td>
    					</tr>
