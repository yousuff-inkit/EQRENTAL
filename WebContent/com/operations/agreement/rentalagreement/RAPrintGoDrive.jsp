...
<tr><td colspan=2><h2 align="center">GO DRIVE</h2></td></tr>
...
<table width="100%" >
 ...
 <tr>
   ...
   <fieldset><legend style="font-size: 11px"><b>Driver Details &nbsp;&nbsp;&nbsp;&nbsp;  </b></legend>
    <table  width="100%" style="padding:0px">
   <tr>
    <td width="20%" align="left" style="font-size: 11px">Name </td>
   ...
   <td colspan="30%" style="font-size: 11px"><label id="radlno" name="radlno"><s:property value="radlno"/></label>&nbsp;&nbsp;&nbsp;</td>
    <td width="40%" align="left" style="font-size: 11px">Exp Date </td>
    ...
    <tr>
      ...
      <tr>
   <td width="20%" align="left" style="font-size: 11px">DOB </td>
   ...
   <tr>
     <td width="35%" style="font-size: 11px">Mobile </td>
  ...
  <fieldset><legend style="font-size: 11px"><b>Additional Driver Details &nbsp;&nbsp;&nbsp;&nbsp;    </b></legend>
    <table  width="100%" style="padding:0px">
<!--    <tr>
   ...
   <tr> 
  	  <td width="35%" align="left" style="font-size: 11px">Name </td>
    ...
    <tr>
     ...
     <tr><td></td></tr>
    <tr>
      <td width="35%" align="left" style="font-size: 11px">Exp Date </td>
     ...
     <tr><td></td></tr>
     <tr>
      <td width="35%" align="left" style="font-size: 11px">DOB </td>
     ...
     <tr><td></td></tr>
    <tr>
    <td width="35%" style="font-size: 11px">Nationality </td>
...
<td>
  ...
  <legend><b style="font-size: 11px">Vehicle Details&nbsp;&nbsp;&nbsp;&nbsp;   </b></legend>
     <table width="100%" style="padding:0px" >  
  <tr>
    <td width="26%" colspan="2" align="left" style="font-size: 11px">Model:&nbsp;<label id="ravehname" name="ravehname"><s:property value="ravehname"/></label></td>
   <%--  <td width="23%" >
    ...
    <td width="30%" colspan="2" style="font-size: 11px">Color:&nbsp;<label id="racolor" name="racolor"><s:property value="racolor"/></label></td>
    </tr>
      <tr>
      <td width="15%" align="left" style="font-size: 11px">Reg No:</td>
    ...
    <td width="15%" align="left" style="font-size: 11px">Authority:</td>
      <td width="20%" style="font-size: 11px"><label id="vehauth" name="vehauth"><s:property value="vehauth"/></label></td>
         ...
         <fieldset>
    <legend><b style="font-size: 11px">Out Details  &nbsp;&nbsp;&nbsp;&nbsp;    </b></legend>  
       <table style="padding:0px">
  <tr>
    <td align="left" style="font-size: 11px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td width="22%" align="left" style="font-size: 11px">Date </td>
       <td width="22%" align="left" style="font-size: 11px">Time </td>
          <td width="25%" align="left" style="font-size: 11px">Km &nbsp;&nbsp;&nbsp; </td>
             <td width="25%" align="left" style="font-size: 11px">Fuel &nbsp;&nbsp;&nbsp; </td>
  </tr>
  <tr><!-- <td>&nbsp;&nbsp;&nbsp;&nbsp;</td> -->
...
<%-- <td style="font-size: 11px"><label id="delfuels" name="delfuels"><s:property value="delfuels"/></label></td> --%>
   ...
   <fieldset>
    <legend><b style="font-size: 11px">Delivery Details &nbsp;&nbsp;&nbsp;&nbsp; </b></legend>  
       <table style="padding:0px">
  <tr>
    <td align="left" style="font-size: 11px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td width="25%" align="left" style="font-size: 11px">Date </td>
       <td width="20%" align="left" style="font-size: 11px">Time  </td>
          <td width="22%" align="left" style="font-size: 11px">Km </td>
             <td width="19%" align="left" style="font-size: 11px">Fuel  </td>
             <td width="19%" align="center" style="font-size: 11px">Signature </td>
  </tr>
  <tr>
...
<td style="font-size: 11px"><label id="rafuelout" name="rafuelout"><s:property value="rafuelout"/></label></td>
        ...
        <fieldset>
				    <legend><b style="font-size: 11px">In Details &nbsp;&nbsp;&nbsp;&nbsp;   </b></legend>  
				       <table style="padding:0px">
				  <tr>
				    <td align="left" style="font-size: 11px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				    <td width="25%" align="left" style="font-size: 11px">Date  </td>
...
<td style="font-size: 11px"><label id="colfuels" name="colfuels"><s:property value="colfuels"/></label></td>
  ...
  <%--   <fieldset>
    ...
    <br>  
     ...
     <fieldset><legend><b style="font-size: 11px">Rental Details &nbsp;&nbsp;&nbsp;&nbsp; </b></legend>  
       <table  width="100%" border="1">
    	...
    	<tr>
    		<td style="font-size: 11px"><label id="lblindigorenttype" name="lblindigorenttype"><s:property value="lblindigorenttype"/></label>&nbsp;Rental Charges</td>
  ...
  <!--   </table> 
    <table  width="100%" style="padding:0px" > -->
       ...
       <tr><td width="15%" style="font-size: 11px">Personal Accident Insurance</td><td width="5%" align="right" style="font-size: 11px"><label id="raaccessory" name="raaccessory"><s:property value="raaccessory"/></label></td></tr>
        <tr><td width="35%" style="font-size: 11px">Add Driver Charges </td><td width="10%" align="right" style="font-size: 11px"><label id="raadditionalcge" name="raadditionalcge"><s:property value="raadditionalcge"/></label></td></tr>
		<tr><td width=35% style="font-size: 11px">Chauffer Charge </td><td width="25%" align="right" style="font-size: 11px"><label id="lblchafcharge" name="lblchafcharge"><s:property value="lblchafcharge"/></label></td></tr>
       ...
       <tr><td width="55%" style="font-size: 11px">Extra per KM Charge</td><td width="25%" align="right" style="font-size: 11px"><label id="raexxtakmchg" name="raexxtakmchg"><s:property value="raexxtakmchg"/></label></td></tr>
       ...
       <tr><td style="font-size: 11px">Net Total</td><td align="right" style="font-size: 11px"><label id="rentaltotals" name="rentaltotals"><s:property value="rentaltotals"/></label></b></td></tr>
  </table>
    </fieldset>
...
<p style="font-size:9px;"><label id="excessinsu" name="excessinsu"><s:property value="excessinsu"/></label> 
...
<!--     </tr> -->
 ...
 <tr><td width="50%" style="text-align:center;"><b>I/We have read, understood and agree to abide by the terms and conditions printed above and overleaf as well</b></td></tr>
  <tr><td width="50%" style="text-align:center;"><b></b></td></tr> 
 </table>
 </fieldset>
 </td></tr>
</table>
...
<tr><td width="20%" align="center"><b>Customer Sign</b></td><td width="20%" align="center"><b>Driver Sign</b></td><td width="20%" align="center"><b>For GO DRIVE</b></td><td width="20%" align="center"><b>Sign On Off Hiring</b></td></tr>
<tr><td width="20%"><fieldset><img src="" style="height:30px;width:60px;" id="imgsignature"/></fieldset></td><td width="20%"><fieldset><br><br><br></fieldset></td><td width="20%"><fieldset><br><br><br></fieldset></td><td width="20%"><fieldset><br><br><br></fieldset></td></tr>
</table>
