        ...
        $(document).ready(function () { 	
            ...
            filterable:true,
               showfilterrow:true,
                ...
                columns: [
					{ text: '<fmt:message key="global.docno"/>', datafield: 'doc_no',  columntype: 'textbox', filtertype: 'input', width: '20%',hidden:true},
					{ text: '<fmt:message key="global.name"/>', datafield: 'sal_name',columntype: 'textbox', filtertype: 'input', width: '100%' }
