	  ...
	  $('#jqxTimeOut').on('change', function (event) {
		   ...
		   if($('#jqxTimeOut').jqxDateTimeInput('getDate')!=null){
			...
			function funReadOnly(){
			    ...
			    $("#ratariffbutton,#btnnewclient").attr("disabled", true);
			...
			function funNotify(){	
				   ...
				   var outstandingamt=document.getElementById("outstandingamt").value;
				   if(outstandingamt!="" && outstandingamt!=null && outstandingamt!="undefined"){
				   	if(parseFloat(outstandingamt)!=0.0){
				   		document.getElementById("errormsg").innerText="";
						document.getElementById("errormsg").innerText="Cannot create RA,Outstanding balance is "+outstandingamt;
						return 0;
				   	}
				   }
	               if($('#rentaldesc').val().trim()==''){
	               		document.getElementById("errormsg").innerText="";
		    	...
		    	if(intimestatus){
				 ...
				 $('#jqxDeliveryOut').jqxDateTimeInput({ disabled: false});
				  ...
				  var valfleet=document.getElementById("txtfleetno").value;
					...
					var securitymode=$('#jqxgridpayment').jqxGrid('getcellvalue',1,'mode');
					if(securitymode=="undefined" || securitymode==null || securitymode=="" || typeof(securitymode)=="undefined"){
						document.getElementById("errormsg").innerText="";
						document.getElementById("errormsg").innerText="Security Mode is mandatory";
						return 0;
					}
					var securityamt=$('#jqxgridpayment').jqxGrid('getcellvalue',1,'amount');
					if(securityamt=="undefined" || securityamt==null || securityamt=="" || typeof(securityamt)=="undefined"){
						document.getElementById("errormsg").innerText="";
						document.getElementById("errormsg").innerText="Security Amount is mandatory";
						return 0;
					}
...
<form id="frmRentalAgreementCosmo" action="saveRentalAgreementCosmo" name="rentalform" method="post"  autocomplete="off">
...
<td width="20%"> 
	<table width="100%">
        ...
        <tr>
       		<td align="center" colspan="3"><i><b><label id="rentalstatus"  name="rentalstatus"   style="font-size: 13px;font-family: Tahoma; color:#6000FC"><s:property value="rentalstatus"/></label></b></i></td>
       	</tr>
       	<tr>
       		<td align="center" colspan="3"><button type="button" name="btnnewclient" id="btnnewclient" class="myButton">Create New Client</button></td>
       	</tr>
    </table>
</td></tr></table>
...
<tr>
<td align="right">Project</td><td><input type="text" id="rentalproject"  name="rentalproject" value='<s:property value="rentalproject"/>' placeholder="Press F3 to Search" readonly>
</td>
