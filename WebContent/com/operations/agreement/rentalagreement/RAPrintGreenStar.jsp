 ...
 <tr>
  ...
  <tr>
    ...
    <td  width="35%" align="left" style="font-size: 11px">Driving License NO</td>
     <td colspan="30%" style="font-size: 11px"><label id="radlno" name="radlno"><s:property value="radlno"/></label>&nbsp;&nbsp;&nbsp;</td></tr>
     <tr><td width="40%" align="left" style="font-size: 11px">Exp Date [تاريخ الانتهاء]</td>
     <td colspan="30%" style="font-size: 11px"><label id="licexpdate" name="licexpdate" ><s:property value="licexpdate"/></label></td></tr>
     <tr> <td width="35%" align="left" style="font-size: 11px">Passport NO</td>
    <td colspan="30%" style="font-size: 11px"><label name="passno" id="passno" ><s:property value="passno"/></label>&nbsp;&nbsp;&nbsp;</td></tr>
    <tr> <td width="40%" align="left" style="font-size: 11px">Exp Date [تاريخ الانتهاء]</td>
    <td width="30%" style="font-size: 11px"><label name="passexpdate" id="passexpdate" ><s:property value="passexpdate"/></label></td></tr>
       ...
       <td width="20%" align="left" style="font-size: 11px">Time [الوقت] </td>
          <td width="22%" align="left" style="font-size: 11px">Km [كيلومتر]</td>
             <td width="19%" align="left" style="font-size: 11px">Fuel [الوقود] </td>
              <tr> <td width="19%" align="center" style="font-size: 11px">Signature [التوقيع] </td>
  </tr>
  <tr>
