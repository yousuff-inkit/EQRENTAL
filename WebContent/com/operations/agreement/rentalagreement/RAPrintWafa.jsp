...
<table width="100%" style="padding-top:55px;">
	<tr>
...
<table width="100%">
	...
	<tr>
		...
		<td>&nbsp;</td>
		<td colspan="2">Dubai Police : 999&nbsp;&nbsp;&nbsp;</td>
	</tr>
</table>
<table width="100%" >
  <tr>
...
جميع سيلرات اشركة لديها ـامين شامل ، في حال التسبب في حادث او تقرير ضد مجهول يتوجب على  المستأجر دفع  مبلغ 1500 درهم بالاضافة الى عدد ايام اصلاح السيارة  المستاجرة
  ...
  <!--   <tr>
    <td><fieldset>
    	<p style="font-size:9px;">Accidents: In the event of an accident, you must notify the police immediately. You should not move the vehicle until the police issue a report. Failure to submit a police report to Yes Sure Car Rental will render you liable for all coS1 incurred as s result of the accident. Call Police at 999.
الحوادث : في حالة وقوع حادث، يجب أن تخطر الشرطة على الفور. يجب أن لا تحرك السيارة حتى تصدر الشرطة تقرير الحادث. إن الفشل في تقديم تقرير الشرطة لشركتنا تجعلك مسؤولا عن جميع التكاليف المتكبدة نتيجة للحادث. استدعاء الشرطة  999.
    	</p></fieldset></td>
    </tr> -->
    <tr>
    <td><fieldset>
...
النظافة : إبقاء داخل / خارج السيارة نظيف في كل الأوقات هي مسؤولية العميل السيارات القذرة القادمة للخدمة أو الارجاع تجذب رسوم تنظيف
    ...
    <tr>
    <td><fieldset>
    	20% of the repair cost is related by the tenant if the driver is under 20 years of age or the driver's license is less than six months.
20% من قيمة الاصلاح يتحملها المستأجر في حالة كان عمر السائق تحت 20 أو رخصة القيادة أقل من ستة أشهر
    ...
    <tr>
    <td><fieldset>
    	Traffic Fines: For every traffic and municipality One incurred during the rental period, you will be charged AED 40/ fee to cover administration costs. All costs related to car confiscation will be charged to customer.
المخالفات المرورية : يضاف 40 درهما على قيمة كل مخالفة مرورية يرتكبها المستأجر خلال فترة الإيجار وتحمل جميع التكاليف المتعلقة بمصادرة السيارة إلى العملاء
