...
<table width="100%" >
  ...
  <table width="100%" >
    ...
    <td width="50%"><label id="clmobno" name="clmobno"><s:property value="clmobno"/></label></td>
    <td width="18%" align="left">TRN NO</td>
    <td width="50%"><label id="lblclientrn" name="lblclientrn"><s:property value="lblclientrn"/></label></td>
 </tr>
 <tr>
...
Failure to provide one will result in additional charges. Customer who opt out of CDW will be liable to pay the excess deductible amount of 1500.00
...
<legend><b>Salik (Road tolls)</b></legend>
 By putting your initial in the box provided below you agree to pay salik charges of 5 Dhs for each crossing .These charges will be added to the end of the rental, or as and when we are notified by the RTA.
<table width="100%" >
<tr><td  width="50%"></td><td width="50%" height="25px" > <fieldset style="height:100%;"></fieldset></td>
</tr>
</table>
