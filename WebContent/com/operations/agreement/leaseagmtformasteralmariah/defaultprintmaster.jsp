...
<p align="justify">Rent a car , hereafter called “Lessor” rents the vehicle(s) that is/are mentioned in the “Rental/LeaseAgreement,
...
<ul class="a">
  ...
  <li>Return the vehicle with full tank of fuel and if not pay for the fuel as per current  fuel tariff (approx. 1.25 x of the actual cost), based on the fuel levels as mentioned in Vehicle Check Out- &In Report.</li>
...
<ul> 
 ...
 <li>Drivers 23-25 years with prior approval at  Management discretion: Excess AED 2,000 + 25% of total repair cost</li>
