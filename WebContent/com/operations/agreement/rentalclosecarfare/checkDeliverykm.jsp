...
try{
	...
	*/
	...
	long datedifftemp=date2.getTime()-outdate.getTime();
	long datedifftemp2 = datedifftemp / (24 * 60 * 60 * 1000);	
	
	System.out.println(advchk+"##"+advinvcount+"##"+datedifftemp2+"##"+monthcalvalue);
	if(closecal==1){
		if(firstinvstatus==1){
			closecalflag=1;
		...
		else if(advchk==1 && advinvcount==1 && datedifftemp2<monthcalvalue){
			/* date2.compareTo(invdate)<=0 */
			closecalflag=1;
			closeinvdate=invdate;
			System.out.println("Case 2");
			 datedifftemp=date2.getTime()-closeinvdate.getTime();
			 datedifftemp2 = datedifftemp / (24 * 60 * 60 * 1000);	
  		...
  		System.out.println("Checking:"+nocreditdatediff+"////"+startdays);
			if(nocreditdatediff<startdays && advchk==1 && advinvcount==1){
				...
				int nocreditconfig=closedao.getNoCreditConfig(conn);
				if(nocreditconfig>0){
				datediff=0;
				closeinvdate=invdate;
				finaltime1="0.0";
