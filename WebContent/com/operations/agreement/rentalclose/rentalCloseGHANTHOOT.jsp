...
$(document).ready(function () {
  ...
  getAgmtLocation();
	...
	//$("#tarifreferencegrid").jqxGrid({ disabled: true});
	 ...
	 $("#collectdate").jqxDateTimeInput({ width: '125px', height: '15px',formatString:"dd.MM.yyyy"});
	...
	// $("#policecollecteddate").jqxDateTimeInput({ width: '125px', height: '15px',formatString:"dd.MM.yyyy"});
	 $("#intime").jqxDateTimeInput({ width: '80%', height: '17px', formatString: 'HH:mm', showCalendarButton: false });
	 $("#collecttime").jqxDateTimeInput({ width: '80%', height: '17px', formatString: 'HH:mm', showCalendarButton: false});
	//Minimize Button
		   ...
		   $('#tarifagmtgrid').jqxGrid({ disabled: false});
		    ...
		    if(document.getElementById("mode").value=='A'){
		    	 ...
		    	 $('#btnprocess').attr('disabled',false);
				  ...
				  $('#indate').jqxDateTimeInput('setDate',new Date());
				  $('#intime').jqxDateTimeInput('setDate',new Date());
				$('#collectdate').jqxDateTimeInput('setDate',new Date());
				$('#collecttime').jqxDateTimeInput('setDate',new Date());
				  $('#lblchkorgregcard').hide();
					$('#chkorgregcardcollect').hide();
					$('#description').css('width','99%');
					if($('#hidchkorgregcard').val()=='1'){
