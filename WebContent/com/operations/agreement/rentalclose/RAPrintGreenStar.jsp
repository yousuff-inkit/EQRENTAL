...
<td style="font-size: 11px"><label id="colfuels" name="colfuels"><s:property value="colfuels"/></label></td>
  ...
  <!--   </table>
    <table  width="100%" style="padding:0px" > -->
       ...
       <tr><td width="15%" style="font-size: 11px">SCDW</td><td width="5%" align="right" style="font-size: 11px"><label id="racdwscdw" name="racdwscdw"><s:property value="racdwscdw"/></label></td></tr>
       <tr><td width="15%" style="font-size: 11px">PA1</td><td width="5%" align="right" style="font-size: 11px"><label id="raaccessory" name="raaccessory"><s:property value="raaccessory"/></label></td></tr>
 ...
 <fieldset>
	<table width="100%">
		<tr>
		<td><p style="font-size:9px;">I understand that in case of accident ,even though availed SCDW ,must be accompanied by a valid police report.if without SCDW ,I will be liable to pay excess insurance charges of AED .0.00</p> 
<p style="font-size:9px;">أنا أفهم أنه في  حالة وقوع حادث ، على الرغم من حصول التنازل عن أضرار الاصطدام الفائق(scdw)، يجب أن يرافقه تقريرساري المفعول لشرطة. إذا لم يوجد (scdw)، فسأكون مسؤولاً عن دفع رسوم تأمين زائدة بقيمة 0 درهم.
...
<table width="100%">
<tr><td width="20%" align="center"><b>Customer Sign</b></td><td width="20%" align="center"><b>Driver Sign</b></td><td width="20%" align="center"><b>For GreenStar</b></td><td width="20%" align="center"><b>Sign On Off Hiring</b></td></tr>
<tr><td width="20%"><fieldset><br><br><br></fieldset></td><td width="20%"><fieldset><br><br><br></fieldset></td><td width="20%"><fieldset><br><br><br></fieldset></td><td width="20%"><fieldset><br><br><br></fieldset></td></tr>
</table>
