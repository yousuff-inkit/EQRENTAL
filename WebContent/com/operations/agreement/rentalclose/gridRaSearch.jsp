            ...
            $("#gridRaSearch").jqxGrid(
            {
               ...
               // pageable: true,
                ...
                columns: [
							...
							{ text: 'Out Date', datafield: 'odate', width: '30%',hidden:true,cellsformat:'dd.MM.yyyy'},
							{ text: 'Out Time', datafield: 'otime', width: '30%',hidden:true },
							{ text: 'Inv Type', datafield: 'invtype', width: '30%',hidden:true }
							]
            });
...
//				document.getElementById("description").value=$('#gridRaSearch').jqxGrid('getcellvalue', rowindex1, "desc1");
				...
				document.getElementById("invtype").value=$('#gridRaSearch').jqxGrid('getcellvalue', rowindex1, "invtype");
				...
				checkConvertion();
				getAgmtDates(doctemp);	
				if(document.getElementById("defaultdate").value=="1"){
        ...
        function getAgmtDates(doctemp){
    		...
    		x.onreadystatechange = function() {
    			if (x.readyState == 4 && x.status == 200) {
    				 ...
    				 if(showagmtdate=="1"){
    					 document.getElementById("errormsg").innerText="Created On "+showdate+"  "+showtime;	 
    				 }
