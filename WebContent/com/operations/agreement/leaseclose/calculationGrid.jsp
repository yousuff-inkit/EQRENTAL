...
{ text: 'Salik AUH Amt',  datafield: 'salikauhamt',  width: '17.5%',hidden:true},
{ text: 'Salik DXB Amt',  datafield: 'salikdxbamt',  width: '17.5%',hidden:true},
{ text: 'Salik AUH Srvc',  datafield: 'salikauhsrvc',  width: '17.5%',hidden:true},
{ text: 'Salik DXB Srvc',  datafield: 'salikdxbsrvc',  width: '17.5%',hidden:true},
{ text: 'Salik AUH Count',  datafield: 'salikauhcount',  width: '17.5%',hidden:true},
{ text: 'Salik DXB Count',  datafield: 'salikdxbcount',  width: '17.5%',hidden:true},
{ text: 'Salik AUH Rate',  datafield: 'salikauhrate',  width: '17.5%',hidden:true},
{ text: 'Salik DXB Rate',  datafield: 'salikdxbrate',  width: '17.5%',hidden:true},
{ text: 'Salik AUH Srvc Rate',  datafield: 'salikauhsrvcrate',  width: '17.5%',hidden:true},
{ text: 'Salik DXB Srvc Rate',  datafield: 'salikdxbsrvcrate',  width: '17.5%',hidden:true},
