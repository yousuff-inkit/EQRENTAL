 ...
 <%
 ClsMasterLeaseAgmtAlmariahDAO viewDAO= new ClsMasterLeaseAgmtAlmariahDAO();
...
$(document).ready(function () { 
            ...
            $("#mainSearchGrid").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'Ref Type', datafield: 'reftype', width: '8%',hidden:true  },
					{ text: 'Qot Ref No', datafield: 'qotrefno', width: '21%',hidden:true  }, 
					{ text: 'Project Name', datafield: 'projectname', width: '20%',hidden:true },
					{ text: 'Project No', datafield: 'projectno', width: '20%',hidden:true },
					{ text: 'Driver',datafield: 'driver',width: '10%',hidden:true},
					{text : 'Security Pass',datafield: 'security_pass',width:'10%',hidden:true},
					{text : 'Fuel', datafield: 'fuel',width:'10%',hidden:true}
           ...
           $('#mainSearchGrid').on('rowdoubleclick', function (event) 
               ...
               $('#cmbreftype,#hidcmbreftype').val($('#mainSearchGrid').jqxGrid('getcellvalue', rowindex1, "reftype"));
               $('#qotrefno,#hidqotrefno').val($('#mainSearchGrid').jqxGrid('getcellvalue', rowindex1, "qotrefno"));
               $('#projectno').val($('#mainSearchGrid').jqxGrid('getcellvalue', rowindex1, "projectname"));
               $('#hidprojectno').val($('#mainSearchGrid').jqxGrid('getcellvalue', rowindex1, "projectno"));
               ...
               $('#masterleasegriddiv').load('masterLeaseGrid.jsp?id=1&docno='+$('#docno').val()+'&reftype='+$('#cmbreftype').val());
               
               document.getElementById("driver").value=$('#mainSearchGrid').jqxGrid('getcellvalue', rowindex1,"driver");
               document.getElementById("security_pass").value=$('#mainSearchGrid').jqxGrid('getcellvalue', rowindex1,"security_pass");
               document.getElementById("fuel").value=$('#mainSearchGrid').jqxGrid('getcellvalue', rowindex1,"fuel");
