       ...
       // alert(data);
        $(document).ready(function () { 	
            ...
            $('#jqxbtntarif').on('rowdoubleclick', function (event) 
				...
				$('#rentalQuoteGrid').jqxGrid('setcellvalue',gridindex,'maxdiscount',$('#jqxbtntarif').jqxGrid('getcellvalue',rowindex,'maxdiscount'));
				$('#rentalQuoteGrid').jqxGrid('setcellvalue',gridindex,'rate',$('#jqxbtntarif').jqxGrid('getcellvalue',rowindex,'rate'));
				$('#rentalQuoteGrid').jqxGrid('setcellvalue',gridindex,'tarifdocno',$('#jqxbtntarif').jqxGrid('getcellvalue',rowindex,'doc_no'));
