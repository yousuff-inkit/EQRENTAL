	...
	loaddata='<%=cvd.getEquipData(docno,fleetname,fleetno,regno,date,session,engine,chassis,id)%>';
        ...
        $(document).ready(function () { 
			...
			{ 
				...
				$('#rentalQuoteGrid').jqxGrid('setcellvalue',gridindex,'code',$('#equipSearchGrid').jqxGrid('getcellvalue',rowindex,'code'));
				$('#rentalQuoteGrid').jqxGrid('setcellvalue',gridindex,'subcatid',$('#equipSearchGrid').jqxGrid('getcellvalue',rowindex,'subcatid'));
				$('#rentalQuoteGrid').jqxGrid('setcellvalue',gridindex,'fleet_no',$('#equipSearchGrid').jqxGrid('getcellvalue',rowindex,'fleet_no'));
				$('#rentalQuoteGrid').jqxGrid('setcellvalue',gridindex,'flname',$('#equipSearchGrid').jqxGrid('getcellvalue',rowindex,'flname'));
				$('#rentalQuoteGrid').jqxGrid('setcellvalue',gridindex,'grpid',$('#equipSearchGrid').jqxGrid('getcellvalue',rowindex,'grpid'));
