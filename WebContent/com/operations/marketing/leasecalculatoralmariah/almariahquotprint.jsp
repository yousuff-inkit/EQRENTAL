...
<form id="frmqotPrint" autocomplete="off" target="_blank">
...
<table style="border-collapse: collapse;" width="100%" class="table"> 
 ...
 <tr height="25" style="background-color: #ffebcd;border-collapse: collapse;" >
   <th align="left" class="firstcol" style="border-collapse: collapse;"><b>Sl No</b></th>
     ...
     <th align="left"  class="firstcol"style="border-collapse: collapse;"><b>KM use/month</b></th>
     <!-- <th align="left" class="firstcol" style="border-collapse: collapse;"><b>Group</b></th> -->
     <th align="left" class="firstcol" style="border-collapse: collapse;"><b>Driver Days/Week</b></th>
     <th align="left" class="firstcol" style="border-collapse: collapse;"><b>Driver Hrs/Day</b></th>
     <th align="left" class="firstcol" style="border-collapse: collapse;"><b>Rate /Ex.hour</b></th>
     <th align="left" class="firstcol" style="border-collapse: collapse;"><b>Ex.KM Charges</b></th>
     <th align="left" class="firstcol" style="border-collapse: collapse;"><b>Rate / month</b></th>
  </tr>
...
<!-- </fieldset> -->
<!-- </div> -->
<table><tr><td>Terms & Conditions</td></tr>
<s:iterator var="stat" value='#request.TERMSPRINT' >
<tr>   
	<s:iterator status="arr" value="#stat.split('::')" var="des">   
		<td>
  			<s:property value="#des"/>
