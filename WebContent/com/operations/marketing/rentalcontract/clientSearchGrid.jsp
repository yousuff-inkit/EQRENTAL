...
var id='<%=id%>';
if(id=="1"){
	cldata1='<%=viewDAO.searchClientData(branch,clname,mob,id)%>';	 
}
         ...
         //	var url1;
            ...
            $("#subclientsearch").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'MOB', datafield: 'per_mob', width: '15%' ,hidden:true},
					 ...
					 { text: 'Salesman', datafield: 'salesman', width: '20%',hidden:true },
          ...
          /*   $("#subclientsearch").jqxGrid('addrow', null, {}); */
				           ...
				           $('#subclientsearch').on('rowdoubleclick', function (event) 
				                ...
				                document.getElementById("cldocno").value= $('#subclientsearch').jqxGrid('getcellvalue', rowindex1, "cldocno");
				               ...
				               document.getElementById("salesman").value=$('#subclientsearch').jqxGrid('getcellvalue', rowindex1, "salesman");
				               document.getElementById("hidsalesman").value=$('#subclientsearch').jqxGrid('getcellvalue', rowindex1, "salid");
