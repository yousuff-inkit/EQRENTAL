...
<%@page import="javax.servlet.http.HttpSession" %>
 <%
  ...
  ClsProformaInvoiceDAO invdao=new ClsProformaInvoiceDAO();
 %> 
...
var id='<%=id%>';
if(id=="1"){
	loaddata='<%=invdao.mainSearch(client,cmbagmttype,agmtno,date,docno,branch,id)%>';
}               
        $(document).ready(function () { 
            ...
            $("#jqxmainsearch").jqxGrid('addrow', null, {});
				          ...
				          $('#jqxmainsearch').on('rowdoubleclick', function (event) 
				                ...
				                //$('#cmbagmttype').val();
				                funSetlabel();
				            	document.getElementById("frmProformaInvoice").submit();
