...
/* 	if($('#hiddate').val()){
    ...
    function funPrintBtn() {
    	...
    	//    	var win= window.open(reurl[0]+"printProformaInvoice?docno="+document.getElementById("docno").value,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
