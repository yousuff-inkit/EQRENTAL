...
<jsp:include page="../../../common/printTajeerHeader.jsp"></jsp:include><br/>  <br/> 
</div>
...
<table width="100%">
  ...
  <tr>
    ...
    <td width="8%"><label id="lblcontractstart" name="lblcontractstart">: <s:property value="lblcontractstart"/>    End: <s:property value="lblcontractend"/></label></td>
   <%--  <td width="5%" align="left">End:</td>
    <td width="20%" align="left"><label id="lblcontractend" name="lblcontractend"><s:property value="lblcontractend"/></label></td> --%>
  </tr>
  <tr>
    <td align="left">Driven </td>
    <td colspan="3">: <label id="lbldriven" name="lbldriven" ><s:property value="lbldriven"/></label></td>
    <td colspan="4">Biling Period From: <label name="lblinvfrom" id="lblinvfrom" ><s:property value="lblinvfrom"/></label> To :<label name="lblinvto" id="lblinvto" ><s:property value="lblinvto"/></label></td>
    </tr>
    <tr>
...
<table width="100%">
 <tr>
    ...
    <td align="right">Rate(Excl.VAT)</td>
    <td align="right">Price VAT Excl.</td>
    <td align="right">VAT %</td>
    <td align="right">VAT Amount</td>
    <td align="right">Price VAT Incl.</td>
  </tr>
...
<%-- <table width="100%" border="0">
  <tr>
    <td>Tax Summary</td>
    <td align="right">VAT Excl.</td>
    <td align="right">VAT</td>
    <td align="right">VAT Incl.</td>
  </tr>
  <tr>
    <td>VAT 5%</td>
 ...
 <table width="100%" border="0">
<tr>
    <td width="84%" align="right"> Total VAT Excl:</td>
    <td width="16%" align="right"><label name="lbltotalvatexcl" id="lbltotalvatexcl" ><s:property value="lbltotalvatexcl"/></label></td>
 </tr> 
 <tr>  
    <td width="84%" align="right">VAT Value:</td>
    <td width="16%" align="right"><label name="lbltotalvat" id="lbltotalvat" ><s:property value="lbltotalvat"/></label></td>
 </tr>
 <tr>   
    <td width="84%" align="right">Total VAT Incl.:</td>
    <td width="16%" align="right"><label name="lbltotalvatincl" id="lbltotalvatincl" ><s:property value="lbltotalvatincl"/></label></td>
  </tr>
</table>
...
<table width="100%" >
  ...
  <tr>
    ...
    <td align="right">:</td>
    <td colspan="3" align="left"><label id="lblamountwords" name="lblamountwords"><s:property value="lblamountwords"/></label></td>
    </tr>
</table>
<hr>
