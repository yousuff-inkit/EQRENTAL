...
<%-- <jsp:include page="../../../../../header.jsp"></jsp:include> --%> <br/> 
 ...
 <table width="100%" class="normaltable" >
  <tr>
    <td width="25%" rowspan="6"><img src="<%=contextPath%>/icons/confident.jpg" width="100%" height="80%"  alt=""/></td>
   <%--  <td width="45%" rowspan="2">&nbsp;</td>
    <td width="30%"><font size="3"><label id="lblprintname" name="lblprintname"> أميكس لتأجير السيارات ذ.م.م.</label><br><label id="lblcompname" name="lblcompname" ><s:property value="lblcompname"/></label></font></td> --%>
  </tr>
  <%-- <tr>
