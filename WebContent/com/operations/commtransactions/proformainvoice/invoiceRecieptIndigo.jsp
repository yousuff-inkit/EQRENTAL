...
<table width="100%" class="normaltable">
  <tr>
  <td align="center" colspan="4" class="complogo"><%-- <img src="<%=contextPath%>/icons/epic.jpg" width="100%" height="91"  alt=""/> --%></td>
  </tr>
  <tr>
  ...
  <tr>
  	...
  	<td width="62%" align="left"><label id="lbllocation" name="lbllocation" >: <s:property value="lbllocation"/></label></td>
  	<td width="8%" align="left"><b>TRN</b></td>
  	<td width="23%" align="left"><b><label id="lblcomptrn" name="lblcomptrn" >: <s:property value="lblcomptrn"/></label></b></td>
  </tr>
