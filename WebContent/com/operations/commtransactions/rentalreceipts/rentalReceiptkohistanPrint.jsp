...
<jsp:include page="../../../common/printHeaderkohist.jsp"></jsp:include>

<table width="99%" style="font-size: 15px;">
  <tr>
    <td width="71%"><b>Received with Thanks From</b></td>
    <td width="15%" align="left"><b>Receipt No :</b></td>
...
<table width="100%" class=tablereceipt style="font-size: 15px;">
...
<table width="99%" class="tablereceipt" align="center" style="font-size: 15px;">
<tr>
...
<!-- <table width="1047" style="font-size: 15px;">  

  <tr>
     <td width="1039" colspan="3">
     <table width="1041">
     <tr>
     <td width="279"><b>Operations Officer</b></td>
     <td width="289"><b>Accounts Officer</b></td>
     <td width="220"><b>Internal Auditor</b></td>
     <td width="233"><b> Managing Partner</b></td>
     </tr>
     </table>
    </td>
</tr>
...
<jsp:include page="../../../common/printFooter_kohistan.jsp"></jsp:include>
<br><br>
								              <!-- Page 2 -->
...
<jsp:include page="../../../common/printHeaderkohi.jsp"></jsp:include>
