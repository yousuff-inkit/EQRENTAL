...
<%-- <jsp:include page="../../../../../header.jsp"></jsp:include> --%> <br/> 
 ...
 <div class="commonheader">
 	<jsp:include page="../../../common/printHeaderGreenStar.jsp"></jsp:include>
 </div>
<%--</br></br></br></br>--%>
   <div class="invheader">
  <table style="width:100%;padding-top:100px;">
  	<tr>
  		...
  		<td style="width:40%;" align="center"><b><font size="5"><label id="lblprintname" name="lblprintname"><s:property value="lblprintname"/></label></font></b></td>
  		<td style="width:30%;">&nbsp;</td>
  	</tr>
  </table>	
  </div> 
...
<table width="100%">
  ...
  <tr>
   ...
   <%-- <td align="left">Contract Start </td>
    <td width="13%">: <label id="lblcontractstart" name="lblcontractstart"><s:property value="lblcontractstart"/></label></td> --%>
    <td width="8%"></td>
    <td width="12%"></td>
  ...
  <tr>
    ...
    <%-- <td colspan="2">Inv From : <label name="lblinvfrom" id="lblinvfrom" ><s:property value="lblinvfrom"/></label> To :<label name="lblinvto" id="lblinvto" ><s:property value="lblinvto"/></label></td> --%>
   <td  colspan="2" align="left"><b>TRN : &nbsp;<label id="lblcomptrn" name="lblcomptrn" ><s:property value="lblcomptrn"/></label></b></td>
    </tr>
	<tr>
    <td align="left">&nbsp;</td>
    <td colspan="3">&nbsp;</td>
...
<fieldset>
  <table width="100%" >
    <tr>
      ...
      <td width="85%">: <label name="cntrctvehgrn" id="cntrctvehgrn" >
        <s:property value="cntrctvehgrn"/>
	...
	<tr>
      <td width="15%" align="right"> Current Vehicle  </td>
       <td width="85%">: <label name="curntvehgrn" id="curntvehgrn" >
        <s:property value="curntvehgrn"/> 
