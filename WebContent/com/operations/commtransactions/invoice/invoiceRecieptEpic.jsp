...
<form id="frmManualInvoicePrint" action="printManualInvoice" autocomplete="off" target="_blank">
 ...
 <div id="header2" >
 <br/><br/><br/><br/><br/><br/>&ensp;Branch&emsp;:&nbsp;<label id="lblbranch" name="lblbranch" ><s:property value="lblbranch"/></label><br/>
 &ensp;Location :&nbsp;<label id="lbllocation" name="lbllocation" ><s:property value="lbllocation"/></label><br/>
 	<font size="5" style="font-weight: bold; text-align: center;">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<label id="lblprintname" name="lblprintname"><s:property value="lblprintname"/></label></font>
 	&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<b>TRN No.  :&nbsp;<label id="lblcomptrn" name="lblcomptrn" ><s:property value="lblcomptrn"/></label></b>
 </div>
 </s:if>
 <s:else>
 <div id="headerdiv">
 <jsp:include page="../../../common/epicHeader.jsp"></jsp:include> 
</div>
</s:else>
