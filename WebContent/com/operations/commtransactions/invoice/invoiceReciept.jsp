...
$(document).ready(function () {
	...
	if(document.getElementById("lblmanual").value.trim()=="12"){
		$('.bulkinvoice').css('display','none');
	}
});
function getPrint(){
	//alert("hgchjh");
...
<table width="100%">
  ...
  <tr>
    ...
    <td align="left" class="bulkinvoice">RA No </td>
    <td class="bulkinvoice">: <label name="lblrano" id="lblrano" ><s:property value="lblrano"/></label></td>
  </tr>
  <tr>
    <td align="left">&nbsp;</td>
    <td colspan="3">: <label name="lbladdress2" id="lbladdress2" ><s:property value="lbladdress2"/></label></td>
    <td align="left" class="bulkinvoice">LPO No</td>
    <td class="bulkinvoice">: <label name="lbllpono" id="lbllpono" ><s:property value="lbllpono"/></label></td>
  </tr>
  <tr>
    <td align="left">TRN</td>
    <td colspan="2">: <label name="lblclienttrn" id="lblclienttrn" ><s:property value="lblclienttrn"/></label></td>
    <td>&nbsp;</td>
    <td align="left" class="bulkinvoice">MRA No </td>
    <td class="bulkinvoice">: <label name="lblmranno" id="lblmrano" ><s:property value="lblmrano"/></label></td>
  </tr>
  <tr>
    ...
    <td align="left">&nbsp;</td>
    <td></td>
    <td align="left" class="bulkinvoice">Type </td>
    <td class="bulkinvoice">: <label name="lblratype" id="lblratype" ><s:property value="lblratype"/></label></td>
  </tr>
  <tr>
    ...
    <td align="left">&nbsp;</td>
    <td></td>
   <td align="left" class="bulkinvoice">Contract Start </td>
    <td width="13%" class="bulkinvoice"><label id="lblcontractstart" name="lblcontractstart"><s:property value="lblcontractstart"/></label></td>
    <td width="8%" class="bulkinvoice">End</td>
    <td width="12%" class="bulkinvoice"><label id="lblcontractend" name="lblcontractend"><s:property value="lblcontractend"/></label></td>
    
  </tr>
  <tr class="bulkinvoice">
