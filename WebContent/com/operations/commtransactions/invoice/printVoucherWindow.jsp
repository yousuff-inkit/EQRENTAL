...
<div id=search >
<table width="690" height="105" border="0">
  <tr>
...
<label for="rdosingle">Single</label></td>
    ...
    <td colspan="2" rowspan="2" align="center"><input type="checkbox" name="chkdeletedinvprint" id="chkdeletedinvprint"><label for="chkdeletedinvprint"> Deleted Invoices</label></td>
    </tr>
    <tr>
    <td height="22" align="center">&nbsp;</td>
    <td align="center">&nbsp;</td>
