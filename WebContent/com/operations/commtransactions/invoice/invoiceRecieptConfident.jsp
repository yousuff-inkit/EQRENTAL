...
<%-- <jsp:include page="../../../../../header.jsp"></jsp:include> --%> <br/> 
 ...
 <table width="100%" class="normaltable">
  <tr>
    <td colspan="2" width="25%"><img src="<%=contextPath%>/icons/confident1.jpg" width="100%" height="80%"  alt=""/></td>
   </tr>
  
  <tr>
    <td   align="right" width="16%"><b><font size="5"><label id="lblprintname" name="lblprintname"><s:property value="lblprintname"/></label></font>
    <s:if test="%{#tempprintname.equalsIgnoreCase('Tax Invoice')}">
    	<br><label id="lblprintname" name="lblprintname" style="margin-right:6%;"> فاتورة ضريبية</label>
    </s:if>
    <s:else>
    	<s:property value="lblprintname"/>
    </s:else>
    </b></td>
     <td align="right"  ><b>TRN :</b><label id="lblcomptrn" name="lblcomptrn" style="margin-right:3%;"><s:property value="lblcomptrn"/></label></td> 
    </tr>
