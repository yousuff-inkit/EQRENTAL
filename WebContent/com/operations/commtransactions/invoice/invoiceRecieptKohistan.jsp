...
<%-- <jsp:include page="../../../../../header.jsp"></jsp:include> --%> <br/> 
 ...
 <s:set var="tempprintname" value="lblprintname"></s:set>
 <table width="100%" class="normaltable" >
  <tr>
    <td width="25%" rowspan="6"><img src="<%=contextPath%>/icons/epic.jpg" width="100%"  alt=""/></td>
    <td width="45%" rowspan="2">&nbsp;</td>
    <td width="30%"><font size="3"><label id="lblprintname" name="lblprintname">كوهستان لتأجير السيارات ش.ذ.م.م </label><br><label id="lblcompname" name="lblcompname" ><s:property value="lblcompname"/></label></font></td>
  </tr>
  <tr>
    <td><b><label id="lblcompaddress" name="lblcompaddress"><s:property value="lblcompaddress"/></label></b></td>
  </tr>
  <tr>
    <td rowspan="2"  align="center"><b><font size="5"><label id="lblprintname" name="lblprintname"><s:property value="lblprintname"/></label></font>
    <s:if test="%{#tempprintname.equalsIgnoreCase('Tax Invoice')}">
    	<br><label id="lblprintname" name="lblprintname"> فاتورة ضريبية</label>
    </s:if>
    <s:else>
    	<%-- <s:property value="lblprintname"/> --%>
    </s:else>
    </b></td>
...
<table width="100%">
  <tr>
    <td width="16%" align="left"> إسم العميل<br>Customer Name </td>
...
<table width="100%" >
  ...
  <tr>
    <td width="18%"><b>Payment method</b></td><td>طريقة الدفع
</td>
   </tr>
   <tr>
    <td colspan="6">Terms of payment is advance,renewal is dependent upon the advance rental payment of the next month.Preferable options for payment are as follows:</td>
   </tr>
   <tr>
   <td>*   cash</td>
   </tr>
   <tr>
   <td colspan="6">*   Credit Card</td>
   </tr>
   <tr>
   <td colspan="6">*   Electronic transfer in the bank: </td>
   </tr>
   <tr>
   <td colspan="6">*   Bank Name: Emirates NBD (Account# 1014760192501)(Account title: Kohistan Rent A Car LLC)(IBAN: AE030260001014760192501)</td>
   </tr>
...
<table width="100%">
 <tr>
    <td colspan="3" align="center">Thank you for your business with Kohistan</td>
    </tr>
    <tr>
