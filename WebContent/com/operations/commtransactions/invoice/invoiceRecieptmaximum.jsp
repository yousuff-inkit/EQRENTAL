...
<table width="100%" class="normaltable">
  ...
  <tr>
  	...
  	<td align="left"><label id="lblcomptrn" name="lblcomptrn" >: <s:property value="lblcomptrn"/></label></td>
  </tr>
  </table>
  </div>
<fieldset>
...
<table width="100%" border="0">
  <tr>
    <td>Tax Summary</td>
    <td align="right">Amount(Excl Vat)</td>
    <td align="right">Tax Amount</td>
    <td align="right">Total(Incl Vat)</td>
  </tr>
  <tr>
    <td>VAT 5%</td>
