...
<table width="100%" class="normaltable">
  ...
  <tr>
  <td align="center" colspan="2"><font size="4"><label id="lblprintname" name="lblprintname"><s:property value="lblprintname"/></label></font></td>
  </tr>
  ...
  <tr>
   ...
   <tr>
  	...
  	<td align="left">: <label name="lblcomptrn" id="lblcomptrn" ><s:property value="lblcomptrn"/></label></td>
  </tr>
  </table>
  </div>
<fieldset>
<table width="100%">
  <tr>
    ...
    <td width="15%" align="left">INV No </td>
    <td width="25%">: <label name="lblinvno" id="lblinvno" ><s:property value="lblinvno"/></label>   <label name="lblinvtype" id="lblinvtype" >(<s:property value="lblinvtype"/>)</label></td>
  </tr>
  <tr>
    <td align="left">Code </td>
    <td width="22%">: <label id="lblaccount" name="lblaccount" ><s:property value="lblaccount"/></label></td>
...
<%--     <td>: <label id="lblbranch" name="lblbranch" ><s:property value="lblbranch"/></label></td> --%>
  ...
  <tr>
    ...
    <td align="left">&nbsp;</td>
    <td></td>
    <td align="left">Inv From</td>  
    <td>: <label name="lblinvfrom" id="lblinvfrom" ><s:property value="lblinvfrom"/></label> 
    &nbsp;To&nbsp;
      <label name="lblinvto" id="lblinvto" ><s:property value="lblinvto"/></label></td>
  ...
  <tr>
    ...
    <td  width="25%">: <label name="lblcurrencycode" id="lblcurrencycode"><s:property value="lblcurrencycode" /></label></td>
  ...
  <%-- <td align="left">Driven </td>
   ...
   <td>&nbsp;</td>
    ...
    <%-- Inv From : <label name="lblinvfromtime" id="lblinvfromtime" ><s:property value="lblinvfromtime"/></label> To :<label name="lblinvtotime" id="lblinvtotime" ><s:property value="lblinvtotime"/></label> --%>
     <td>&nbsp;</td>
    <td colspan="3">&nbsp;</td>
       </tr>
...
<div class="trafficdiv" id="trafficdiv">
	<table width="100%">
			...
			<s:if test="#showfees > 0">
  				<tr><td>
  				<br>
  				**Govt. Knowledge Fees for Dubai/Parking Traffic fine AED 20/-</td></tr>
  			</s:if>
</table>
</div>
</s:if>
...
<table width="100%" >
  <tr>
    <td width="211" align="left"><b>Total</b> </td>
    <td width="10" align="right">:</td>
    <td width="731">&nbsp;</td>
    <td width="161">&nbsp;</td>
    <td width="147" align="right"><b><label id="lbltotal" name="lbltotal"><s:property value="lbltotal"/></label></b></td>
  </tr>
