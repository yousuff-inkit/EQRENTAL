...
<table width="100%">
  ...
  <tr>
    ...
    <td>: <label name="lbltelphone" id="lbltelphone" ><s:property value="lbltelphone"/></label></td>
    <td align="left">&nbsp;</td>
    <td></td>
  ...
  <tr>
    ...
    <td colspan="2">Inv From <label name="lblinvfrom" id="lblinvfrom" style="margin-left:45px;">: <s:property value="lblinvfrom"/></label> To <label name="lblinvto" id="lblinvto" ><s:property value="lblinvto"/></label></td>
    </tr>
    <tr>
