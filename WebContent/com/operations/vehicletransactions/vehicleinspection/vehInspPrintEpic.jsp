...
<table width="100%" >
  ...
  <tr>
    ...
    <td align="left">:<label name="lblreffleetno" id="lblreffleetno"><s:property value="lblreffleetno"/></label></td>
    <td align="left">Time</td>
    <td align="left">:<label name="lbltime" id="lbltime"><s:property value="lbltime"/></label></td>
  </tr>
  <tr>
    <td align="left">Reg No</td>
    <td align="left">:<label name="lblregno" id="lblregno"><s:property value="lblregno"/></label></td>
    <td align="left">Type</td>
    <td align="left">:<label name="lbltype" id="lbltype"><s:property value="lbltype"/></label></td>
    </tr>
    <tr>
    <td align="left">Fleet Name</td>
    <td align="left">:<label name="lblfleetname" id="lblfleetname"><s:property value="lblfleetname"/></label></td>
  </tr>
  <tr>
...
<s:iterator var="statpic" value="#request.NEWINSPPRINTPICS">
<img src='<s:property value="#statpic"/>'  height="25%" width="25%">
</s:iterator>
<center>
