...
$(document).ready(function () {  
	...
	$("#maintainceDate").jqxDateTimeInput({  width: '105px', height: '22px', formatString:"dd.MM.yyyy"});   
...
/* 	
    ...
    $("#maintTime").jqxDateTimeInput({ width : '50px', height : '22px', formatString : "HH:mm",showCalendarButton: false });
...
function funReadOnly() {
	$('#frmmaintepic input').attr('readonly', true);
	$('#frmmaintepic select').attr('disabled', true);
...
function funRemoveReadOnly() {
	...
	$('#frmmaintepic input').attr('readonly', false);
	$('#frmmaintepic select').attr('disabled', false);  
...
function setValues() {
	if($('#hidtime').val()){   
		   $("#maintTime").jqxDateTimeInput('val', $('#hidtime').val());
	}
 ...
 */
 function funPrintBtn(){
    ...
    var reurl=url.split("saveMaintworkorderepic");
    console.log(url+"=="+reurl);   
    $("#docno").prop("disabled", false);
var win= window.open(reurl[0]+"printmaintWorkepic?docno="+document.getElementById("masterdoc_no").value+"&date="+$('#hidmaintainceDate').val(),"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
...
/*   	x.open("GET","workordersavedata.jsp?type="+type+'&description='+description+'&remarks='+remarks+'&lbrcost='+lbrcost+
	  ...
	  x.open("GET","workordersavedata.jsp?list="+list+'&doc='+document.getElementById("masterdoc_no").value+'&garrageid='+document.getElementById("garrageid").value+'&maintype='+document.getElementById("maintype").value+'&currkm='+document.getElementById("currkm").value+'&nextserdue='+document.getElementById("nextserdue").value);      
	x.send();
}
...
//function ajaxcall1(type,description,remarks,lbrcost,partscost,total,i,clears,rwo,delval){
	...
	x.open("GET","approvelsavedata.jsp?list="+lists+'&doc='+document.getElementById("masterdoc_no").value);      
...
<form id="frmmaintepic" action="saveMaintworkorderepic" name="maintworkorderepic" method="post" autocomplete="OFF">
...
<input type="hidden" id="hidmaintainceDate" name="hidmaintainceDate" value='<s:property value="hidmaintainceDate"/>'></td>  
<td align="right" width="3%">Time</td> <td align="left" width="10%"><div id="maintTime" name="maintTime" value='<s:property value="maintTime"/>'></div></td>       
        ...
        <div style="float: left"  >
            <div id='jqxTabs' class='jqx-rc-all'  >
			   ...
			   <table width="100%">
					...
					<td align="left" width="1%" ><select id="maintype" name="maintype" onchange="changetype()" value='<s:property value="maintype"/>'>
					<option value="service">Service</option>
					<option value="repair">Repair</option>  
					...
					<td align="right" width="1.2%">Garage</td><td align="left" width="5%"><input type="text" id="garagemaster"  name="garagemaster" placeholder="Press F3 To Search" style="width:97%;"  value='<s:property value="garagemaster"/>' onkeydown="getgarrage(event)"></td>
						<td align="right" width="1%">Curr.KM</td><td align="left" width="2%"><input type="text" id="currkm" name="currkm"  onkeypress="javascript:return isNumber (event)" style="width:90%;" value='<s:property value="currkm"/>'> </td>   
						<td align="right" width="1.2%">Next Ser.Due KM</td><td align="left" width="5%"><input type="text" id="nextserdue" name="nextserdue" onkeypress="javascript:return isNumber (event)" style="width:50%;" value='<s:property value="nextserdue"/>' > </td>
						</tr>
					</table>  
...
<input type="hidden" id="hidtime" name="hidtime" value='<s:property value="hidtime"/>'>     
 </div>  
