...
<table width="100%" > 
  ...
  <tr>
  <td width="25%" align="left">TRN NO</td>
  <td align="left">: <label name="lbltrnno" id="lbltrnno" ><s:property value="lbltrnno"/></label></td>
  </tr>
  
  <tr>
  <td width="25%" align="left">INV NO</td>
  <td align="left">: <label name="lblinvo" id="lblinvo" ><s:property value="lblinvo"/></label></td>
  </tr>
...
<table width="100%" >
  ...
  <tr>
    ...
    <td >: <label name="lbldate" id="lbldate" ><s:property value="lbldate"/></label>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Time : <label name="lblmainttime" id="lblmainttime" ><s:property value="lblmainttime"/></label></td>    
  </tr>

<tr>
  <td width="25%" align="left">INV Date</td>
  <td align="left">: <label name="lblinvdate" id="lblinvdate" ><s:property value="lblinvdate"/></label></td>
  </tr>
 ...
 <tr style="border-collapse: collapse;">
    ...
    <td align="right" style="border-collapse: collapse;"><label id="lblnettotallabour" name="lblnettotallabour"><s:property value="lblnettotallabour"/></label></td>
      <td align="right" style="border-collapse: collapse;"><label id="lblnettotalparts" name="lblnettotalparts"><s:property value="lblnettotalparts"/></label></td>
        <td align="right" style="border-collapse: collapse;"><label id="lblnettotalamount" name="lblnettotalamount"><s:property value="lblnettotalamount"/></label></td></tr>
        
        <tr style="border-collapse: collapse;">
     <td align="right" style="border-collapse: collapse;" colspan="4"> <b>Tax</b></td> 
    <td align="right" style="border-collapse: collapse;"><label id="lbltaxamount" name="lbltaxamount"><s:property value="lbltaxamount"/></label></td>
      <td align="right" style="border-collapse: collapse;"><b>Net Total</b></td>
        <td align="right" style="border-collapse: collapse;"><label id="lblnettaxamount" name="lblnettaxamount"><s:property value="lblnettaxamount"/></label></td></tr>
...
<table width="100%">  
  ...
  <!--   <td width="15%" rowspan="5"></td>
    ...
    <td ><img src="<%=contextPath%>/icons/replacevehicle.jpg" class="center"/>
