...
<table width="100%" > 
  ...
  <tr>
    ...
    <td align="left">INV NO</td>
     <td >: <label name="lblinvno" id="lblinvno" ><s:property value="lblinvno"/></label></td>
  </tr> 
</table>
</td>
...
<tr>
    ...
    <td align="left">INV Date</td>
     <td >: <label name="lblinvdate" id="lblinvdate" ><s:property value="lblinvdate"/></label></td>
  </tr>
</table>
 ...
 <tr style="border-collapse: collapse;">
    ...
    <td align="right" style="border-collapse: collapse;"><label id="lblnettotallabour" name="lblnettotallabour"><s:property value="lblnettotallabour"/></label></td>
      <td align="right" style="border-collapse: collapse;"><label id="lblnettotalparts" name="lblnettotalparts"><s:property value="lblnettotalparts"/></label></td>
       <td align="right" style="border-collapse: collapse;"><label id="lblnettotaltax" name="lblnettotaltax"><s:property value="lblnettotaltax"/></label></td>
