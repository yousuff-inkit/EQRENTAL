...
%> --%>
<%@page import="com.operations.saleofvehicle.vehsalesinvreturn.*"%>
        ...
        $(document).ready(function () { 	
            ...
            var source =
            {
                ...
                datafields: [
     						...
     						{name :'salesinvremarks',type:'string'},
     						{name :'salesinvvocno',type:'number'},
     						{name :'salesinvdocno',type:'number'},
            ...
            $("#disposalSearch").jqxGrid(
            {
               ...
               // editable: true,
                ...
                columns: [
							...
							{ text: 'Sales Inv Remarks',datafield:'salesinvremarks', width: '16.66%',hidden:true},
							{ text: 'Sales Inv Docno',datafield:'salesinvdocno', width: '16.66%',hidden:true},
							{ text: 'Sales Inv Vocno',datafield:'salesinvvocno', width: '16.66%',hidden:true},
           ...
           $('#disposalSearch').on('rowdoubleclick', function (event) {
        	   ...
        	   document.getElementById("salesinvremarks").value=$('#disposalSearch').jqxGrid('getcellvalue', row2, "salesinvremarks");
        	   document.getElementById("salesinvdocno").value=$('#disposalSearch').jqxGrid('getcellvalue', row2, "salesinvdocno");
        	   document.getElementById("salesinvvocno").value=$('#disposalSearch').jqxGrid('getcellvalue', row2, "salesinvvocno");
        	   document.getElementById("salesinvtrno").value=$('#disposalSearch').jqxGrid('getcellvalue', row2, "salesinvtrno");
