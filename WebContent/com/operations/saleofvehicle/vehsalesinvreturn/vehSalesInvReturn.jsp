    ...
    <form id="frmVehSalesInvReturn" action="saveVehSalesInvReturn" autocomplete="off" >
        ...
        <div class='modern-ui hidden-scrollbar'>
            ...
            <div class="middle-panel">
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:120px;">Sales Inv Ref No</label>
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:120px;">Client</label>
                    <input type="text" name="client" id="client" value='<s:property value="client"/>' style="width: 125px;" readonly>
                    <input type="text" name="clientname" id="clientname" value='<s:property value="clientname"/>' style="flex:1;" readonly tabindex="-1">
                </div>

                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:120px;">Description</label>
