...
.modern-ui textarea {
    height: 48px !important; /* Slightly taller for textareas */
    resize: none;
}
...
$(document).ready(function() {
    ...
    $("#fleetstatustime").jqxDateTimeInput({ 
        width: '100px', 
        height: 24, 
        formatString: 'HH:mm', 
    ...
    <form id="frmFleetStatusChange" action="saveActionFleetStatusChange" autocomplete="off">
        ...
        <div class='modern-ui hidden-scrollbar'>
            ...
            <div class="middle-panel">
                <span class="middle-panel-title">Fleet Status Change Info</span>
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Fleet</label>
                    <div class="input-search-container" style="width: 125px;">
                        <input type="text" name="fleetno" id="fleetno" placeholder="Press F3" value='<s:property value="fleetno"/>' readonly onkeydown="getFleet(event);" />
                ...
                <div class="field-row">
                    ...
                    <label class="lbl-right" style="width:100px;">Change to Status</label>
