        ...
        <div class='modern-ui hidden-scrollbar'>
            ...
            <div class="middle-panel">
                ...
                <div class="field-row">
                    ...
                    <input type="text" name="vocno" id="vocno" value='<s:property value="vocno"/>' readonly tabindex="-1" style="width:120px;" />
                </div>
                ...
                <div class="field-row" style="margin-bottom:0;">
                    ...
                    <button type="button" class="myButton" name="btncalculate" id="btncalculate" onclick="funCalculate();" style="margin-left:10px;">Calculate</button>
                </div>
            </div>
