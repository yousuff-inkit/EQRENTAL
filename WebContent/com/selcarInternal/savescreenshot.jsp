...
<%@page import="java.text.SimpleDateFormat" %>
 ...
 System.out.println("Screenshot page");
...
String strl="",docn="",sqltest="";
if(desc.equalsIgnoreCase("Front")){
 sqltest="update an_takehand set front='"+check+"' where doc_no="+doc+"";
}
if(desc.equalsIgnoreCase("Back")){
 sqltest="update an_takehand set back='"+check+"' where doc_no="+doc+"";
}
if(desc.equalsIgnoreCase("Left")){
 sqltest="update an_takehand set leftk='"+check+"' where doc_no="+doc+"";
}
if(desc.equalsIgnoreCase("Right")){
 sqltest="update an_takehand set rightk='"+check+"' where doc_no="+doc+"";
}
if(desc.equalsIgnoreCase("Interior")){
 sqltest="update an_takehand set interior='"+check+"' where doc_no="+doc+"";
}
int val3=stmt3.executeUpdate(sqltest);
//System.out.println("CODE==="+code);
