...
//System.out.println("======aa==== ");		
	...
	System.out.println("--from--"+from+":to:"+to);
			...
			if(!(from==null))
			{
           		...
           		String sql="select r.voc_no,r.brhid,a.refname,t1.rate,t.rentaltype from gl_ragmt r left join my_acbook a on r.cldocno=a.cldocno and dtype='CRM' left join gl_rtarif t on r.doc_no=t.rdocno and rstatus=5 left join gl_rtarif t1 on r.doc_no=t1.rdocno and t1.rstatus=7  where odate>='"+from+"' and odate<='"+to+"';";
