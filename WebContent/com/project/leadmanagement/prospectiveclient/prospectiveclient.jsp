...
<tr>
  ...
  <td width="358">
  	<input type="text" name="txtenqsource" id="txtenqsource" style="width:70%;" placeholder="Press F3 To Search"  value='<s:property value="txtenqsource"/>'>
...
<td ><input type="text" id="txtpaddress" name="txtpaddress" style="width:70%;" readonly placeholder="Permenant Address" value='<s:property value="txtpaddress"/>' /></td>
 <td align="right">Address 2</td>
 <td><input type="text" id="txttaddress" name="txttaddress" style="width:70%;" readonly placeholder="Temporary Address" value='<s:property value="txttaddress"/>' /></td>
 <td>&nbsp;</td>
 <td>&nbsp;</td>
</tr> 
<tr>
...
<fieldset Style="display:none"><legend>Contact Person Details</legend>
<table width="100%">
