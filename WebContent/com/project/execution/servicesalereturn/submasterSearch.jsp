									...
									{ text: 'delterm', datafield: 'delterm', width: '8%',hidden:true },
									 { text: 'payterm',  datafield: 'payterm', width: '5%' ,hidden:true},
										...
										{ text: 'Description', datafield: 'desc1', width: '25%' },
										 ...
										 { text: 'rvoc_no', datafield: 'rvoc_no', width: '2%',hidden:true},
    ...
    $('#mainsearshgrid').on('rowdoubleclick', function (event) {
       var rowindex1 = event.args.rowindex;
             ...
             $('#deliverydate').val($("#mainsearshgrid").jqxGrid('getcellvalue', rowindex1, "deldate")) ;
                ...
                document.getElementById("rrefno").value = $('#mainsearshgrid').jqxGrid('getcellvalue', rowindex1, "rvoc_no");
                
                document.getElementById("ordermasterdoc_no").value = $('#mainsearshgrid').jqxGrid('getcellvalue', rowindex1, "rrefno");
		   ...
		   $('#refslno').attr('disabled', false);
        	 ...
        	 $('#invDate').jqxDateTimeInput({ disabled: false});
        	  ...
        	  $("#nipurdetails").load("descgridDetails.jsp?maindoc="+$("#mainsearshgrid").jqxGrid('getcellvalue',rowindex1,"doc_no")+"&rdocno="+$('#mainsearshgrid').jqxGrid('getcellvalue', rowindex1, "rrefno"));
        	 // $('#cmbcurr').attr('disabled', false);
        	// $('#acctype').attr('disabled', false);
        	 //funSetlabel();
