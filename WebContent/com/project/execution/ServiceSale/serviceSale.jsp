...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            <label class="lbl-right" style="width:80px;" id="typetd1" hidden="hidden">Type</label>
            <select name="cmbtype" id="typetd2" style="width: 80px;" value='<s:property value="cmbtype"/>' hidden="hidden">
