...
int val=0;
int aa=0;
String dates=request.getParameter("date")==null?"":request.getParameter("date").trim(); 
String cmbbilltype=request.getParameter("cmbbilltype")==null || request.getParameter("cmbbilltype").equalsIgnoreCase("")?"0":request.getParameter("cmbbilltype").trim();
