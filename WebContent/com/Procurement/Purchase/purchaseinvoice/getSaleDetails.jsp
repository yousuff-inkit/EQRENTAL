...
try{	ClsConnection ClsConnection=new ClsConnection();
	...
	String strSql = "select date_format(m.date,'%d.%m.%Y')date"+sqltest+" from my_srvm m left join my_srvd d on m.tr_no=d.tr_no where m.cldocno="+cldocno+" and d.psrno="+psrno+"";
