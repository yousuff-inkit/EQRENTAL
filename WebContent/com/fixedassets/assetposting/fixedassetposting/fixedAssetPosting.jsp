...
<div class="modern-ui hidden-scrollbar">
    ...
    <div class="middle-panel">
        <span class="middle-panel-title">Fixed Asset Depreciation Posting</span>
        ...
        <div class="field-row">
            ...
            <div style="display: flex; gap: 8px; margin-left: 15px;">
                <button type="button" class="myButton" id="btnExcelExporter" title="Export current Document to Excel" onclick="funExcelExporter();">
                    <img alt="Excel" src="<%=contextPath%>/icons/excel_new.png" width="14" height="14"> Export
                </button>
                <button type="button" class="myButton" id="btnProcessing" title="Process" onclick="funProcessBtn();">
                    <img alt="Process" src="<%=contextPath%>/icons/process2.png" width="14" height="14"> Process
                </button>
                <button type="button" class="myButton" id="btnCalculate" title="Calculate" onclick="funCalculateBtn();">
                    <img alt="Calculate" src="<%=contextPath%>/icons/calculate_new.png" width="14" height="14"> Calculate
                </button>
            </div>
            
            <label class="lbl-right" style="width:80px; margin-left:auto;">Doc No.</label>
            <input type="text" id="docno" name="txtjvno" style="width:125px;" value='<s:property value="txtjvno"/>' tabindex="-1"/>
        </div>
    </div>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="justify-content:flex-end; margin-top:15px; margin-bottom:0;">
            ...
            <input type="text" id="txtdeprtotal" name="txtdeprtotal" style="width:150px; text-align:right; font-weight:bold; color:#0b45a2;" value='<s:property value="txtdeprtotal"/>' tabindex="-1" readonly/>
        </div>
    </div>
