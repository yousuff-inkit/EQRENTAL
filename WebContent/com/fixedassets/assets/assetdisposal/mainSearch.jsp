        ...
        <table>
            ...
            <tr>
                ...
                <td colspan="6">
                    ...
                    <input type="hidden" id="msearchclient" name="msearchclient">

                    <input type="hidden" id="msearchacno" name="msearchacno">

                    <input type="hidden" id="msearchmobile" name="msearchmobile">
