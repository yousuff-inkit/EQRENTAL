...
function setValues(){
    ...
    if ($('#hidcmbtype').val() != null && $('#hidcmbtype').val() != '') {
...
function funPrintBtn() {
    ...
    var win= window.open(reurl[0]+"com/fixedassets/assets/assetdisposal/printAssetDisposal.action?docno="+document.getElementById("docno").value+"&trno="+document.getElementById("trno").value,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
    win.focus();      
}
</script>
</head>
...
<form id="frmAssetDisposal" action="saveAssetDisposal" autocomplete="off" >
    ...
    <div class="modern-ui hidden-scrollbar">
        ...
        <div class="middle-panel">
            <span class="middle-panel-title">Asset Disposal Details</span>
            ...
            <div class="field-row">
                ...
                <input type="text" name="vocno" id="vocno" style="width:125px;" value='<s:property value="vocno"/>' tabindex="-1" readonly>
            </div>
            ...
            <div class="field-row">
                ...
                <input type="text" name="clientname" id="clientname" value='<s:property value="clientname"/>' style="flex:1;" readonly>
            </div>
            --%>
...
<div id="assetwindow"><div></div><div></div></div>
<div id="detailwindow"><div></div><div></div></div>
