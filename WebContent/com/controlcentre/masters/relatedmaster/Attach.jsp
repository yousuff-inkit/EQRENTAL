<%@page import="com.controlcentre.masters.relatedmaster.hoteltype.ClsAttach"%>
	 ...
	 function ajaxFileUpload()  
		  ...
		  //check whether browser fully supports all File API
		    if (window.File && window.FileReader && window.FileList && window.Blob)
		    {
	          ...
	          (  
	              {  
	                  url:'hotelfileAttachAction.action?formCode=<%=request.getParameter("formCode")%>&doc_no=<%=request.getParameter("docno")%>&branchids=<%=request.getParameter("barchvals")%>&descpt='+$("#txtdesc").val() ,  
