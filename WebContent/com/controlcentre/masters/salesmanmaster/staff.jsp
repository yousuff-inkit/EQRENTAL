...
<title>GatewayERP(i) - Staff</title>
...
$(document).ready(function () {     
    ...
    $("#staffdate").jqxDateTimeInput({width : '125px', height : 24, formatString : "dd.MM.yyyy"});
...
function funNotify(){
    ...
    if(document.getElementById("chkvalid") && document.getElementById("chkvalid").value==1){
    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <input type="text" name="txtaccname" id="txtaccname" style="flex:1; max-width:400px; margin-left:10px;" value='<s:property value="txtaccname"/>' readonly>
            </div>
        </div>
