...
<title>GatewayERP(i) - Check In</title>
...
$(document).ready(function () {     
    ...
    $("#checkindate").jqxDateTimeInput({width : '125px', height : 24, formatString : "dd.MM.yyyy"});
...
<form id="frmCheckin" action="saveActionCheckin" autocomplete="off" >
    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            <span class="middle-panel-title">Check In Details</span>
        ...
        <!-- Check In List Data Grid -->
        <div class="middle-panel" style="padding-bottom: 20px;">
            <span class="middle-panel-title">Check In List</span>
            <div id="jqxCheckinSearch1" class="grid-container"></div>
        </div>
