...
<title>GatewayERP(i) - Sales Agent</title>
...
$(document).ready(function () {     
    ...
    $("#salesagentdate").jqxDateTimeInput({width : '125px', height : 24, formatString : "dd.MM.yyyy"});
...
<form id="frmSalesAgent" action="saveActionSalesAgent" autocomplete="off" >
    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel" style="padding-bottom: 20px;">
            ...
            <div id="jqxSalesagentSearch1" class="grid-container"></div>
        </div>
