...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#tpiexpiry").jqxDateTimeInput({width : '125px',height : '15px',formatString : "dd.MM.yyyy",value:null});
...
/* 	function getDealer(event){
	...
	function funReadOnly() {
		 ...
		 $('#tpiexpiry').jqxDateTimeInput({ disabled: true}); 
		 getAuth();
		getBrand();
		//getPlateCode();
		getGroup();
		...
		getStatus();
		//getLocation();
/* 		document.getElementById("frmEquipmentMaster").disabled=true;
	...
	function funRemoveReadOnly() {
		...
		/*  $('#releasedate').jqxDateTimeInput({ disabled: false}); 
		 $('#releasetime').jqxDateTimeInput({ disabled: false});  */
		 $('#tpiexpiry').jqxDateTimeInput({ disabled: false});
		 if(document.getElementById("mode").value=='A'){
			...
			<fieldset><legend>Equipment Details</legend>
				<table width="100%" cellspacing="0" border="0">
					<tr>
						...
						<td><input type="text" name="srno" id="srno" value='<s:property value="srno"/>'>
						</td>
					...
					<tr>
						<td height="24" align="right">Category</td>
					  	<td>
					  		<select name="cmbcategory" id="cmbcategory" value='<s:property value="cmbcategory"/>' style="width:81%;" onchange="getSubCategory(this.value);">
					  	...
					  	<td>
					  		<select name="cmbsubcategory" id="cmbsubcategory" value='<s:property value="cmbsubcategory"/>' style="width:75%;">
					  	...
					  	<td width="146" align="left">
					  		<input type="text" name="regno" id="regno" style="width:89%;" value='<s:property value="regno"/>' autocomplete="off" onblur="checkRegNo();"/>
					  	</td>
					  	<td align="right">Group</td>
					  	<td align="left">
					  		<select name="cmbgroup" id="cmbgroup" value='<s:property value="cmbgroup"/>' style="width:74%;" onchange="getLevel(this.value);">
                        		<option>--Select--</option>
                      		</select>
					  	...
					  	<td align="left">
					  		<select name="cmbsize" id="cmbsize" value='<s:property value="cmbsize"/>'>
					  			<option value="">--Select--</option>
					  		</select>
					  	...
					  	<td align="left">
					  		<select name="cmbauthority" id="cmbauthority" value='<s:property value="cmbauthority"/>'>
					  			<option value="">--Select--</option>
					  		</select>
					...
					<tr>
						...
						<td width="142">
							<select name="cmbbrand" id="cmbbrand" value='<s:property value="cmbbrand"/>' style="width:81%;" onchange="getModel(this.value);">
                          		<option>--Select--</option>
                        	</select>
						...
						<td width="128">
							<select name="cmbmodel" id="cmbmodel" value='<s:property value="cmbmodel"/>' style="width:75%;" onchange="getFleetName();">
                        		<option>--Select--</option>
                        	</select>
						...
						<td align="left">
							<select name="cmbyom" id="cmbyom" value='<s:property value="cmbyom"/>' style="width:91%;">
                          		<option>--Select--</option>
                        	</select>
						...
						<td align="right">Plate Code</td>
					  	<td align="left">
					  		<select name="cmbplate" id="cmbplate" value='<s:property value="cmbplate"/>'>
					  			<option value="">--Select--</option>
					  		</select>
						...
						<td>
							<fieldset><legend></legend>
								<table style="width:100%;">
									<tr>
										<td align="right">Registration Expiry</td>
										<td><div id='jqxOtherRegExp' name='jqxOtherRegExp' value='<s:property value="jqxOtherRegExp"/>'></div></td>
										<td align="right">Insurance Expiry</td>
										<td><div id='jqxOtherInsExp' name='jqxOtherInsExp' value='<s:property value="jqxOtherInsExp"/>'></div></td>
										<td align="right">TPI Expiry</td>
										<td><div id='tpiexpiry' name='tpiexpiry' value='<s:property value="tpiexpiry"/>'></div></td>
										
										<td align="right">Depreciation %</td>
										<td><input type="text" id="depr_perc" name="depr_perc" value='<s:property value="depr_perc"/>' style="text-align:right;" onblur="depr_percent(this.value);"/></td>
									</tr>
								</table>
							</fieldset>
						</td>
