...
<div id="nav">
    ...
    <div class="nav-buttons">
        ...
        <div class="nav-item"><input type="button" name="btncat" class="myButton" value="Category" onclick='document.getElementById("iframe1").src="<%=contextPath%>/com/controlcentre/masters/vehiclemaster/category.jsp";'></div>
        <div class="nav-item"><input type="button" name="btnsubcat" class="myButton" value="Sub category" onclick='document.getElementById("iframe1").src="<%=contextPath%>/com/controlcentre/masters/vehiclemaster/subcategory.jsp";'></div>
