    ...
    <form id="frmUnit" action="saveActionUnit"  autocomplete="off">
        ...
        <div class='modern-ui hidden-scrollbar'>
            ...
            <div class="middle-panel">
                ...
                <div class="field-row">
                    <label class="lbl-right" style="width:100px;">Unit</label>
                    <input type="text" name="unit" id="unit" value='<s:property value="unit"/>' style="width: 150px;">
                ...
                <div class="field-row" style="margin-bottom:0;">
                    ...
                    <input type="text" name="unitdesc" id="unitdesc" value='<s:property value="unitdesc"/>' style="flex:1;">
                </div>
            </div>

            <div class="middle-panel">
                <span class="middle-panel-title">Unit List</span>
                <div class="grid-container">
                    <div id="jqxUnitSearch1" style="border:none;"></div>
                </div>
            </div>
