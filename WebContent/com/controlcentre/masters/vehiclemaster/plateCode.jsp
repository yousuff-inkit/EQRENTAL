...
function savenalias(listss) {
    ...
    x.onreadystatechange=function(){
        if (x.readyState==4 && x.status==200) {
            ...
            if(parseInt(itemvalappr)==1) {} else {}  
        }
    }
...
<form id="frmPlateCode" action="saveActionPlate" autocomplete="off">
    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div style="display: flex; gap: 15px;">
            <div class="middle-panel" style="flex: 2; margin-bottom: 0;">
                ...
                <div class="field-row">
                    ...
                    <input type="text" name="docno" id="docno" value='<s:property value="docno"/>' style="width: 120px;" tabindex="-1">
                </div>
                
                <div class="field-row">
                    <label class="lbl-right" style="width:80px;">Authority</label>
                    <select name="authName" id="authName" style="width: 125px;">
                ...
                <div class="field-row" style="margin-bottom:0;">
                    ...
                    <input type="text" id="plateCode" name="plateCode" value='<s:property value="plateCode"/>' style="width: 125px;">
                    
                    <label class="lbl-right" style="width:80px;">Name</label>
                    <input type="text" name="platename" id="platename" value='<s:property value="platename"/>' style="flex: 1;">
                </div>
            </div>
            
            <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
                <span class="middle-panel-title">Alias Details</span>
                <div id="nAliasgrid" class="grid-container">
        ...
        <div class="middle-panel">
            <span class="middle-panel-title">Existing Plate Codes</span>
