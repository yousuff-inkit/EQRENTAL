...
<table >
		...
		<tr><td><input type="button" name="btncat" class="myButton" value="Category" style="width:90px;" onclick='document.getElementById("iframe1").src="<%=contextPath%>/com/controlcentre/masters/vehiclemaster/category.jsp";'></td></tr>
		<tr><td><input type="button" name="btnsubcat" class="myButton" value="Sub category" style="width:90px;" onclick='document.getElementById("iframe1").src="<%=contextPath%>/com/controlcentre/masters/vehiclemaster/subcategory.jsp";'></td></tr>
