...
========================================================= */
body {
    background: #ffffff; /* Completely removed the light blue gradient/background */
...
#mainBG {
    ...
    max-width: 100%;
    margin: 0 auto;
    box-shadow: none; /* Removed shadow to ensure no false background artifacts */
}
        ...
        <div class='modern-ui hidden-scrollbar'>
            ...
            <div class="middle-panel">
                ...
                <div class="field-row" style="margin-bottom:0;">
                    <label class="lbl-right" style="width:120px;">Name</label>
                    <input type="text" name="compliant" id="compliant" value='<s:property value="compliant"/>' style="flex:1;">
                </div>
            </div>

            <div class="middle-panel">
                <span class="middle-panel-title">Complaint List</span>
                <div class="grid-container">
                    <div id="maintearch10" style="border:none;"></div>
                </div>
            </div>
