...
<style>
/* =========================================================
SCOPED UI: Modern Layout (Matches Reference UI)
========================================================= */
body {
...
.modern-ui .btn-remove:hover { background: linear-gradient(135deg, #b71c1c 0%, #e53935 100%); }
...
.modern-ui .remove-icon { position: static; transform: none; color: #d32f2f; margin-left: 5px; }
.modern-ui .remove-icon:hover { color: #b71c1c; }
...
/* JQX Tabs Overrides for Modern Look */
#jqxTabs { border: 1px solid #c5d3e0; border-radius: 4px; }
.jqx-tabs-content-element { padding: 15px; background: #fff !important; }
</style>
    ...
    <form id="frmApprovalMaster" action="saveApprovalMaster" method="post" autocomplete="off" > 
        ...
        <div class="modern-ui hidden-scrollbar">
            ...
            <div class="middle-panel" id="main">
                ...
                <div class="field-row">
                    ...
                    <div class="input-search-container" style="width: 150px;">
                        <input type="text" id="doctype" name="doctype" placeholder="Press F3 To Search" value='<s:property value="doctype"/>' required="required" onKeyDown="getUser(event);" readonly/>
            ...
            <div id="jqxTabs">
                ...
                <!-- Final Level -->
                <div id="level1" class="jqx-tabs-content-element">
                    <div id="lev1" class="field-row" style="border-bottom: 1px solid #e2e8f0; padding-bottom: 12px; margin-bottom: 12px;">
                        <input type="button" class="myButton" id="addUser" name="addUser" value="Add User" onclick="addUser1();" readonly>
                        
                        <label style="display:flex; align-items:center; margin-left: 20px; font-weight: bold; color: #444;">
                            <input type="checkbox" id="chckfinalmodify" name="chckfinalmodify" value="0" onclick="$(this).attr('value', this.checked ? 1 : 0)" /> Modify
                        </label>
                        
                        <label class="lbl-right" style="margin-left:auto;">Min. Approval</label>
                        <input type="text" id="txtfinal_minapproval" name="txtfinal_minapproval" style="width:80px; text-align:right;" value='<s:property value="txtfinal_minapproval"/>'/>
                    </div>
                    ...
                    <div id="users">
                        ...
                        <div id="user1">
                            <div class="field-row">
                                ...
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtfinal_user1" name="txtfinal_user1" value='<s:property value="txtfinal_user1"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(1,'level1')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(1,'final')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                        <!-- Final User 2 -->
                        <div id="user2">
                            <div class="field-row">
                                <label class="lbl-right" style="width:60px;">User</label>
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtfinal_user2" name="txtfinal_user2" value='<s:property value="txtfinal_user2"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(2,'level1')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(2,'final')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                        <!-- Final User 3 -->
                        <div id="user3">
                            <div class="field-row">
                                <label class="lbl-right" style="width:60px;">User</label>
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtfinal_user3" name="txtfinal_user3" value='<s:property value="txtfinal_user3"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(3,'level1')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(3,'final')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                        <!-- Final User 4 -->
                        <div id="user4">
                            <div class="field-row">
                                <label class="lbl-right" style="width:60px;">User</label>
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtfinal_user4" name="txtfinal_user4" value='<s:property value="txtfinal_user4"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(4,'level1')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(4,'final')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                        <!-- Final User 5 -->
                        <div id="user5">
                            <div class="field-row">
                                <label class="lbl-right" style="width:60px;">User</label>
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtfinal_user5" name="txtfinal_user5" value='<s:property value="txtfinal_user5"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(5,'level1')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(5,'final')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Second Level -->
                <div id="level2" class="jqx-tabs-content-element">
                    <div id="lev2" class="field-row" style="border-bottom: 1px solid #e2e8f0; padding-bottom: 12px; margin-bottom: 12px;">
                        ...
                        <label class="lbl-right" style="margin-left:auto;">Min. Approval</label>
                        <input type="text" id="txtsecond_minapproval" name="txtsecond_minapproval" style="width:80px; text-align:right;" value='<s:property value="txtsecond_minapproval"/>'/>
                    </div>
                    ...
                    <div id="usrs">
                        ...
                        <div id="usr1">
                            <div class="field-row">
                                <label class="lbl-right" style="width:60px;">User</label>
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtsecond_user1" name="txtsecond_user1" value='<s:property value="txtsecond_user1"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(1,'level2')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(1,'second')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                        <!-- Second User 2 -->
                        <div id="usr2">
                            <div class="field-row">
                                <label class="lbl-right" style="width:60px;">User</label>
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtsecond_user2" name="txtsecond_user2" value='<s:property value="txtsecond_user2"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(2,'level2')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(2,'second')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                        <!-- Second User 3 -->
                        <div id="usr3">
                            <div class="field-row">
                                <label class="lbl-right" style="width:60px;">User</label>
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtsecond_user3" name="txtsecond_user3" value='<s:property value="txtsecond_user3"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(3,'level2')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(3,'second')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                        <!-- Second User 4 -->
                        <div id="usr4">
                            <div class="field-row">
                                <label class="lbl-right" style="width:60px;">User</label>
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtsecond_user4" name="txtsecond_user4" value='<s:property value="txtsecond_user4"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(4,'level2')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(4,'second')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                        <!-- Second User 5 -->
                        <div id="usr5">
                            <div class="field-row">
                                <label class="lbl-right" style="width:60px;">User</label>
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtsecond_user5" name="txtsecond_user5" value='<s:property value="txtsecond_user5"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(5,'level2')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(5,'second')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- First Level -->
                <div id="level3" class="jqx-tabs-content-element">
                    <div id="lev3" class="field-row" style="border-bottom: 1px solid #e2e8f0; padding-bottom: 12px; margin-bottom: 12px;">
                        ...
                        <label class="lbl-right" style="margin-left:auto;">Min. Approval</label>
                        <input type="text" id="txtfirst_minapproval" name="txtfirst_minapproval" style="width:80px; text-align:right;" value='<s:property value="txtfirst_minapproval"/>'/>
                    </div>
                    ...
                    <div id="new_users">
                        ...
                        <div id="new_user1">
                            <div class="field-row">
                                <label class="lbl-right" style="width:60px;">User</label>
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtfirst_user1" name="txtfirst_user1" value='<s:property value="txtfirst_user1"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(1,'level3')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(1,'first')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                        <!-- First User 2 -->
                        <div id="new_user2">
                            <div class="field-row">
                                <label class="lbl-right" style="width:60px;">User</label>
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtfirst_user2" name="txtfirst_user2" value='<s:property value="txtfirst_user2"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(2,'level3')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(2,'first')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                        <!-- First User 3 -->
                        <div id="new_user3">
                            <div class="field-row">
                                <label class="lbl-right" style="width:60px;">User</label>
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtfirst_user3" name="txtfirst_user3" value='<s:property value="txtfirst_user3"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(3,'level3')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(3,'first')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                        <!-- First User 4 -->
                        <div id="new_user4">
                            <div class="field-row">
                                <label class="lbl-right" style="width:60px;">User</label>
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtfirst_user4" name="txtfirst_user4" value='<s:property value="txtfirst_user4"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(4,'level3')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(4,'first')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                        <!-- First User 5 -->
                        <div id="new_user5">
                            <div class="field-row">
                                <label class="lbl-right" style="width:60px;">User</label>
                                <div class="input-search-container" style="width: 150px;">
                                    <input type="text" id="txtfirst_user5" name="txtfirst_user5" value='<s:property value="txtfirst_user5"/>'/>
                                    <svg class="magnifier-icon" onclick="funSearchBtn11(5,'level3')" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </div>
                                ...
                                <svg class="remove-icon" onclick="funResetbtn1(5,'first')" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </div>
                        </div>
                    </div>
                </div>
