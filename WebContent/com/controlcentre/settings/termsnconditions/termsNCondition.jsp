...
<%-- <tr>
  ...
  <tr>   
    ...
    <td width="5%"><button class="myButton" type="button" id="btnHeaderAdd" name="btnHeaderAdd">Add</button></td>
...
<tr>
  ...
  <tr>
    ...
    <td width="5%"><button class="myButton" type="button" id="btnFooterAdd" name="btnFooterAdd">Add</button></td>
