...
<title>GatewayERP(i) - User Master</title>
...
<script type="text/javascript">
    $(document).ready(function () { 
        ...
        $("#jqxUserMasterDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});
	...
	$(function(){
		$('#frmUserMaster').validate({
		    rules: {
		        txtuser:{ required:true,maxlength:10 },
		        txtusername:{ required:true,maxlength:30 },
		        txtuserpassword:{ required:true,maxlength:100 },
			    txtpasswordconfirm:{ required:true },
			    txtusermail:"required"
		    },
		    messages: {
		        txtuser:{ required:"*",maxlength:"max 10 chars" },
		        txtusername:{ required:"*",maxlength:"max 30 chars" },
		        txtuserpassword:{ required:"*",maxlength:"max 100 chars" },
	...
	function getURole(event){
	    var x= event.keyCode;
	    if(x==114){
	        roleSearchContent('<%=contextPath%>/userRoleSearchGrid.jsp');
	    }
	}
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <input type="text" id="txtuser" name="txtuser" style="width:125px;" placeholder="Enter user ID" value='<s:property value="txtuser"/>' onblur="checkUserid()"/>
            
            <label class="lbl-right" style="width:80px; margin-left:15px;">User Name</label>
            <input type="text" id="txtusername" name="txtusername" style="flex:1;" placeholder="Enter user Name" value='<s:property value="txtusername"/>' onblur="checkUsername()"/>
            
            <label class="lbl-right" style="width:100px; margin-left:15px;">Discount Level</label>
            <select id="levels" name="levels" style="width:125px;" value='<s:property value="levels"/>'>    
        ...
        <div class="field-row">
            ...
            <div class="input-search-container" style="width: 125px;">
                ...
                <svg class="magnifier-icon" onclick="roleSearchContent('<%=contextPath%>/userRoleSearchGrid.jsp');" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            </div>
            <input type="hidden" id="txtroleid" name="txtroleid" value='<s:property value="txtroleid"/>'/>
            
            <label class="lbl-right" style="width:80px; margin-left:15px;">Language</label>
            <select id="cmblanguage" name="cmblanguage" style="flex:1; max-width: 250px;" value='<s:property value="cmblanguage"/>'></select>
            ...
            <select id="cmpermission" name="cmpermission" style="width:125px;" value='<s:property value="cmpermission"/>' onchange="fungriddis()">    
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <input type="password" id="txtuserpassword" name="txtuserpassword" style="width:125px;" placeholder="Password" value='<s:property value="txtuserpassword"/>'/>
            
            <label class="lbl-right" style="width:120px; margin-left:15px;">Confirm Password</label>
            <input type="password" id="txtpasswordconfirm" name="txtpasswordconfirm" style="width:125px;" placeholder="Confirm" value='<s:property value="txtpasswordconfirm"/>'/>
            <span style="font-weight: bold; margin-left: 10px; font-size: 11px;" id='message'></span>
        </div>
    </div>

    <div class="middle-panel">
        <span class="middle-panel-title">E-mail Configuration</span>
        
        <div class="field-row">
            <label class="lbl-right" style="width:100px;">Email</label>
            <input type="email" id="txtusermail" name="txtusermail" style="width:250px;" placeholder="Email Address" value='<s:property value="txtusermail"/>' />
            
            <label class="lbl-right" style="width:100px; margin-left:15px;">Password</label>
        ...
        <div class="field-row" style="margin-bottom:0;">
            <label class="lbl-right" style="width:100px;">Host</label>
            <input type="text" id="txtmailhost" name="txtmailhost" style="width:250px;" placeholder="SMTP/IMAP Host" value='<s:property value="txtmailhost"/>' />
            
            <label class="lbl-right" style="width:100px; margin-left:15px;">Port</label>
            <input type="text" id="txtmailport" name="txtmailport" style="width:80px;" placeholder="Port" value='<s:property value="txtmailport"/>' />
            
            <label class="lbl-right" style="width:80px; margin-left:15px;">Signature</label>
            <input type="text" id="txtmailsign" name="txtmailsign" style="flex:1;" placeholder="Email Signature" value='<s:property value="txtmailsign"/>' />
        </div>
    </div>

    <div class="middle-panel" style="padding-bottom: 20px;">
        <span class="middle-panel-title">Branch Access</span>
        <div id="userMasterDiv" class="grid-container">
