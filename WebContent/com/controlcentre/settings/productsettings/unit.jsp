    ...
    <div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel">
            ...
            <div class="field-row">
                ...
                <input type="text" name="unit" value='<s:property value="unit"/>' id="unit" style="width: 125px;">
            ...
            <div class="field-row" style="margin-bottom:0;">
                ...
                <input type="text" name="unitdesc" value='<s:property value="unitdesc"/>' id="unitdesc" style="flex:1;">
            </div>
        </div>

        <div class="middle-panel">
            <span class="middle-panel-title">Existing Units</span>
