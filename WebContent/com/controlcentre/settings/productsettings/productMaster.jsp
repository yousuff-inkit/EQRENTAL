...
<div id="nav">
    ...
    <div class="nav-buttons">
        <div class="nav-item"><input type="button" name="btntype" class="myButton" value="Type" onclick='document.getElementById("iframe2").src="<%=contextPath%>/com/controlcentre/settings/productsettings/typeMaster.jsp";'></div>
        ...
        <div class="nav-item"><input type="button" name="btncategory" class="myButton" value="Category" onclick='document.getElementById("iframe2").src="<%=contextPath%>/com/controlcentre/settings/productsettings/Category.jsp";'></div>
        <div class="nav-item"><input type="button" name="btnscategory" class="myButton" value="Subcategory" onclick='document.getElementById("iframe2").src="<%=contextPath%>/com/controlcentre/settings/productsettings/SubCategory.jsp";'></div>
