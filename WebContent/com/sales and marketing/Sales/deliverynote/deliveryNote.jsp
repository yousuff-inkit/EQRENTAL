...
// 			     document.getElementById("collqty").value="";
			...
			function prosrch(){
				var prodsearchtype=$("#prodsearchtype").val();
		   		...
		   		//alert(prddata);
		   			 productSearchContent('productSearch.jsp?prodsearchtype='+prodsearchtype+'&enqmasterdocno='+refmasterdocno+'&location='+document.getElementById("locationid").value+'&reftype='+reftype+'&date='+document.getElementById("date").value+'&id=1'+'&hidalterid=1'+'&psconf='+document.getElementById("hidpsconf").value);
...
<body onload="setValues();getunit(0);getDefaultLocation(); getAlternativeConfig();getCurrencyIds();funchkps();">
...
<table width="100%"  >
  ...
  <tr>
    ...
    <td colspan="2">Sales Order <input type="text" id="rrefno" name="rrefno" style="width:15%;"  placeholder="Press F3 to Search"  onKeyDown="getrefno(event);" value='<s:property value="rrefno"/>'/>
     </td>
