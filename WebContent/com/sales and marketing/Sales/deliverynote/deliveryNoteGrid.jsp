...
var rendererstring=function (aggregates){
	...
	return '<div style="float: right; margin: 4px;font-size:12px; overflow: hidden;"> ' + value + '</div>';
          ...
          applyFilter(dataField,$(this).val());  
            		              ...
            		              if($('#cmbreftype').val()=='SOR'){
            		            	  var vattype=$('#jqxDeliveryNote').jqxGrid('getcellvalue', 0, "vattype"); 
            		       			...
            		       			if(vattype=="exclusive"){
            		      				$('#hidcmbvatype').val("exclusive");
            		      			}
            		      			if(vattype=="inclusive"){
            		      				$('#hidcmbvatype').val("inclusive");
            		      			}
            		      			if(vattype=="export"){
            		      				$('#hidcmbvatype').val("export");
            		      			}
            ...
            if (cell4 != undefined && cell4.datafield == 'productname') {
                ...
                columns: [
							...
							{text: 'vattype', datafield: 'vattype', width: '10%',cellclassname: cellclassname,hidden:true},
               	  ...
               	  if(df == "productid")
               		  ...
               		  if(document.getElementById("locationid").value=="")
            		  {
               		...
               		/* if(parseInt(document.getElementById("productchk").value)==1){
        	   			...
        	   			$('#jqxDeliveryNote').jqxGrid('setcolumnproperty', 'productid', 'editable', true);
        	  			  $('#jqxDeliveryNote').jqxGrid('setcolumnproperty', 'productname', 'editable', true);
        		         productSearchContent('productMasterSearch.jsp?prodsearchtype='+prodsearchtype+'&enqmasterdocno='+refmasterdocno+'&location='+document.getElementById("locationid").value+'&reftype='+reftype+"&date="+document.getElementById("date").value);
        		    }	
           ...
           { 
            ...
            $('#jqxDeliveryNote').on('rowdoubleclick', function (event) {
	   ...
	   var productd=$('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextempg, "productid");
	    if(productd!="" && !(productd==null) && !(productd=="undefiend")){
           	    //alert("productchk====="+chk);
           	                      document.getElementById("jqxInput").value=$('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextempg, "productid");
           	                      document.getElementById("jqxInput1").value=$('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextempg, "productname");
                                  document.getElementById("temppsrno").value=$('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextempg, "psrno");
                                  document.getElementById("tempspecid").value=$('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextempg, "specid");
/* //                                   getunit(dataAdapter.records[i].psrno);
                                  document.getElementById("hidpsrno").value=$('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextemp, "psrno");
                                  getSaleDet();
								  ...
								  document.getElementById("unit").value=$('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextempg, "unitdocno");
                                  document.getElementById("brand").value=$('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextempg, "brandname");
                                  $("#totalstock").val($('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextempg, "balqty"));
                                  document.getElementById("quantity").value=$('#jqxDeliveryNote').jqxGrid('getcellvalue', rowindextempg, "qty");
	    
                                 $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowindextempg, "proid","");
                 			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowindextempg, "proname", "");
                 			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowindextempg, "brandname", "");
                 			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowindextempg, "unitdocno",0);
                 			    $('#jqxDeliveryNote').jqxGrid('setcellvalue', rowindextempg, "psrno",0);
               			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowindextempg, "prodoc",0);
               			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowindextempg, "specid", 0);
               			     $('#jqxDeliveryNote').jqxGrid('setcellvalue', rowindextempg, "productid" ,"");
               			     $('#jqxDeliveryNote').jqxGrid('setcellvalue', rowindextempg, "productname", "");
               			     $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowindextempg, "qty", 0);
               			  $('#jqxDeliveryNote').jqxGrid('setcellvalue',  rowindextempg, "unit", "");
	    }                   
             	 if(columnindex1 == "productid")
           	  { 
             		/* if(parseInt(document.getElementById("productchk").value)==1){
                  	   	 
        	   			$('#jqxDeliveryNote').jqxGrid('setcolumnproperty', 'productid', 'editable', false);
        	  			  $('#jqxDeliveryNote').jqxGrid('setcolumnproperty', 'productname', 'editable', false);
        		         productSearchContent('productMasterSearch.jsp?prodsearchtype='+prodsearchtype+'&enqmasterdocno='+refmasterdocno+'&location='+document.getElementById("locationid").value+'&reftype='+reftype+"&date="+document.getElementById("date").value);
        		    }	
               		if(parseInt(document.getElementById("productchk").value)==0){
            ...
            // create context menu
               ...
               $("#jqxDeliveryNote").on('contextmenu', function () {
                   return false;
               });
                   
               $("#Menu2").on('itemclick', function (event) {          
            	   var args = event.args;
                   var rowindex = $("#jqxDeliveryNote").jqxGrid('getselectedrowindex');
                   if ($.trim($(args).text()) == "Edit Selected Row") {
                       editrow = rowindex;
                       var offset = $("#jqxDeliveryNote").offset();
                       $("#popupWindow2").jqxWindow({ position: { x: parseInt(offset.left) + 60, y: parseInt(offset.top) + 60} });
                       // get the clicked row's data and initialize the input fields.
                       var dataRecord = $("#jqxDeliveryNote").jqxGrid('getrowdata', editrow);
                       // show the popup window.
                       $("#popupWindow2").jqxWindow('show');
                   }
                   else {  
                       var rowid = $("#jqxDeliveryNote").jqxGrid('getrowid', rowindex);      
                       //var rowno= $('#jqxDeliveryNote').jqxGrid('getcellvalue', rowid, "productid");
                       //alert("prdid=="+rowno);
                       
                    	  
                           $('#jqxDeliveryNote').jqxGrid('deleterow', rowid);  
                         
                                              
                   }
               });
            $("#jqxDeliveryNote").on('rowclick', function (event) {
                var rowindex = $("#jqxDeliveryNote").jqxGrid('getselectedrowindex');
                if (event.args.rightclick) {   
                    $("#jqxDeliveryNote").jqxGrid('selectrow', event.args.rowindex);
