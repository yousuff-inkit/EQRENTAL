...
$(document).ready(function () { 
     ...
     var source =
     {
         ...
         datafields: [
				...
				{name : 'lcldocno', type: 'number'  },
				{name : 'rcldocno', type: 'number'  },
     ...
     var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#clientSearchGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Rcldocno',datafield:'lcldocno',hidden:true},
							{ text: 'Lcldocno',datafield:'rcldocno',hidden:true}
			              ]
            });
            ...
            $("#clientSearchGrid").on("rowdoubleclick", function (event) {
				...
				$('#clientdetails').val($('#clientSearchGrid').jqxGrid('getcellvalue',row1,'clientdetails'));
				 if($('#lcldocno').val()!='' && $('#lcldocno').val()!='0' && $('#rcldocno').val()!='0' && $('#rcldocno').val()!='0'){
	                	$('#agmtexist').val('1');
	                }
	                else{
	                	$('#agmtexist').val('0');
