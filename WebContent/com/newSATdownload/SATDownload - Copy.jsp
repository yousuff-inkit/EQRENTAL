...
//	    	$('#jqxCashPaymentDate').jqxDateTimeInput('focus'); 	    		
	  ...
	  function getvehinfo(event){
		...
		function moveProgressBar(){
			...
			var interval=setInterval(function() {frame();},2000000);
			function frame(){
				var itemtype="";
				if(document.getElementById("radio_salik").checked==true){
					itemtype="Salik";
...
<td colspan="4" align="left"><input type="checkbox" id="chck_trafficpdata" name="chck_trafficpdata"  value="trafficpdata" onchange="fundisable();">Inquiry by plate data</td></tr>
</table>
<fieldset>
<table width="100%">
  <tr>
