          ...
          var dataAdapter = new $.jqx.dataAdapter(source,
            ...
            $("#hoursGrid").jqxGrid(
            {
               ...
               handlekeyboardnavigation: function (event) {
            	var griddisabled = $('#hoursGrid').jqxGrid('disabled'); 
          		if(!griddisabled){
            ...
            $("#hoursGrid").on("celldoubleclick", function (event)
            		{
            		    ...
            		    if(dataField=="pickuplocation"){
            			   ...
            			   if($('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype')=="" || $('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype')=="undefined" || $('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype')==null || typeof($('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype'))=="undefined"){
              		    		document.getElementById("errormsg").innerText="";
            			   ...
            			   $('#hoursGrid').jqxGrid('clearselection'); 
                       	   ...
                       	   var brandid=$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'brandid');
                       		var modelid=$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'modelid');
                       		var blockhrs=$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'blockhrs');
                       		var transfertype=$('#hoursGrid').jqxGrid('getcellvalue',rowBoundIndex,'transfertype');
                       		$('#tarifwindow').jqxWindow('open');
    						$('#tarifwindow').jqxWindow('focus');
    						tarifSearchContent('tarifSearchGrid.jsp?datafield='+dataField+'&gridname=hoursGrid&gridrowindex='+document.getElementById("hoursrowindex").value+'&brandid='+brandid+'&modelid='+modelid+'&blockhrs='+blockhrs+'&client='+document.getElementById("hidclient").value+'&transfertype='+transfertype, $('#tarifwindow'));            		   	   
            		   }
            		});
