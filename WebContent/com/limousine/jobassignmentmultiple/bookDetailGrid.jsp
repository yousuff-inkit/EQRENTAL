...
var detaildata;
if(id=="1"){
	detaildata='<%=jobdao.getDetailData(id,branch)%>';
}
$(document).ready(function () { 
       ...
       /*      alert("here");
                ...
                columns: [
							...
							{ text: 'Doc No', datafield: 'bookvocno',width:'4%'},
							...
							{ text: 'Transfer Type',datafield:'transfertype',width:'7%'},
							{ text: 'Loc. Type',datafield:'loctype',width:'7%'},
							{ text: 'Loc. Ref No',datafield:'locrefno',width:'5%'},
							{ text: 'Loc. Ref Name',datafield:'locrefname',width:'10%'},
