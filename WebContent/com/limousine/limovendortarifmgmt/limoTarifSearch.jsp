        ...
        $(document).ready(function () { 	
            ...
            $("#limoTarifSearch").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Category/Vendor', datafield: 'refname', width: '20%' },
							...
							{text: 'Vendor Id',datafield:'tarifvendor',width:'20%',hidden:true}
            ...
            $('#limoTarifSearch').on('rowdoubleclick', function (event) {
                ...
                document.getElementById("tarifvendor").value="";
                document.getElementById("hidtarifvendor").value="";
           		if($("#limoTarifSearch").jqxGrid('getcellvalue', rowindex1, "refname")!="" && $("#limoTarifSearch").jqxGrid('getcellvalue', rowindex1, "refname")!=null && typeof($("#limoTarifSearch").jqxGrid('getcellvalue', rowindex1, "refname"))!="undefined"){
           			document.getElementById("tarifvendor").value=$("#limoTarifSearch").jqxGrid('getcellvalue', rowindex1, "refname");
           			document.getElementById("hidtarifvendor").value=$("#limoTarifSearch").jqxGrid('getcellvalue', rowindex1, "tarifvendor");
           		}
