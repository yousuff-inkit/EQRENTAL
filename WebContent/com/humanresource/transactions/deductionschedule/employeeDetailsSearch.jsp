...
<title>GatewayERP(i)</title>
	...
	function getdata(empname,mob,employeedesignation,employeedepartment,empid,dob){
		 ...
		 $("#refreshdiv").load('employeeDetailsSearchGrid.jsp?empname='+empname.replace(/ /g, "%20")+'&mob='+mob+'&employeedesignation='+employeedesignation+'&employeedepartment='+employeedepartment+'&empid='+empid+'&dob='+dob);
		}
