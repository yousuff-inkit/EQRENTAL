...
<meta charset="UTF-8">
<title>GatewayERP(i) - Leave Request</title>
...
$(document).ready(function() {
    ...
    $("#leaveRequestDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});
    ...
    $("#halfDayDate").jqxDateTimeInput({ width: '125px', height: 24, formatString:"dd.MM.yyyy"});
...
function getDesignation() {
    ...
    x.onreadystatechange = function() {
        if (x.readyState == 4 && x.status == 200) {
            ...
            if ($('#hidcmbempdesignation').val() != null && $('#hidcmbempdesignation').val() != '') {
...
function getDepartment() {
    ...
    x.onreadystatechange = function() {
        if (x.readyState == 4 && x.status == 200) {
            ...
            if ($('#hidcmbempdepartment').val() != null && $('#hidcmbempdepartment').val() != '') {
...
function getPayrollCategory() {
    ...
    x.onreadystatechange = function() {
        if (x.readyState == 4 && x.status == 200) {
            ...
            if ($('#hidcmbpayrollcategory').val() != null && $('#hidcmbpayrollcategory').val() != '') {
...
function getLeaveType() {
    ...
    x.onreadystatechange = function() {
        if (x.readyState == 4 && x.status == 200) {
            ...
            if ($('#hidcmbleavetype').val() != null && $('#hidcmbleavetype').val() != '') {
...
function funNotify(){	
    var empid=document.getElementById("txtemployeedocno").value;
    if(empid==""){
    ...
    var noofdays=document.getElementById("txtnoofdays").value;
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel" style="background-color: #fcfcfc;">
        <span class="middle-panel-title">Leave Request Info</span>
        ...
        <div class="field-row">
            ...
            <input type="text" id="docno" name="txtleaverequestdocno" style="width:125px;" value='<s:property value="txtleaverequestdocno"/>' tabindex="-1" readonly/>
        </div>

        <div class="field-row">
            <label class="lbl-right" style="width:100px;">Designation</label>
            <select id="cmbempdesignation" name="cmbempdesignation" style="flex:1; max-width:200px;" value='<s:property value="cmbempdesignation"/>'>
                <option value="">--Select--</option>
            </select>
            <input type="hidden" id="hidcmbempdesignation" name="hidcmbempdesignation" value='<s:property value="hidcmbempdesignation"/>'/>
            
            <label class="lbl-right" style="width:100px; margin-left:15px;">Department</label>
            <select id="cmbempdepartment" name="cmbempdepartment" style="flex:1; max-width:200px;" value='<s:property value="cmbempdepartment"/>'>
                <option value="">--Select--</option>
            </select>
            <input type="hidden" id="hidcmbempdepartment" name="hidcmbempdepartment" value='<s:property value="hidcmbempdepartment"/>'/>
            
            <label class="lbl-right" style="width:100px; margin-left:15px;">Payroll Category</label>
            <select id="cmbpayrollcategory" name="cmbpayrollcategory" style="flex:1; max-width:200px;" value='<s:property value="cmbpayrollcategory"/>'>
                <option value="">--Select--</option>
            </select>
        ...
        <div class="field-row" style="margin-bottom:0;">
            <label class="lbl-right" style="width:100px;">Employee</label>
            ...
            <input type="text" id="txtemployeename" name="txtemployeename" placeholder="Employee Name" style="flex:1; max-width:400px; margin-left: 10px;" value='<s:property value="txtemployeename"/>' tabindex="-1" readonly/>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row">
            ...
            <input type="text" id="txtdescription" name="txtdescription" placeholder="Description" style="flex:1; max-width: 400px;" value='<s:property value="txtdescription"/>'/>
        </div>

        <div class="field-row" style="margin-bottom:0;">
            <label class="lbl-right" style="width:100px;">From</label>
            <div style="width: 125px;">
            ...
            <label style="display:flex; align-items:center; font-size:12px; font-weight:bold; color:#444; margin-left:25px; cursor: pointer;">
                <input type="checkbox" id="chckhalfday" name="chckhalfday" value="" onchange="halfdaycheck();funNoofDaysLeave();" onclick="$(this).attr('value', this.checked ? 1 : 0)" style="margin-right:5px;"> Half Day
            ...
            <label class="lbl-right" style="width:80px; margin-left:15px;">No. of Days</label>
            <input type="text" id="txtnoofdays" name="txtnoofdays" placeholder="Days" style="width:80px; text-align: right;" value='<s:property value="txtnoofdays"/>' tabindex="-1" readonly/>
        </div>
    </div>
