		...
		if(funtype.equalsIgnoreCase("1")){
    	    ...
    	    if(checkweekoff.equalsIgnoreCase("0")){
    	    	...
    	    	for(int j=0;j<weeklyoffarray.size();j++){
    	    		...
    	    		if(oldattendance.equalsIgnoreCase("U")){leave1total=String.valueOf(Integer.parseInt(leave1total)-1);} 
                	...
                	if(oldattendance.equalsIgnoreCase("U2")){leave1total=String.valueOf(Integer.parseInt(leave1total)-(0.5));} 
