		...
		if(funtype.equalsIgnoreCase("1")){
    	    ...
    	    if(checkweekoff.equalsIgnoreCase("0")){
    	    	...
    	    	for(int j=0;j<weeklyoffarray.size();j++){
    	    		...
    	    		if(oldattendance.equalsIgnoreCase("S")){leave1total=String.valueOf(Integer.parseInt(leave1total)-1);} 
                	if(oldattendance.equalsIgnoreCase("A")){leave2total=String.valueOf(Integer.parseInt(leave2total)-1);}
                	if(oldattendance.equalsIgnoreCase("C")){leave3total=String.valueOf(Integer.parseInt(leave3total)-1);} 
                	if(oldattendance.equalsIgnoreCase("T")){leave4total=String.valueOf(Integer.parseInt(leave4total)-1);}
                	if(oldattendance.equalsIgnoreCase("M")){leave5total=String.valueOf(Integer.parseInt(leave5total)-1);}

                	if(oldattendance.equalsIgnoreCase("S2")){leave1total=String.valueOf(Integer.parseInt(leave1total)-(0.5));} 
                	if(oldattendance.equalsIgnoreCase("A2")){leave2total=String.valueOf(Integer.parseInt(leave2total)-(0.5));}
                	if(oldattendance.equalsIgnoreCase("C2")){leave3total=String.valueOf(Integer.parseInt(leave3total)-(0.5));}
                	if(oldattendance.equalsIgnoreCase("T2")){leave4total=String.valueOf(Integer.parseInt(leave4total)-(0.5));} 
