...
<div id="mainBG" class="homeContent" data-type="background">
    ...
    <div class="modern-ui hidden-scrollbar">
        ...
        <form id="frmallowance" action="saveAllowance" method="post" autocomplete="off">
            <div class="middle-panel">
                ...
                <div class="field-row">
                    ...
                    <label class="lbl-right" style="width:80px; margin-left:15px;">Allowance</label>
                    <input type="text" name="allowancecode" id="allowancecode" style="width:125px;" placeholder="Allowance Code" value='<s:property value="allowancecode"/>'>
                    
                    <label class="lbl-right" style="width:50px; margin-left:15px;">Name</label>
                    <input type="text" name="allowance" id="allowance" style="width:250px;" placeholder="Allowance Name" value='<s:property value="allowance"/>'>
        ...
        <div class="middle-panel">
            <span class="middle-panel-title">Allowance List</span>
