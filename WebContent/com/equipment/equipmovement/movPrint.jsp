...
function getPrint(){
	...
	document.getElementById("frmEquipMovementPrint").submit(); 
...
<form id="frmEquipMovementPrint" action="printEquipMovement" autocomplete="off" target="_blank">
...
<table width="100%">
<tr>
<td align="left" >Branch</td ><td align="left" colspan="2">:&nbsp;<label id="lblopenbranch" name="lblopenbranch"><s:property value="lblopenbranch"/></label></td>
<td align="left" >Location</td>
<td align="left" colspan="2">:&nbsp;<label name="lblopenlocation" id="lblopenlocation"><s:property value="lblopenbranch"/></label></td>
...
<table width="100%">
<tr>
<td align="left">Branch</td ><td align="left" colspan="3">:&nbsp;<label id="lblclosebranch" name="lblclosebranch"><s:property value="lblclosebranch"/></label></td>
<td align="left">Location</td>
<td align="left" colspan="3">:&nbsp;<label name="lblcloselocation" id="lblcloselocation"><s:property value="lblcloselocation"/></label></td>
</tr>
<tr>
