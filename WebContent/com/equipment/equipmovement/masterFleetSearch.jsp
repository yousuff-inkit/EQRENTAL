...
<script type="text/javascript">
    ...
    function mainloadSearch() {
        var searchdate = document.getElementById("searchdate") ? $('#searchdate').jqxDateTimeInput('val') : "";
        var fleetno = document.getElementById("searchfleetno") ? document.getElementById("searchfleetno").value : "";
        var docno = document.getElementById("searchdocno") ? document.getElementById("searchdocno").value : "";
        var regno = document.getElementById("searchregno") ? document.getElementById("searchregno").value : "";
        var color = document.getElementById("searchcolor") ? document.getElementById("searchcolor").value : "";
        var group = document.getElementById("searchgroup") ? document.getElementById("searchgroup").value : "";
    ...
    function getdata(searchdate, fleetno, docno, regno, color, group, branch) {
        var url = 'fleetSearch.jsp?searchdate=' + encodeURIComponent(searchdate) + 
    ...
    <div class="search-panel">
        <table class="form-grid" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="searchfleetno" id="searchfleetno" autocomplete="off">
                </td>
                
                <td class="lbl-right">Asset Id</td>
                <td>
                    <!-- Keeping the ID as searchregno to maintain logic compatibility -->
                    <input type="text" name="searchregno" id="searchregno" autocomplete="off">
                </td>
