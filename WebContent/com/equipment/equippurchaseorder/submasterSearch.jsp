        ...
        $(document).ready(function () { 	
            ...
            $("#vehorderMaster").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'curid', datafield: 'curid', width: '65%' ,hidden:true },	
							{ text: 'rate', datafield: 'rate', width: '65%' ,hidden:true },	
							{ text: 'paymode', datafield: 'paymode', width: '65%' ,hidden:true },	
							{ text: 'payterms', datafield: 'payterms', width: '65%' ,hidden:true },	
							{ text: 'delterms', datafield: 'delterms', width: '65%' ,hidden:true },	
			              ]   
            ...
            $('#vehorderMaster').on('rowdoubleclick', function (event) {
    			...
    			$('#vehpurorderDate').jqxDateTimeInput({disabled: false});
    			 document.getElementById("masterdoc_no").value =  $('#vehorderMaster').jqxGrid('getcellvalue', rowindex2, "doc_no");
                   ...
                   funRoundRate($('#vehorderMaster').jqxGrid('getcellvalue', rowindex2, "rate"),"epocurrate");
                   document.getElementById("hidcmbcurr").value  = $('#vehorderMaster').jqxGrid('getcellvalue', rowindex2, "curid");
                   document.getElementById("txtpaymode").value  = $('#vehorderMaster').jqxGrid('getcellvalue', rowindex2, "paymode");
                   document.getElementById("txtpayterms").value  = $('#vehorderMaster').jqxGrid('getcellvalue', rowindex2, "payterms");
                   document.getElementById("txtdelterms").value  = $('#vehorderMaster').jqxGrid('getcellvalue', rowindex2, "delterms");
