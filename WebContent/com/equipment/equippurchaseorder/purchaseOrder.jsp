...
<tr>
    ...
    <td width="5%"><select id="vehtype" name="vehtype" style="width:92%;" value='<s:property value="vehtype"/>' onchange="funrefdisslno()">
      <option value="DIR">DIR </option>
       <option value="VPR">VPR</option></select>
     </td>
    <td width="10%"><input type="text" id="vehrefno" name="vehrefno" style="width:96%;" placeholder="Press F3 to Search" value='<s:property value="vehrefno"/>'  onkeydown="getrefDetails(event)"/></td>
    <td width="10%" align="right">Doc No</td>
    <td width="5%"><input type="text" id="docno" name="docno" style="width:97%;" value='<s:property value="docno"/>' tabindex="-1"/>
    </td>
  </tr>
  <tr>
    <td width="5%" align="right">Vendor</td>  
    <td width="5%"><input type="text" id="accid" name="accid" style="width:97%;" placeholder="Press F3 to Search" value='<s:property value="accid"/>'  onkeydown="getaccountdetails(event)" onblur="diserror()"/></td>
   	<td width="12%"><input type="text" id="vehpuraccname" name="vehpuraccname" style="width:99%;" value='<s:property value="vehpuraccname"/>'/>
    ...
    <td width="3.1%" align="right">Rate <input type="text" name="epocurrate" id="epocurrate" value='<s:property value="epocurrate"/>'  onblur="funRoundAmt(this.value,this.id);" tabindex="-1"></td>  
  </tr>
  <tr>
    <td align="right" width="5%">Exp.Delivery</td> 
    <td width="5%"><div id="vehpurorderdelDate" name="vehpurorderdelDate" value='<s:property value="vehpurorderdelDate"/>'></div>
     ...
     <td width="60%" colspan="7">&nbsp;&nbsp;Delivery Terms&nbsp;&nbsp;&nbsp;<input type="text" id="txtdelterms" name="txtdelterms" style="width:91%;" value='<s:property value="txtdelterms"/>'/></td>
  </tr>
  <tr>
    <td width="5%" align="right">Payment Mode</td>    
    <td width="5%"><input type="text" id="txtpaymode" name="txtpaymode" style="width:97%;" value='<s:property value="txtpaymode"/>'/></td>
   	<td width="60%" colspan="7">&nbsp;&nbsp;Payment Terms&nbsp;&nbsp;<input type="text" id="txtpayterms" name="txtpayterms" style="width:91%;" value='<s:property value="txtpayterms"/>'/></td>
  </tr>
  <tr> 
    <td align="right" width="5%">Description</td>     
    <td width="60%" colspan="9"><input type="text" id="vehdesc" name="vehdesc" style="width:99%;" value='<s:property value="vehdesc"/>'/></td>
  </tr>
  </table>
</fieldset>
<br>
