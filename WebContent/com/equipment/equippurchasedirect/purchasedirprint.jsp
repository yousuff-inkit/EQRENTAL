...
<table width="100%" > 
  <tr>
    ...
    <td width="25%" align="left">: <label id="lblpurchaseDate" name="lblpurchaseDate"><s:property value="lblpurchaseDate"/></label></td> 
     ...
     <td width="10%" align="left">Vendor TRN</td>
    <td   align="left">: <label id="lblvendtrn" name="lblvendtrn"><s:property value="lblvendtrn"/></label></td>        
...
<td align="left" style="border-collapse: collapse;"><b>Asset id</b></td>
...
<%int i=0; %>
 ...
 <tr >
	...
	<td  >: <label id="lbltotal"><s:property value="lbltaxamount"/></td>
	
	<td ><b></b></td>
	<td ><b>Net Total</b></td>
    <td>: <label id="lbltotal"><s:property value="lblnettotal"/></td>
    <td ><b></b></td>
