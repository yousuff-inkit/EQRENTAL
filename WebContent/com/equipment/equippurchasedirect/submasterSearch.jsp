        ...
        $(document).ready(function () { 	
            ...
            $("#vehpurchase").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Ref. No', datafield: 'refvocno', width: '7%' },	
							...
							{ text: 'refdocno', datafield: 'refdocno', width: '5%' ,hidden:true },
							{ text: 'nettotal', datafield: 'nettotal', width: '5%' ,hidden:true },
							{ text: 'taxamt', datafield: 'taxamt', width: '5%' ,hidden:true },
							{ text: 'cmbbilltype', datafield: 'billtype', width: '5%'  ,hidden:true },
            ...
            $('#vehpurchase').on('rowdoubleclick', function (event) {
    			...
    			$('#vehpurinvDate').jqxDateTimeInput({disabled: false});
                   ...
                   funRoundRate($('#vehpurchase').jqxGrid('getcellvalue', rowindex2, "rate"),"epocurrate");
                   document.getElementById("hidcmbcurr").value  = $('#vehpurchase').jqxGrid('getcellvalue', rowindex2, "curid");
                   document.getElementById("reftype").value  = $('#vehpurchase').jqxGrid('getcellvalue', rowindex2, "reftype");
                   document.getElementById("refno").value  = $('#vehpurchase').jqxGrid('getcellvalue', rowindex2, "refvocno");
                   document.getElementById("masterrefno").value  = $('#vehpurchase').jqxGrid('getcellvalue', rowindex2, "refdocno");
                   document.getElementById("hidreftype").value  = $('#vehpurchase').jqxGrid('getcellvalue', rowindex2, "reftype");  
                   document.getElementById("hidcmbbilltype").value =  $('#vehpurchase').jqxGrid('getcellvalue', rowindex2, "billtype");
                   document.getElementById("cmbbilltype").value =  $('#vehpurchase').jqxGrid('getcellvalue', rowindex2, "billtype");

                   funRoundAmt($('#vehpurchase').jqxGrid('getcellvalue', rowindex2, "nettotal"),"txtnetotal");   
                   funRoundAmt($('#vehpurchase').jqxGrid('getcellvalue', rowindex2, "taxamt"),"txttaxamount");      
