 ...
 else if(temp1>0)
{
	...
	vahreqdata='<%=cvp.refsearchrelode(orderdoc)%>';
} 
else
	{
      vahreqdata;
              ...
              // disabled:true,
               localization: {thousandsSeparator: ""},
                ...
                columns: [
							...
							{ text: 'Equipment', datafield: 'fleet_no', width: '10%',cellclassname: cellclassname,editable: false},
							
							
							{ text: 'Asset id', datafield: 'reg_no', width: '8%',cellclassname: cellclassname,editable: false},
