...
<%@page import="com.equipment.inspection.ClsEquipmentInspectionDAO"%>
<%@page import="com.equipment.inspection.ClsEquipmentInspectionAction"%>
<%ClsEquipmentInspectionDAO inspdao=new ClsEquipmentInspectionDAO(); %>
