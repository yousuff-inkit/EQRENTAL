    ...
    var doc='<%=docno%> ';
        ...
        //alert(fleet+"==="+doc);
 		if(fleet=='' || fleet=='0'){
 		 ...
 		 var reurl=url.split("com/");
 		  	...
 		  	var win= window.open(reurl[0]+"com/equipment/inspection/equipmentInspectionPrint.action?docno="+doc+"&fleetno="+fleet+"&lblurl="+window.location.origin,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
 	...
 	function printMobile(){
		 ...
		 var reurl=url.split("com/");
		  	...
		  	var win= window.open(reurl[0]+"com/equipment/inspection/equipmentInspectionMobilePrint.action?docno="+doc+"&fleetno="+fleet+"&lblurl="+window.location.origin,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
		    	//var win= window.open(reurl[0]+"printManualInvoice?docno="+document.getElementById("docno").value,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
			win.focus();
 	}
