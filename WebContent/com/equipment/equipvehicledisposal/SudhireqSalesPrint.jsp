...
function hidedata()
{
	...
	var billtype=document.getElementById("lblbilltype").value;
	//ert(billtype);

	if(billtype==1)
		{
		   $("#tblwotax").prop("hidden", true);
		   $("#tbltax").prop("hidden", false);

		}
	else
		{
		   $("#tblwotax").prop("hidden", false);
		   $("#tbltax").prop("hidden", true);
		}
...
<body onload="hidedata();" style="background-color:white;">
...
<hr>
<table width="100%" id="tbltax">
 <tr>
    <td align="left" width="3%"><b>SINo</b></td>
    <td align="left" width="7%"><b>Asset id</b></td>
...
<table width="100%" id="tblwotax">
 <tr>
  ...
  <tr><td></td></tr>
  <tr><td></td></tr>
 <s:iterator var="stat1" status="arr" value="%{#request.INVPRINT4}" >
	
		<s:iterator status="arr" value="#stat1" var="stat">
        	<tr>   
				
     				<s:iterator status="arr" value="#stat.split('::')" var="des" begin="0" end="11" >
    					<s:if test="#arr.index!=4">
...
<table width="100%" >
 <tr>
  ...
  <tr>
    ...
    <td width="4%">Date</td>
    <td width="21%"><label id="lblfinaldate" name="lblfinaldate"><s:property value="lblfinaldate"/></label>
   </td>
    </tr>
  <tr>
    <td colspan="6">&nbsp;</td>
...
<input type="hidden" id="lblbilltype" name="lblbilltype" value='<s:property value="lblbilltype"/>'>  
