...
$("#hiddep_posted").jqxDateTimeInput({
	width : '125px',
	height : '15px',
	formatString : "dd.MM.yyyy"
});
$("#hiddep_posted1").jqxDateTimeInput({
	width : '125px',
	height : '15px',
	formatString : "dd.MM.yyyy"
});
...
function getSalesprice()
{
	...
	//	alert("trsalesprices==="+trsalesprice+"clientrate==="+clientrate+"sellingprice==="+sellingprice);
...
<table width="100%" border=0 >
  <tr>
    ...
    <td width="29%">&nbsp;</td>
    <td width="4%"> <label id="billname">Bill Type</label> </td>
	<td width="22%"><select id="cmbbilltype" name="cmbbilltype"   style="width:13%;" value='<s:property value="cmbbilltype"/>'>
  ...
  <tr>
    ...
    <td align="left"><input type="text" name="clientcurr" id="clientcurr" value='<s:property value="clientcurr"/>' readonly ></td>
    <td align="right">Rate</td>
    <td align="left"><input type="text" name="currrate" id="currrate" value='<s:property value="currrate"/>' onchange="getSalesprice();" readonly ></td>
    <td colspan="2">&nbsp;</td>
  </tr>
  <tr>
 ...
 <td align="right">&nbsp;</td>
  ...
  <tr hidden="true">
      <td width="11%" align="left"><div id="hiddep_posted" name="hiddep_posted" value='<s:property value="hiddep_posted"/>'></div></td>
        <td width="11%" align="left"><div id="hiddep_posted1" name="hiddep_posted1" value='<s:property value="hiddep_posted1"/>'></div></td>
