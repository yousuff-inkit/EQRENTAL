        ...
        $(document).ready(function () { 	
            ...
            $("#disposalGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Equipment', datafield: 'flname',editable:false, width: '14%'},
							{ text: 'Asset id', datafield: 'reg_no',editable:false, width: '7%'},
							{ text: ' Tr.Sales Price', datafield: 'trsalesprice', width: '9.71%',cellsformat:'d2',cellsalign:'right',align:'right'},
            ...
            $('#disposalGrid').on('cellvaluechanged', function (event) {
           	   var row1=event.args.rowindex;
       				if(event.args.datafield=='trsalesprice'){
           				var trsalesprices=$('#disposalGrid').jqxGrid('getcelltext', row1, 'trsalesprice').replace(",",""); 
						var clientrate=document.getElementById("currrate").value;
       					var sellingprice=parseFloat(trsalesprices)*parseFloat(clientrate);
       					//alert("trsalesprices==="+trsalesprices+"clientrate==="+clientrate+"sellingprice==="+sellingprice);
       					$('#disposalGrid').jqxGrid('setcellvalue', row1, 'salesprice',sellingprice); 
