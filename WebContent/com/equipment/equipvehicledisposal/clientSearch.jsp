		...
		$(document).ready(function () { 	
            ...
            var source =
            {
                ...
                datafields: [
     						...
     						{name : 'clientcurr',type:'String'},
     						{name : 'currrate',type:'number'},
            ...
            $("#clientSearch").jqxGrid(
            {
                ...
                columns: [
							...
							{ text:'Client Currency',datafield:'clientcurr',width:'16.66%',hidden:true},
							{ text: 'Currency Rate',  datafield:'currrate',width: '9.71%',cellclassname:'column' ,editable:false,cellsformat:'d2',cellsalign:'right',align:'right',hidden:true},
							{ text:'curid',datafield:'curid',width:'16.66%',hidden:true},
           ...
           $('#clientSearch').on('rowdoubleclick', function (event) {
            	...
            	temp=temp+",Mail: "+$('#clientSearch').jqxGrid('getcellvalue', rowindex1, "mail1");
              	...
              	document.getElementById("clientcurr").value=$('#clientSearch').jqxGrid('getcellvalue', rowindex1, "clientcurr");
              	document.getElementById("currrate").value=$('#clientSearch').jqxGrid('getcellvalue', rowindex1, "currrate");
              	document.getElementById("hidclientcurid").value=$('#clientSearch').jqxGrid('getcellvalue', rowindex1, "curid");
