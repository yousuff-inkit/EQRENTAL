	...
	subsearchdata=[];
        ...
        $(document).ready(function () { 	
            ...
            $("#disposalSearch").jqxGrid(
            {
               ...
               // editable: true,
                ...
                columns: [
							...
							{ text: 'Billtype',datafield:'billtype',width:'10%',hidden:true},
							{ text: 'Client curr',datafield:'clientcurr',width:'10%',hidden:true},
							{ text: 'currrate',datafield:'currrate',width:'10%',hidden:true},
							{ text: 'Client curr',datafield:'clientcurrid',width:'10%',hidden:true},
           ...
           $('#disposalSearch').on('rowdoubleclick', function (event) {
            ...
            $('#cmbbilltype').val($("#disposalSearch").jqxGrid('getcellvalue', row2, "billtype")) ;
            $('#clientcurr').val($("#disposalSearch").jqxGrid('getcellvalue', row2, "clientcurr")) ;
            $('#currrate').val($("#disposalSearch").jqxGrid('getcellvalue', row2, "currrate")) ;
            $('#hidclientcurid').val($("#disposalSearch").jqxGrid('getcellvalue', row2, "clientcurrid")) ;
