            ...
            $("#fleetSearch").jqxGrid(
            {
               ...
               // editable: true,
                ...
                columns: [
							...
							{ text: 'Asset id',filtertype:'input',columntype:'textbox', datafield: 'reg_no', width: '15%'},
							{ text: 'Plate Code',filtertype:'input',columntype:'textbox',datafield:'platecode',width:'15%'},
							{ text: 'Tr. Sales Price', datafield: 'trsalesprice', width: '9.71%',cellsformat:'d2',cellsalign:'right',align:'right',hidden:true},
           	...
           	$('#fleetSearch').on('rowdoubleclick', function (event) {
        		var row2=event.args.rowindex;
               	...
               	$("#disposalGrid").jqxGrid('setcellvalue', row5, "trsalesprice", $('#fleetSearch').jqxGrid('getcellvalue', row2, "trsalesprice"));
