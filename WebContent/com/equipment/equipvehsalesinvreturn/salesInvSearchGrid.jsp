...
<%@page import="com.equipment.equipvehsalesinvreturn.ClsEquipVehSalesInvReturnDAO"%>
...
ClsEquipVehSalesInvReturnDAO vehsalesinvretdao=new ClsEquipVehSalesInvReturnDAO();
%> 
		...
		$(document).ready(function () { 	
            ...
            $("#salesInvSearchGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text:'Rate',datafield:'rate',width:'16.66%',hidden:true},
							{ text:'Currency',datafield:'currency',width:'16.66%',hidden:true},
							{ text:'Currency Id',datafield:'curid',width:'16.66%',hidden:true},
							{ text:'BillType',datafield:'billtype',width:'16.66%',hidden:true},
          ...
          $('#salesInvSearchGrid').on('rowdoubleclick', function (event) {
            	...
            	document.getElementById("clientcurr").value=$('#salesInvSearchGrid').jqxGrid('getcellvalue', rowindex1, "currency");
            	document.getElementById("currrate").value=$('#salesInvSearchGrid').jqxGrid('getcellvalue', rowindex1, "rate");
            	document.getElementById("hidclientcurid").value=$('#salesInvSearchGrid').jqxGrid('getcellvalue', rowindex1, "curid");
                $('#cmbbilltype').val($("#salesInvSearchGrid").jqxGrid('getcellvalue', rowindex1, "billtype")) ;
