...
function funRemoveReadOnly(){
	 ...
	 $('#disposalGrid').jqxGrid({ disabled: false}); 
		$('#frmVehSalesInvReturn input').attr('readonly', false );
		 ...
		 $('#clientcurr').prop('readonly',true);
		 $('#currrate').prop('readonly',true);
...
function funPrintBtn() {
	 ...
	 var url=document.URL;
		 var reurl=url.split("com/");	 
	 	 var win= window.open(reurl[0]+"com/equipment/equipvehicledisposal/printEqSalesInvReturn.action?docno="+document.getElementById("docno").value+"&trno="+document.getElementById("trno").value,"_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=no,toolbar=yes");
		 win.focus();      
...
<form id="frmVehSalesInvReturn" action="saveEqSalesInvReturn" autocomplete="off" >
...
<table width="100%" >
  ...
  <tr>
    <td align="right">Sales Inv Ref No</td>
    <td align="left"><input type="text" name="salesinvvocno" id="salesinvvocno" value='<s:property value="salesinvvocno"/>' readonly placeholder="Press F3 to Search" onkeydown="getSalesInv(event);"></td>
    <td colspan="3" align="left"><input type="text" name="salesinvremarks" id="salesinvremarks" value='<s:property value="salesinvremarks"/>' style="width:99%;" readonly></td>
    <td align="right"><label id="billname">Bill Type</label> </td>
    <td ><select id="cmbbilltype" name="cmbbilltype"   style="width:90%;" value='<s:property value="cmbbilltype"/>'>
  ...
  <input type="hidden" name="salesinvdocno" id="salesinvdocno" value='<s:property value="salesinvdocno"/>' readonly >
  <tr>
    <td align="right">Client</td>
    <td align="left"><input type="text" name="client" id="client" value='<s:property value="client"/>' readonly></td>
  ...
  <tr>
    ...
    <td colspan="4" align="left"><input type="text" name="description" id="description" value='<s:property value="description"/>' style="width:99%;"></td>
       <td align="right">Rate</td>
    <td align="left"><input type="text" name="currrate" id="currrate" value='<s:property value="currrate"/>' readonly ></td>
 
    <td colspan="2">&nbsp;</td>
  </tr>
  <input type="button" name="btncalculate" id="btncalculate" class="myButton" onclick="funCalculate();" value="Calculate" style="visibility:hidden;">
  <select name="cmbtype" id="cmbtype" style="visibility:hidden;">
