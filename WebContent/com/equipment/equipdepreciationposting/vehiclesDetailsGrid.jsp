<%@page import="com.equipment.equipdepreciationposting.ClsEquipDepreciationPostingDAO"%>
<% ClsEquipDepreciationPostingDAO DAO= new ClsEquipDepreciationPostingDAO(); %>
