<%-- <jsp:include page="../../../../includes.jsp"></jsp:include> --%>
 ...
 <%@page import="com.equipment.equipreplacement.*"%>
...
ClsEquipReplacementDAO repdao=new ClsEquipReplacementDAO();
%>
        ...
        $(document).ready(function () { 	
            ...
            $("#gridAgmtSearch").jqxGrid(
            {
                ...
                columns: [
							...
							{ text:'Calc Doc No',datafield:'calcdocno',width:'30%',hidden:true}
							/*	
            ...
            $('#gridAgmtSearch').on('rowdoubleclick', function (event) {
				...
				temp=temp+",Asset id: "+$('#gridAgmtSearch').jqxGrid('getcellvalue', rowindex1, "reg_no");
                ...
                document.getElementById("calcdocno").value=$('#gridAgmtSearch').jqxGrid('getcellvalue', rowindex1, "calcdocno");
