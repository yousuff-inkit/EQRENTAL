	...
	$('#btnSave').mousedown(); 
	 ...
	 /* 	$.messager.confirm('Confirm', 'Do you Want to Save Changes', function(r){
			if (r){
				...
				$('#cmbcolinbranch').prop('disabled',false); 
				document.getElementById("frmEquipReplacement").submit();
...
<fieldset>
      <legend>Equipment Info As In Agreement</legend>
      <table width="100%" >
        <tr>
  ...
  <tr>
    ...
    <td align="left">
    	<select name="cmbatbranchinfuel" id="cmbatbranchinfuel" value='<s:property value="cmbatbranchinfuel"/>'>
	    <option value="">--Select--</option>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  ...
  <tr>
    <td>
    <fieldset style="background-color:#F7F2E0;"><legend><b>New Equip. going for Delivery</b></legend>
    <table width="100%">
  <tr>
  ...
  <tr>
    ...
    <fieldset style="background-color:#FFFAFA;" id="collectfield"><legend><input type="checkbox" name="chkcollect" id="chkcollect" onchange="checkCollect();"><label for="chkcollect"><b>Equipment Recieved from Client</b></label></legend>
    <table width="100%">
  <tr>
  ...
  <tr>
    ...
    <!-- <br><br><br><br> -->
    <br>
    <fieldset style="background-color:#e6e6fa;" id="deliveryfield"><legend><input type="checkbox" name="chkdelivery" id="chkdelivery" onchange="checkDelivery();"><label for="chkdelivery"><b>New Equ. handed over to Client</b></label></legend>
    <table width="100%">
  <tr>
  ...
  <tr>
    ...
    <fieldset style="background-color:#ECF8E0"><legend><b>Collected Equip. Closing At Branch</b></legend>
    <table width="100%">
  <tr>
