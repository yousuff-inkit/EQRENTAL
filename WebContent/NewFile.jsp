...
/*			function funExcelBtn(){
			...
			function funDateInPeriod(value){
			      ...
			      var tempdtype=document.getElementById("formdetailcode").value;
			       ...
			       if(tempdtype=='INV' || tempdtype=='INR' || tempdtype=='PIV' || tempdtype=='PIR' || tempdtype=='PJIV' || tempdtype=='CPU' || tempdtype=='SRS' || tempdtype=='SRR')
			    	   {
		...
		/*PDC Date Restriction Ends*/
			...
			function funChkButtonchk(){
				...
				if(!(dtype=='DPMA' || dtype=='FRO' || dtype=='LEC' || dtype=='OPN' || dtype=='FPP'|| dtype=='PREP'|| dtype=='BRCN'|| dtype=='MAPP'|| dtype=='UCPP' || dtype=='SAT'  || dtype=='CUR'  || dtype=='STE' )){  
